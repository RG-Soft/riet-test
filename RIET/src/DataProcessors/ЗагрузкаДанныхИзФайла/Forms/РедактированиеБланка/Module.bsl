...
Процедура СброситьНастройки(Команда)
	...
	ПоказатьВопрос(Оповещение, ВернутьСтр("ru = 'Установить настройки колонок в первоначальное состояние?'"), РежимДиалогаВопрос.ДаНет);
КонецПроцедуры
...
Процедура УстановитьОформлениеДанных()
	...
	ЭлементОтбора.Использование = Истина;
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", ВернутьСтр("ru = 'Стандартное наименование'"));
