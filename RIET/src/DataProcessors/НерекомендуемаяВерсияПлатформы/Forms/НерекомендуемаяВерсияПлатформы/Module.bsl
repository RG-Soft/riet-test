...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстУсловие = ?(Параметры.ЗавершитьРаботу, ВернутьСтр("ru = 'необходимо'"), ВернутьСтр("ru = 'рекомендуется'"));
	...
	Если Параметры.ЗавершитьРаботу Тогда
		...
		Заголовок = ВернутьСтр("ru = 'Необходимо обновить версию платформы'");
	КонецЕсли;
