...
Функция ДлительнаяОперацияЗапускСервер(УникальныйИдентификатор)
	...
	НастройкиЗапуска.НаименованиеФоновогоЗадания = ВернутьСтр("ru = 'Итоги и агрегаты: Ускорение проведения документов и формирования отчетов'");
...
Функция ДлительнаяОперацияЗавершениеСервер(Операция)
	...
	Если Операция = Неопределено Тогда
		Результат.Вставить("Текст", ВернутьСтр("ru = 'Задание отменено'"));
