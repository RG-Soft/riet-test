...
Процедура ПриОткрытии(Отказ)
	...
	ТекстСообщения = ВернутьСтр("ru = 'На компьютере установлено %1 Гб оперативной памяти.
	...
	ЗаголовокСообщения = ВернутьСтр("ru = 'Рекомендация по повышению скорости работы'");
	
	ПараметрыВопроса = СтандартныеПодсистемыКлиент.ПараметрыВопросаПользователю();
	ПараметрыВопроса.Заголовок = ЗаголовокСообщения;
	ПараметрыВопроса.Картинка = БиблиотекаКартинок.Предупреждение32;
	ПараметрыВопроса.Вставить("ТекстФлажка", ВернутьСтр("ru = 'Не показывать в течение двух месяцев'"));
	
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить("ПродолжитьРаботу", ВернутьСтр("ru = 'Продолжить работу'"));
