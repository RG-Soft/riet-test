...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.УправлениеИтогамиИАгрегатами.Форма.ФормаВыбораПериода") Тогда
		...
		ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Установка периода рассчитанных итогов ...'"));
		ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Установка периода рассчитанных итогов завершена'"));
		...
		ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка установки периода рассчитанных итогов.'"));
	...
	ИначеЕсли ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.УправлениеИтогамиИАгрегатами.Форма.ФормаПараметровПерестроения") Тогда
		...
		Если КонтекстВыбора = "ПерестроитьАгрегаты" Тогда
			...
			ПараметрыИтогов = Новый Структура;
			ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Перестроение агрегатов ...'"));
			ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Перестроение агрегатов завершено'"));
			...
			ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка перестроения агрегатов.'"));
...
Процедура ВключитьИспользованиеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Включение использования итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Включение использования итогов завершено'"));
	...
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка включения использования итогов.'"));
...
Процедура ВключитьИспользованиеТекущихИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Включение использования текущих итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Включение использования текущих итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка включения использования текущих итогов.'"));
...
Процедура ВыключитьИспользованиеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Выключение использования итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Выключение использования итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьИспользованиеИтогов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользоватьИтоги");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка выключения использования итогов.'"));
...
Процедура ВыключитьИспользованиеТекущихИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Выключение использования текущих итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Выключение использования текущих итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка выключения использования текущих итогов.'"));
...
Процедура ВключитьРазделениеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Включение разделения итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Включение разделения итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРазделениеИтогов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РазделениеИтогов");
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка включения разделения итогов.'"));
...
Процедура ВыключитьРазделениеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Выключение разделения итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Выключение разделения итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРазделениеИтогов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РазделениеИтогов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка выключения разделения итогов.'"));
...
Процедура ВключитьРежимАгрегатов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Включение режима агрегатов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Включение режима агрегатов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРежимАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РежимАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка включения режима агрегатов.'"));
...
Процедура ВключитьРежимИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Включение режима итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Включение режима итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРежимАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РежимАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка включения режима итогов.'"));
...
Процедура ВключитьИспользованиеАгрегатов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Включение использования агрегатов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Включение использования агрегатов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка включения использования агрегатов.'"));
...
Процедура ВыключитьИспользованиеАгрегатов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Выключение использования агрегатов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Выключение использования агрегатов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка выключения использования агрегатов.'"));
...
Процедура ОчиститьАгрегатыПоРегистрам(Команда)
	...
	ТекстВопроса = ВернутьСтр("ru='Очистка агрегатов может привести к существенному замедлению отчетов.'");
	
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить(КодВозвратаДиалога.Да, ВернутьСтр("ru = 'Очистить агрегаты'"));
...
Процедура ЗаполнитьАгрегатыПоРегистрам(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Заполнение агрегатов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Заполнение агрегатов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "ЗаполнитьАгрегаты");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Неопределено);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка заполнения агрегатов.'"));
...
Процедура УстановитьПериодРассчитанныхИтогов(Команда)
	...
	Если МассивДействий.Количество() = 0 Тогда
		ПоказатьПредупреждение(, ВернутьСтр("ru='Отсутствуют регистры, для которых можно выполнить данную операцию.'"));
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьАгрегатыИВыполнитьПерестроение(Команда)
	...
	Если МассивДействий.Количество() = 0 Тогда
		ПоказатьПредупреждение(, ВернутьСтр("ru='Отсутствуют регистры, для которых можно выполнить выбранное действие.'"));
		Возврат;
	КонецЕсли;
...
Процедура ПересчитатьИтоги(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Пересчет итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Пересчет итогов завершен'"));
	ПараметрыИтогов.Вставить("Действие",               "ПересчитатьИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка пересчета итогов.'"));
...
Процедура ПересчитатьТекущиеИтоги(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Пересчет текущих итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Пересчет текущих итогов завершен'"));
	ПараметрыИтогов.Вставить("Действие",               "ПересчитатьТекущиеИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка пересчета текущих итогов.'"));
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", ВернутьСтр("ru = 'Итоги'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", ВернутьСтр("ru = 'Агрегаты'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", ВернутьСтр("ru = 'Просто итоговый регистр'"));
...
Процедура ОчиститьАгрегатыПоРегистрамЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	Если Ответ = КодВозвратаДиалога.Да Тогда
		...
		ПараметрыИтогов = Новый Структура;
		ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Очистка агрегатов ...'"));
		ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Очистка агрегатов завершена'"));
		ПараметрыИтогов.Вставить("Действие",               "ОчиститьАгрегаты");
		ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
		ПараметрыИтогов.Вставить("Поле",                   "Наименование");
		ПараметрыИтогов.Вставить("Значение1",              Неопределено);
		ПараметрыИтогов.Вставить("Значение2",              Неопределено);
		ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка очистки агрегатов.'"));
...
Процедура ПересчитатьИтогиЗаПериодЗавершение(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
	Если ВыбранноеЗначение <> Неопределено Тогда
		...
		ПараметрыИтогов = Новый Структура;
		ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  ВернутьСтр("ru='Пересчет итогов за период ...'"));
		ПараметрыИтогов.Вставить("ПослеПроцесса",          ВернутьСтр("ru='Пересчет итогов за период завершен'"));
		...
		ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", ВернутьСтр("ru='Ошибка пересчета итогов за период.'"));
	...
	Для Счетчик = 1 По Выбранные.Количество() Цикл
		...
		Если Не ВыбраннаяСтрока.РежимАгрегатов
			...
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				ВернутьСтр("ru = 'Операция невозможна в режиме итогов'"),
				,
				ПолеСообщенияОбОшибке);
			Продолжить;
		КонецЕсли;
	...
	Если Результат.МожноПолучить Тогда
		...
		#Иначе
			...
			Если Расширение = "zip" Тогда
				Фильтр = ВернутьСтр("ru = 'Архив ZIP (*.%1)|*.%1'");
			ИначеЕсли Расширение = "xml" Тогда
				Фильтр = ВернутьСтр("ru = 'Документ XML (*.%1)|*.%1'");
			Иначе
				Фильтр = "";
			КонецЕсли;
...
Функция Префикс()
	...
	Возврат ВернутьСтр("ru = 'Агрегаты регистра'");
...
Функция ПолучитьОптимальныеАгрегатыСервер()
	...
	Для НомерСтроки = 1 По Всего Цикл
		...
		Если ИнформацияОбОшибке <> Неопределено Тогда
			ЕстьОшибки = Истина;
			ЗаголовокОшибки = ВернутьСтр("ru = 'Не удалось получить оптимальные агрегаты регистра ""%1"":'");
	...
	Если Успешно > 0 Тогда
		...
		Иначе
			КраткоеИмяФайла = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				ВернутьСтр("ru = 'Оптимальные агрегаты регистров накопления %1.zip'"),
		...
		Если ЕстьОшибки Тогда
			СтандартныеПодсистемыКлиентСервер.ВывестиПредупреждение(
				...
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					ВернутьСтр("ru = 'Не удалось получить оптимальные агрегаты регистра накопления ""%1"".'"),
					ИмяРегистра),
				ПодробныйТекстОшибок);
		Иначе
			СтандартныеПодсистемыКлиентСервер.ВывестиОповещение(
				Результат,
				ВернутьСтр("ru = 'Оптимальные агрегаты успешно получены.'"),
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					ВернутьСтр("ru = '%1 (регистр накопления)'"),
					ИмяРегистра),
	...
	ИначеЕсли Успешно = 0 Тогда
		...
		СтандартныеПодсистемыКлиентСервер.ВывестиПредупреждение(
			Результат,
			ВернутьСтр("ru = 'Не удалось получить оптимальные агрегаты регистров накопления.'"),
			ПодробныйТекстОшибок);
	ИначеЕсли ЕстьОшибки Тогда
		...
		СтандартныеПодсистемыКлиентСервер.ВывестиПредупреждение(
			Результат,
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				ВернутьСтр("ru = 'Агрегаты успешно получены для %1 из %2 регистров.
				|Не получены: %3.'"),
				Успешно,
				Всего,
				Всего - Успешно),
	...
	Иначе
		...
		СтандартныеПодсистемыКлиентСервер.ВывестиОповещение(
			Результат,
			ВернутьСтр("ru = 'Агрегаты успешно получены.'"),
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				ВернутьСтр("ru = 'Регистры накопления (%1)'"),
				Успешно),
			БиблиотекаКартинок.Успешно32);
	КонецЕсли;
...
Процедура ОбновитьСписокИтоговНаСервере()
	...
	ГруппаИтоговЗаголовок = ВернутьСтр("ru = 'Итоги'");
...
Процедура ОбновитьАгрегатыПоРегистрамНаСервере()
	...
	ГруппаАгрегатыЗаголовок = ВернутьСтр("ru = 'Агрегаты'");
...
Функция УстановитьПараметрыРегистраНаСервере(Знач ВидРегистра,
	...
	Попытка
		...
		Иначе
			ВызватьИсключение ВернутьСтр("ru = 'Неправильное имя параметра'") + "(1): " + Действие;
		КонецЕсли;
	...
	Попытка
		...
		Иначе
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				ВернутьСтр("ru = 'Неправильное имя параметра: %1'"),
...
Процедура УстановитьРасширенныйРежим()
	...
	Если ПолныеВозможности Тогда
		Заголовок        = ВернутьСтр("ru = 'Управление итогами - полные возможности'");
		ТекстГиперСсылки = ВернутьСтр("ru = 'Часто используемые возможности'");
	...
	Иначе
		Заголовок        = ВернутьСтр("ru = 'Управление итогами - часто используемые возможности'");
		ТекстГиперСсылки = ВернутьСтр("ru = 'Полные возможности'");
...
Процедура ПрочитатьИнформациюПоРегистрам()
	...
	Для Каждого Регистр Из Метаданные.РегистрыБухгалтерии Цикл
		...
		Представление = Регистр.Представление() + " (" + ВернутьСтр("ru = 'регистр бухгалтерии'") + ")";
	...
	Для Каждого Регистр Из Метаданные.РегистрыНакопления Цикл
		...
		Если Регистр.ВидРегистра = Метаданные.СвойстваОбъектов.ВидРегистраНакопления.Обороты Тогда
			...
			Постфикс = ВернутьСтр("ru = 'оборотный регистр накопления'");
		Иначе
			ОстаткиИОбороты = Истина;
			Постфикс = ВернутьСтр("ru = 'регистр накопления'");
		КонецЕсли;
