...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТолькоОбновлениеПараметровРаботыПрограммы Тогда
		Заголовок = ВернутьСтр("ru = 'Обновление параметров работы программы'");
	...
	ИначеЕсли РежимОбновленияДанных = "НачальноеЗаполнение" Тогда
		Заголовок = ВернутьСтр("ru = 'Начальное заполнение данных'");
	...
	ИначеЕсли РежимОбновленияДанных = "ПереходСДругойПрограммы" Тогда
		Заголовок = ВернутьСтр("ru = 'Переход с другой программы'");
	...
	Иначе
		Заголовок = ВернутьСтр("ru = 'Обновление версии программы'");
...
Функция ЗагрузитьОбновитьПараметрыРаботыПрограммыВФоне()
	...
	Попытка
		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыВыполнения,
			ВернутьСтр("ru = 'Фоновое обновление параметров работы программы'"));
	...
	Если КраткоеСообщениеОбОшибке = Неопределено Тогда
		...
		Иначе
			КраткоеСообщениеОбОшибке =
				ВернутьСтр("ru = 'Ошибка получения результата от фонового задания
