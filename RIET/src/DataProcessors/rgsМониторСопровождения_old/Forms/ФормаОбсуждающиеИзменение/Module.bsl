...
Процедура ЗаполнитьТаблицуПользователей()
	...
	Попытка
		...
		УчастникиОбсуждения.Загрузить(ЗначениеИзСтрокиВнутр(Прокси.ПолучитьТаблицуУчастниковОбсужденияВопроса (ГУИДВопроса)));   //Прокси.ПолучитьСоставОбсуждающих(ГУИДВопроса))
	Исключение
