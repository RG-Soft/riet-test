...
Процедура УстановитьУсловноеОформление()
	...
	СписокЗначений.Добавить(ВернутьСтр("ru = '_$Session$_.AuthenticationError'"));
	СписокЗначений.Добавить(ВернутьСтр("ru = '_$Access$_.AccessDenied'"));
...
Функция ПрочитатьЖурнал(ОтборЖурналаНаКлиенте)
	...
	Попытка
		РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыОтчета,
			ВернутьСтр("ru = 'Защита персональных данных'"));
