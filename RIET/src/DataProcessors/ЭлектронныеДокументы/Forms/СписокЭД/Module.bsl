...
Процедура ОбновитьДеревоСтруктурыПодчиненностиЭД()
	...
	Иначе
		...
		Если ЗначениеЗаполнено(НастройкаЭДО)
			И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(НастройкаЭДО, "ПрограммаБанка") = Перечисления.ПрограммыБанка.АсинхронныйОбмен Тогда
			Элементы.ВыполнитьСинхронизациюСБанком.Видимость = Истина;
		КонецЕсли;
	КонецЕсли;
...
Функция РеквизитыНастройкиЭДО(Знач НастройкаЭДО)
	
	Возврат ОбщегоНазначения.ЗначенияРеквизитовОбъекта(НастройкаЭДО, "Организация, Контрагент");
...
Процедура ВыполнитьСинхронизациюСБанком(Команда)
	...
	РеквизитыНастройкиЭДО = РеквизитыНастройкиЭДО(НастройкаЭДО);
	ЭлектронныеДокументыКлиент.СинхронизироватьСБанком(
		РеквизитыНастройкиЭДО.Организация, РеквизитыНастройкиЭДО.Контрагент);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ВыполнитьСинхронизациюСБанком.Видимость = Ложь;
