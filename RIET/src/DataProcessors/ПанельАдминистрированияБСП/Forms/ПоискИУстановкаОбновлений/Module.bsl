...
Процедура ОбновитьНастройкиОбновленияКонфигурации()
	...
	//
	//ЗаголовокОбновленияПрограммы = ВернутьСтр("ru = 'Автоматическая проверка обновлений отключена.'");
	//Если НастройкиОбновленияКонфигурации.ПроверятьНаличиеОбновленияПриЗапуске = 2 Тогда
	//	ЗаголовокОбновленияПрограммы = ВернутьСтр("ru = 'Автоматическая проверка обновлений выполняется при каждом запуске программы.'");
	//ИначеЕсли НастройкиОбновленияКонфигурации.ПроверятьНаличиеОбновленияПриЗапуске = 1 Тогда
	//	ЗаголовокОбновленияПрограммы = ВернутьСтр("ru = 'Автоматическая проверка обновлений выполняется по расписанию: %1.'");
