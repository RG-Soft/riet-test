...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимРаботы.МодельСервиса Тогда
		...
		Элементы.ОписаниеРаздела.Заголовок = ВернутьСтр("ru = 'Настройка синхронизации данных с моими приложениями.'");
		Элементы.ПояснениеНастройкиСинхронизацииДанных.Заголовок = ВернутьСтр("ru = 'Настройка и выполнение синхронизации данных с моими приложениями.'");
		Элементы.ИспользоватьДатыЗапретаЗагрузкиПояснение.Заголовок =
			ВернутьСтр("ru = 'Запрет загрузки данных прошлых периодов из других приложений.
...
Процедура НастроитьДатыЗапретаЗагрузки(Команда)
	...
	// { RGS AGorlenko 10.08.2016 13:05:22 - временная заглушка
	Возврат;
	// } RGS AGorlenko 10.08.2016 13:05:28 - временная заглушка
