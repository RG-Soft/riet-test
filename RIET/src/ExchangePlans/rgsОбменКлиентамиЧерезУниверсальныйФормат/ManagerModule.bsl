...
Функция КраткаяИнформацияПоОбмену() Экспорт
	...
	ПоясняющийТекст = "Позволяет выполнять загрузку данных НСИ из ERM";
...
Функция ПодробнаяИнформацияПоОбмену() Экспорт
	Возврат "ПланОбмена.rgsОбменКлиентамиЧерезУниверсальныйФормат.Форма.ПодробнаяИнформация";
КонецФункции
...
// { RGS VShamin 29.04.2016 15:02:46 - 
Функция ПолучитьУзелОбменаСERM() Экспорт
	...
	|ГДЕ
	|	rgsОбменКлиентамиЧерезУниверсальныйФормат.Ссылка <> &ЭтотУзел";
	
	Запрос.УстановитьПараметр("ЭтотУзел", ПланыОбмена.rgsОбменКлиентамиЧерезУниверсальныйФормат.ЭтотУзел());
...
КонецФункции // } RGS VShamin 29.04.2016 15:02:47 - 
...
Процедура ПолучитьВерсииФорматаОбмена(ВерсииФормата) Экспорт
	ВерсииФормата.Вставить("1.0.beta", rgsОбменКонтрагентамиМенеджерОбменаЧерезУниверсальныйФормат);
	ВерсииФормата.Вставить("1.0", rgsОбменКонтрагентамиМенеджерОбменаЧерезУниверсальныйФормат);
КонецПроцедуры
