...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоДополнительноеСведение Тогда
		...
		Заголовок = ВернутьСтр("ru = 'Изменить настройку дополнительного сведения'");
	Иначе
...
Процедура ЗаписатьНачало()
	...
	Состояние(ВернутьСтр("ru = 'Выполняется изменение настройки свойства. Пожалуйста, подождите'"));
...
Функция ЗаписатьНаСервере()
	...
	НаименованиеЗадания = ВернутьСтр("ru = 'Изменение настройки дополнительного свойства'");
