...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = ВернутьСтр("ru = '%1 дополнительного реквизита ""%2""'");
	Если НастраиваемоеСвойство = "Доступен" Тогда
		ПредставлениеСвойства = ВернутьСтр("ru = 'Доступность'");
	ИначеЕсли НастраиваемоеСвойство = "ЗаполнятьОбязательно" Тогда
		ПредставлениеСвойства = ВернутьСтр("ru = 'Обязательность заполнения'");
	Иначе
		ПредставлениеСвойства = ВернутьСтр("ru = 'Видимость'");
	КонецЕсли;
