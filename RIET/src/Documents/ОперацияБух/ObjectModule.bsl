...
Функция ПечатьБухгалтерскойСправки()
	...
	ПодвалДокумента.Параметры.РасшифровкаПодписиИсполнителя = ?(ОбщегоНазначения.ЗначениеНеЗаполнено(Ответственный), "", ПроцедурыУправленияПерсоналом.ФамилияИнициалыФизЛица(Ответственный.ФизЛицо));
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Если ОбщегоНазначения.ЗначениеНеЗаполнено(ОбъектКопирования) Тогда
		Возврат;
	КонецЕсли;
