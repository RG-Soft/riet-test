	...
	Если ЗначениеЗаполнено(СтруктураПараметров) Тогда 
		Для Каждого КлючИЗначение Из СтруктураПараметров Цикл
			Если КлючИЗначение.Ключ = "ДАТА_ПРЕКРАЩЕНИЯ" Тогда
				...
				Если ЗначениеЗаполнено(ДатаПрекращенияДеятельности) Тогда
					ПредставлениеУведомления.Области["ДАТА_ПРЕКРАЩЕНИЯ"].Значение = ДатаПрекращенияДеятельности;
				КонецЕсли;
				ПредставлениеУведомления.Области["ПРИЛОЖЕНО_ЛИСТОВ"].Значение = СтруктураПараметров.ПРИЛОЖЕНО_ЛИСТОВ;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьМакет("УведомлениеОПрекращенииДеятельностиУСН");
	...
	Документы.УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыПростойФормы(ЭтаФорма, "УведомлениеОПрекращенииДеятельностиУСНПараметры");
...
Процедура ПредставлениеУведомленияВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли ОсобаяОбласть.Значение = "ДАТА_ПРЕКРАЩЕНИЯ" Тогда 
...
Процедура НестандартнаяОбработка_ДАТА_ПРЕКРАЩЕНИЯ()
	НестандартнаяОбработкаДаты("Дата прекращения деятельности", Ложь, "ДАТА_ПРЕКРАЩЕНИЯ");
КонецПроцедуры
