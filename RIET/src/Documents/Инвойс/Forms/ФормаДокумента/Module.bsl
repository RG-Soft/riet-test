...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Объект.Contract = ВыбранноеЗначение;
...
Процедура ContractОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Иначе
		...
		Если (ЗначениеЗаполнено(Объект.Contract) ИЛИ ЗначениеЗаполнено(ВыбранноеЗначение)) И НЕ ОбщегоНазначения.ДанныеСовпадают(ДанныеПоКонтрактуОбъекта, ДанныеПоКонтрактуВыбора) Тогда
