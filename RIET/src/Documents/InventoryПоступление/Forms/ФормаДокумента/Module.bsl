...
Процедура GoodsFiscalPriceПриИзменении(Элемент)
	...
	// { RGS LFedotova 25.10.2018 21:14:41 - вопрос SLI-0007720
	Если ТекущиеДанные.FiscalPrice <> 0.01 И Объект.Defer Тогда
	    Объект.Defer = Ложь;
	КонецЕсли; 
	// } RGS LFedotova 25.10.2018 21:14:49 - вопрос SLI-0007720
