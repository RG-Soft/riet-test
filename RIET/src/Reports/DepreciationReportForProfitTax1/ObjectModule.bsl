...
Функция СформироватьОтчет(Результат = Неопределено, ДанныеРасшифровки = Неопределено, ВыводВФормуОтчета = Истина) Экспорт
	...
	Запрос.Текст =  Запрос.Текст + " ОсновноеСредство.ПометкаУдаления = ЛОЖЬ) КАК СтоимостьАмортизацияОСОбороты
	              	|	ГДЕ
	              	|		(СтоимостьАмортизацияОСОбороты.АмортизацияНУПриход <> 0
	              	|				ИЛИ СтоимостьАмортизацияОСОбороты.АмортизацияНУРасход <> 0)) КАК СписокОС
	              	...
	              	|	СтоимостьАмортизацияОС.АмортизацияНУОборот КАК АмортизацияЗаПериод,
	              	|	СтоимостьАмортизацияОС.СуммаКВОборот КАК СуммаКВ,
	              	|	СтоимостьАмортизацияОС.СтоимостьНУКонечныйОстаток КАК СтоимостьНаКонецПериода,
	              	|	СтоимостьАмортизацияОС.АмортизацияНУКонечныйОстаток КАК АмортизацияНаКонецПериода,
					|	ВЫБОР
	              	|		КОГДА СтоимостьАмортизацияОС.СтоимостьНУКонечныйОстаток = 0
	              	|			ТОГДА 0
	              	|		ИНАЧЕ СтоимостьАмортизацияОС.СтоимостьНУКонечныйОстаток - ЕСТЬNULL(СтоимостьАмортизацияОС.АмортизацияНУКонечныйОстаток, 0)
					...
					|   &Подразделение КАК Подразделение
	              	...
	              	|					&Кон,
	              	|					,
	              	|					, " + сукНачальныеНастройкиЗапроса.УсловиеПодразделение + "
	              	|					ОсновноеСредство В
	              	|						(ВЫБРАТЬ
	              	|							ОС.ОсновноеСредство
	              	|						ИЗ
	...
	Если ОбщегоНазначенияПовтИсп.ИдентификаторРабочейКонфигурации() = "PA" Тогда
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "КостЦентр.Сегмент.Родитель.Родитель", "КостЦентр.Segment");       
	КонецЕсли; 						
