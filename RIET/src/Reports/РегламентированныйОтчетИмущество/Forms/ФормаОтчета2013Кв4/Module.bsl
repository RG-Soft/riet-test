...
//  RGS EKoshkina - Обновление на 3.0.43.50
...
Функция КБКПоКодуВидаИмущества(КодВидаИмущества)
	...
	СоответствиеКодаВидаИмуществаКБК.Вставить("7", "18210602010021000110");
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020022003", "П000020019003;П000020021003;П000020018003_Знам;П000020018003_Числ;П000020000100;П000020015003;П000020002003;П000020003003;П000020004003;П000020005003;П000020006003;П000020007003;П000020008003;П000020009003;П000020010003;П000020011003;П000020012003;П000020013003;П000020014003;П000020017003;П000020002004;П000020003004;П000020004004;П000020005004;П000020006004;П000020007004;П000020008004;П000020009004;П000020010004;П000020011004;П000020012004;П000020013004;П000020014004");
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если ЗначениеЗаполнено(мСкопированаФорма) Тогда
		ДатаПодписи = Параметры.мСохраненныйДок.ДатаПодписи;
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСписковВыбора = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СпискиВыбора2013Кв4");
	...
	Для Каждого Область Из МакетСписковВыбора.Области Цикл
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			ЕстьДополнительнаяКолонка = (Область.Имя = "ОКЕИ");
			
			ТаблСписка = Новый ТаблицаЗначений;
			ТаблСписка.Колонки.Добавить("Код", , , МакетСписковВыбора.Область(ВерхОбласти, 1, ВерхОбласти, 1).ШиринаКолонки);
			Если ЕстьДополнительнаяКолонка Тогда
				ТаблСписка.Колонки.Добавить("Обозначение", , , МакетСписковВыбора.Область(ВерхОбласти, 3, ВерхОбласти, 3).ШиринаКолонки);
			КонецЕсли;
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если ЕстьДополнительнаяКолонка Тогда
					НовСтрока.Обозначение = СокрП(МакетСписковВыбора.Область(НомСтр, 3).Текст);
				КонецЕсли;
			КонецЦикла;
	...
	// Титульный лист.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "Период", 2, , "Выбор кода налогового периода", КоллекцияСписковВыбора["НалоговыеПериоды"]);
	...
	Если Год(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) >= 2015 Тогда
		СписокВидовИмущества = "ВидыИмущества2014";
		СписокЛьготР2С160 = "ЛьготыР2С160_2015";
	ИначеЕсли Год(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) >= 2014 Тогда
		СписокВидовИмущества = "ВидыИмущества2014";
		СписокЛьготР2С160 = "ЛьготыР2С160";
	Иначе
		СписокВидовИмущества = "ВидыИмущества2013";
		СписокЛьготР2С160 = "ЛьготыР3С040";
	КонецЕсли;
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020016003_КодЛьготы", 7, , "Выбор кода льготы", КоллекцияСписковВыбора[СписокЛьготР2С160]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020020003_КодЛьготы", 7, , "Выбор кода льготы", КоллекцияСписковВыбора["Льгота2012400"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020024003_КодЛьготы", 7, , "Выбор кода льготы", КоллекцияСписковВыбора["Льгота2012500"]);
	
	// Раздел 3.
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030004003_КодЛьготы", 7, , "Выбор кода льготы", КоллекцияСписковВыбора["ЛьготыР3С040"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030007003_КодЛьготы", 7, , "Выбор кода льготы", КоллекцияСписковВыбора["Льгота2012400"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030012003_КодЛьготы", 7, , "Выбор кода льготы", КоллекцияСписковВыбора["Льгота2012500"]);
...
Процедура ВосстановитьСведенияОбОрганизацииИзТитульногоЛистаСтарогоОбразца(ПоказателиОтчета)
	...
	Для Каждого Показатель Из ПоказателиТаблПоле Цикл
		...
		ИначеЕсли ИмяПоказателя = "Прил1" Тогда
			...
			Для Ном = 1 По 3 Цикл
				СтруктураДанныхТитульный.ПоМесту = СокрЛП(СтруктураДанныхТитульный.Прил) + ПоказателиТаблПоле["Прил" + Ном];
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ИзмененаДатаПодписи Тогда
		...
		// { RGS MYurkevich 29.01.2015 10:26:19 - Обновление на 3.0.37.38
		...
		//Заполнение не по Организации, а по подразделению
		Если Форма.Подразделение.Пустая() Тогда
			СведенияОбОрганизации = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(Форма.СтруктураРеквизитовФормы.Организация, Форма.ДатаПодписи, СтрокаСведений);
								
		Иначе
			СведенияОбОрганизации = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(Форма.СтруктураРеквизитовФормы.Подразделение, Форма.ДатаПодписи, СтрокаСведений);
		КонецЕсли;
		// } RGS MYurkevich 29.01.2015 10:26:19 - Обновление на 3.0.37.38	
		...
		// заполняем ОКВЭД
		ОКВЭД = СокрЛП(СведенияОбОрганизации.ОКВЭД);
		ПолеТабличногоДокументаТитульный.Области["ОКВЭД"].Значение=ОКВЭД;
		...
		ПолеТабличногоДокументаТитульный.Области.ОКВЭД.Значение = СокрЛП(СведенияОбОрганизации.ОКВЭД);
...
Функция Сохранить(Автосохранение = Ложь, КодИФНС, КПП, Вариант, ВидДокументаНомерКорректировкиИзменен = Неопределено, НаимТекРаздела) Экспорт
	...
	// { RGS MYurkevich 29.01.2015 10:47:19 - Обновление на 3.0.37.38
	СтруктураРеквизитовФормы.мСохраненныйДок.Подразделение              = СтруктураРеквизитовФормы.Подразделение;
	// } RGS MYurkevich 29.01.2015 10:47:19 - Обновление на 3.0.37.38	
	...
	Если ИмяСтраницыПанели = "Раздел2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020015003, ОбластьИмя) > 0 Тогда
				...
				Делимое150 =  РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020002003.Значение)
				...
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020012003.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020013003.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020014003.Значение);
				
				ПолеТабличногоДокументаРаздел2.П000020015003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое150 / Делитель);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020017003, ОбластьИмя) > 0 Тогда
				...
				Делимое170 =  РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020002004.Значение)
				...
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020012004.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020013004.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020014004.Значение);
				
				ПолеТабличногоДокументаРаздел2.П000020017003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое170 / Делитель);
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020019003, ОбластьИмя) > 0 Тогда			
				...
				П000020018003_Знам = ПолеТабличногоДокументаРаздел2.П000020018003_Знам.Значение;
				П000020018003_Числ = ПолеТабличногоДокументаРаздел2.П000020018003_Числ.Значение;
				...
				СтоимостьОблагаемогоНалогомИмущества = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020015003.Значение) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020017003.Значение), 0);
				...
				Иначе
					П000020019003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, СтоимостьОблагаемогоНалогомИмущества);
				КонецЕсли;
				
				ПолеТабличногоДокументаРаздел2.П000020019003.Значение = П000020019003;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020022003, ОбластьИмя) > 0 Тогда			
				...
				П000020021003 = ПолеТабличногоДокументаРаздел2.П000020021003.Значение;
				П000020019003 = ПолеТабличногоДокументаРаздел2.П000020019003.Значение;
				
				П000020022003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, (П000020019003 * П000020021003) / 100);
				
				ПолеТабличногоДокументаРаздел2.П000020022003.Значение = П000020022003;
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел3" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030006003, ОбластьИмя) > 0 Тогда			
				...
				П000030005003_Знам = ПолеТабличногоДокументаРаздел3.П000030005003_Знам.Значение;
				П000030005003_Числ = ПолеТабличногоДокументаРаздел3.П000030005003_Числ.Значение;
				...
				П000030002003 = ПолеТабличногоДокументаРаздел3.П000030002003.Значение;
				П000030002503 = ПолеТабличногоДокументаРаздел3.П000030002503.Значение;
				П000030003003 = ПолеТабличногоДокументаРаздел3.П000030003003.Значение;
				П000030003503 = ПолеТабличногоДокументаРаздел3.П000030003503.Значение;
				
				ЗаполненаКадастроваяСтроимость = (ЗначениеЗаполнено(П000030002003) ИЛИ ЗначениеСуммыЗаполнено(П000030002503));
				ЗаполненаИнвентаризационнаяСтроимость = (ЗначениеЗаполнено(П000030003003) ИЛИ ЗначениеСуммыЗаполнено(П000030003503));
				
				Если ЗаполненаКадастроваяСтроимость И ЗаполненаИнвентаризационнаяСтроимость Тогда
					П000030006003 = 0;
				ИначеЕсли ЗаполненаКадастроваяСтроимость Тогда
					П000030006003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, (РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000030002003) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000030002503)) * П000030005003);
				ИначеЕсли ЗаполненаИнвентаризационнаяСтроимость Тогда
					П000030006003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, (РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000030003003) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, П000030003503)) * П000030005003);
				Иначе
					П000030006003 = 0;
				КонецЕсли;
				
				П000030006003 = Макс(П000030006003, 0);
				
				ПолеТабличногоДокументаРаздел3.П000030006003.Значение = П000030006003;
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030010003, ОбластьИмя) > 0 Тогда			
				...
				П000030009003_Знам = ПолеТабличногоДокументаРаздел3.П000030009003_Знам.Значение;
				П000030009003_Числ = ПолеТабличногоДокументаРаздел3.П000030009003_Числ.Значение;
				...
				П000030008003 = ПолеТабличногоДокументаРаздел3.П000030008003.Значение;
				П000030010003 = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел3.П000030006003.Значение * П000030008003 * П000030009003 / 100), 0);
				ПолеТабличногоДокументаРаздел3.П000030010003.Значение = П000030010003;
			КонецЕсли;
...
Процедура ПолныйРасчетРаздела2(Форма, ОбластьИмя = "")
	...
	Для Каждого СтраницаРаздела2 Из Форма.ТаблицаСтраницыРазделаРаздел2 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020015003, ОбластьИмя) > 0 Тогда
			...
			Делимое150 =  РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020002003)
			...
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020012003)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020013003)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020014003);
			
			ПолеТабличногоДокументаРаздел2.П000020015003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое150 / Делитель);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020017003, ОбластьИмя) > 0 Тогда
			...
			Делимое170 =  РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020002004)
			...
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020012004)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020013004)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020014004);
			
			ПолеТабличногоДокументаРаздел2.П000020017003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое170 / Делитель);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020019003, ОбластьИмя) > 0 Тогда			
			...
			П000020018003_Знам = ПолеТабличногоДокументаРаздел2.П000020018003_Знам;
			П000020018003_Числ = ПолеТабличногоДокументаРаздел2.П000020018003_Числ;
			...
			СтоимостьОблагаемогоНалогомИмущества = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020015003) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.П000020017003), 0);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020022003, ОбластьИмя) > 0 Тогда			
			...
			ПолеТабличногоДокументаРаздел2.П000020022003 = П000020022003;
...
Процедура ПолныйРасчетРаздела3(Форма, ОбластьИмя = "")
	...
	Для Каждого СтраницаРаздела3 Из Форма.ТаблицаСтраницыРазделаРаздел3 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030006003, ОбластьИмя) > 0 Тогда			
			...
			П000030005003_Знам = ПолеТабличногоДокументаРаздел3.П000030005003_Знам;
			П000030005003_Числ = ПолеТабличногоДокументаРаздел3.П000030005003_Числ;
			Если П000030005003_Числ > 0 И П000030005003_Знам > 0 Тогда
				П000030005003 = П000030005003_Числ / П000030005003_Знам;	
			Иначе
				П000030005003 = 1;
			...
			П000030002003 = ПолеТабличногоДокументаРаздел3.П000030002003;
			П000030002503 = ПолеТабличногоДокументаРаздел3.П000030002503;
			П000030003003 = ПолеТабличногоДокументаРаздел3.П000030003003;
			П000030003503 = ПолеТабличногоДокументаРаздел3.П000030003503;
			...
			ПолеТабличногоДокументаРаздел3.П000030006003 = П000030006003;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030010003, ОбластьИмя) > 0 Тогда			
			...
			П000030009003_Знам = ПолеТабличногоДокументаРаздел3.П000030009003_Знам;
			П000030009003_Числ = ПолеТабличногоДокументаРаздел3.П000030009003_Числ;
			Если П000030009003_Числ > 0 И П000030009003_Знам > 0 Тогда
				П000030009003 = П000030009003_Числ / П000030009003_Знам;	
			Иначе
				П000030009003 = 1;
			...
			П000030008003 = ПолеТабличногоДокументаРаздел3.П000030008003;
			П000030010003 = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел3.П000030006003 * П000030008003 * П000030009003 / 100), 0);
			ПолеТабличногоДокументаРаздел3.П000030010003 = П000030010003;
		КонецЕсли;
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели = "")
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел2" Тогда
		...
		ОбрабатываемаяОбласть2 = Форма.ТабличныйДокумент.Области.П000020025003;
		Если ПустаяСтрока(ОпределяющаяОбласть.Значение) Тогда
			ЗапретитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть1);
			ЗапретитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть2);
		Иначе
		...
		КодВидаИмуществаРаздела2 = СокрЛП(Форма.ТабличныйДокумент.Области.П000020000101.Значение);
		
		ОбрабатываемаяОбласть1 = Форма.ТабличныйДокумент.Области.П000020018003_Числ;
		ОбрабатываемаяОбласть2 = Форма.ТабличныйДокумент.Области.П000020018003_Знам;
		...
		ОбрабатываемаяОбласть1 = Форма.ТабличныйДокумент.Области.П000020023003;
		ОбрабатываемаяОбласть2 = Форма.ТабличныйДокумент.Области.П000020026003;
		Если КодВидаИмуществаРаздела2 = "4" Тогда
			ЗапретитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть1);
			ОтображатьНольЦифройВОбласти(ОбрабатываемаяОбласть1);
			РазрешитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть2);
		Иначе
			РазрешитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть1);
			ОтображатьНольПрочеркомВОбласти(ОбрабатываемаяОбласть1);
			ЗапретитьВводДанныхВОбласть(Форма, ОбрабатываемаяОбласть2);
		КонецЕсли;
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел3" Тогда
		...
		ОпределяющаяОбласть   = Форма.ТабличныйДокумент.Области.П000030007003_КодЛьготы;
		ОбрабатываемаяОбласть = Форма.ТабличныйДокумент.Области.П000030007003_Основание;
		...
		ОпределяющаяОбласть   = Форма.ТабличныйДокумент.Области.П000030012003_КодЛьготы;
		ОбрабатываемаяОбласть1 = Форма.ТабличныйДокумент.Области.П000030012003_Основание;
		ОбрабатываемаяОбласть2 = Форма.ТабличныйДокумент.Области.П000030013003;
...
&НаКлиентеНаСервереБезКонтекста
Процедура ОтображатьНольЦифройВОбласти(ОбрабатываемаяОбласть)
	
	УстановитьФорматОтображенияНулевогоЗначенияВОбласти(ОбрабатываемаяОбласть, "0");
	
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура ОтображатьНольПрочеркомВОбласти(ОбрабатываемаяОбласть)
	
	УстановитьФорматОтображенияНулевогоЗначенияВОбласти(ОбрабатываемаяОбласть, "-")
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьФорматОтображенияНулевогоЗначенияВОбласти(ОбрабатываемаяОбласть, Знач ФорматОбласти)
	
	Если ФорматОбласти = "0" Тогда
		ФорматОбласти = "";
	КонецЕсли;
	СтрокаФорматированияНулевогоЗначения = "ЧН=" + ФорматОбласти;
	
	ИсходнаяСтрокаФормата = ОбрабатываемаяОбласть.Формат;
	...
	Для Инд = 0 По МассивЭлементовФорматирования.ВГраница() Цикл
		...
		Если СтрНайти(ЭлементФорматаБезКрайнихПробелов, "ЧН") = 1 Тогда
			МассивЭлементовФорматирования[Инд] = СтрокаФорматированияНулевогоЗначения;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	...
	ОбрабатываемаяОбласть.Формат = СобраннаяСтрокаФормата;
...
Процедура УстановитьМаскиВПоляхВвода(ИмяТекРаздела)
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2" Тогда
		...
		ТабличныйДокумент.Области.П000020020003_КодЛьготы.Маска = "9999999";
		ТабличныйДокумент.Области.П000020024003_КодЛьготы.Маска = "9999999";
	...
	ИначеЕсли ИмяТекРаздела = "Раздел3" Тогда
		...
		ТабличныйДокумент.Области.П000030007003_КодЛьготы.Маска = "9999999";
		ТабличныйДокумент.Области.П000030012003_КодЛьготы.Маска = "9999999";
...
Процедура СформироватьРаздел1()
	...
	Для Каждого Стр из ТаблДанных Цикл
		...
		Если НЕ ПустаяСтрока(ОКТМО) И НЕ ПустаяСтрока(ВидИмущества) И СтрНайти("1234567", ВидИмущества) <> 0 Тогда	
			НовСтр = ИтоговаяТаблица.Добавить();
			НовСтр.ОКТМО = ОКТМО;
			НовСтр.КБК = КБКПоКодуВидаИмущества(ВидИмущества);
			
			Если ВидИмущества = "4" Тогда
				МинЗнач = Мин(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Стр.Данные[0].Значение.П000020022003) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Стр.Данные[0].Значение.П000020025003),
				              РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма,Стр.Данные[0].Значение.П000020026003));
				
				НовСтр.Сумма = -МинЗнач;
			Иначе
	...
	Если ИтоговаяТаблица.Количество() > 0 Тогда
		...
		Для Инд = 0 По ИтоговаяТаблица.Количество() - 1 Цикл
			...
			НоваяСтрокаМСЧ.П000010003003 = Макс(0, ТекСтр.Сумма);
			НоваяСтрокаМСЧ.П000010004003 = -1 * Мин(0, ТекСтр.Сумма);
...
Процедура ДополнитьСохраненныеПоказателиОтчета()
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		Числитель   = Данные.П000020018003_Числ;
		Знаменатель = Данные.П000020018003_Знам;
		...
		Иначе
			Доля = "";
		КонецЕсли;
		Данные.Вставить("П100020018003", Доля);
		
		КодЛьготы = Данные.П000020020003_КодЛьготы;
		Основание = Данные.П000020020003_Основание;
		Если ЗначениеЗаполнено(КодЛьготы) Тогда
			ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
		Иначе
			ПолныйКодЛьготы = "";
		КонецЕсли;
		Данные.Вставить("П100020020003", ПолныйКодЛьготы);
		
		КодЛьготы = Данные.П000020024003_КодЛьготы;
		Основание = Данные.П000020024003_Основание;
		Если ЗначениеЗаполнено(КодЛьготы) Тогда
			ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
		Иначе
			ПолныйКодЛьготы = "";
		КонецЕсли;
		Данные.Вставить("П100020024003", ПолныйКодЛьготы);
	...
	Для Каждого Страница Из Раздел3 Цикл
		...
		КодЛьготы = Данные.П000030007003_КодЛьготы;
		Основание = Данные.П000030007003_Основание;
		Если ЗначениеЗаполнено(КодЛьготы) Тогда
			ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
		Иначе
			ПолныйКодЛьготы = "";
		КонецЕсли;
		Данные.Вставить("П100030007003", ПолныйКодЛьготы);
		
		Числитель   = Данные.П000030009003_Числ;
		Знаменатель = Данные.П000030009003_Знам;
		Если ЗначениеЗаполнено(Числитель) И ЗначениеЗаполнено(Знаменатель) Тогда
			Доля = СокрЛП(Формат(Числитель, "ЧГ=") + "/" + Формат(Знаменатель, "ЧГ="));
		Иначе
			Доля = "";
		КонецЕсли;
		Данные.Вставить("П100030009003", Доля);
		
		КодЛьготы = Данные.П000030012003_КодЛьготы;
		Основание = Данные.П000030012003_Основание;
		Если ЗначениеЗаполнено(КодЛьготы) Тогда
			ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
		Иначе
			ПолныйКодЛьготы = "";
		КонецЕсли;
		Данные.Вставить("П100030012003", ПолныйКодЛьготы);
...
Процедура ПроверитьЗаполнение_Раздел1(СочетаниеРазделов, СтатусПроверки)
	...
	Пока ДанныеРаздела.Свойство("П000010001003" + Постфикс) Цикл
		...
		БлокЗаполнен = ЗначениеЗаполнено(ДанныеРаздела["П000010001003" + Постфикс])
		           ...
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеРаздела["П000010004003" + Постфикс]);
...
Процедура ПроверитьЗаполнение_Раздел2(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		ЛистЗаполнен = ЗначениеЗаполнено(ДанныеЛиста.П000020000101) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020001001)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020002003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020002004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020003003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020003004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020004003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020004004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020005003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020005004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020006003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020006004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020007003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020007004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020008003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020008004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020009003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020009004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020010003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020010004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020011003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020011004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020012003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020012004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020013003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020013004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020014003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020014004)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020014103) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020014104)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020015003) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020016003_КодЛьготы)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020017003)
		           ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020018003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020018003_Знам)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020019003) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020020003_КодЛьготы)
		           ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020021003)      ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020022003)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020023003) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020024003_КодЛьготы)
		           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020025003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020026003)
		...
		Если НЕ ЗначениеЗаполнено(КодВидаИмущества) ИЛИ СтрНайти("1234567", КодВидаИмущества) = 0 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 код вида имущества должен быть установлен в значение ""1"", ""2"", ""3"", ""4"", ""5"", ""6"" или ""7""", "Раздел2", "П000020000101", НомерЛиста);	
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(ДанныеЛиста.П000020018003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020018003_Знам) Тогда
			Если НЕ ЗначениеЗаполнено(ДанныеЛиста.П000020018003_Числ) Тогда
				...
				СтатусПроверки = Ложь;
			ИначеЕсли НЕ ЗначениеЗаполнено(ДанныеЛиста.П000020018003_Знам) Тогда
				...
				СтатусПроверки = Ложь;
			ИначеЕсли ДанныеЛиста.П000020018003_Знам < ДанныеЛиста.П000020018003_Числ Тогда
		...
		ИначеЕсли КодВидаИмущества = "2" Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 не задана доля балансовой стоимости объекта недвижимого имущества на территории субъекта РФ", "Раздел2", "П000020018003_Числ", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		// Код льготы в строке 200.
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста.П000020020003_КодЛьготы));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
		...
		// Код льготы в строке 240.
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста.П000020024003_КодЛьготы));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
...
Процедура ПроверитьЗаполнение_Раздел3(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		РазделЗаполнен = ЗначениеЗаполнено(ДанныеЛиста.П000030001001)
		             ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030001401)
		             ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030001501)
		             ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030002003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030002503)
		             ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030003003) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030003503)
		             ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030004003_КодЛьготы)
		             ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030005003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030005003_Знам)
		             ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030006003)
		             ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030007003_КодЛьготы)
		             ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030008003)
		             ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030009003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030009003_Знам)
		             ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030010003)
		             ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030011003)
		             ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030012003_КодЛьготы)
		             ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030013003);
		...
		ЗаполненаКадастроваяСтоимость = (ЗначениеЗаполнено(ДанныеЛиста.П000030002003) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030002503));
		ЗаполненаИнвентаризационнаяСтоимость = (ЗначениеЗаполнено(ДанныеЛиста.П000030003003) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030003503));
		
		Если ЗаполненаКадастроваяСтоимость И ЗаполненаИнвентаризационнаяСтоимость Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 3 одновременно заполнены сведения о кадастровой и инвентаризационной стоимости", "Раздел3", "П000030002003", НомерЛиста);
			СтатусПроверки = Ложь;
		Иначе
			Если ДанныеЛиста.П000030002003 < ДанныеЛиста.П000030002503 Тогда;
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 3 значение в строке 025 превышает значение в строке 020", "Раздел3", "П000030002503", НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если ДанныеЛиста.П000030003003 < ДанныеЛиста.П000030003503 Тогда;
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 3 значение в строке 035 превышает значение в строке 030", "Раздел3", "П000030003503", НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
		...
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 3 неверно задан код налоговой льготы", "Раздел3", "П000030004003_КодЛьготы", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		// Код льготы в строке 070.
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста.П000030007003_КодЛьготы));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 3 неверно задан код налоговой льготы (установленной в виде понижения налоговой ставки)", "Раздел3", "П000030007003_КодЛьготы", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		// Коэффициент К.
		Если ЗначениеЗаполнено(ДанныеЛиста.П000030009003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000030009003_Знам) Тогда
			Если НЕ ЗначениеЗаполнено(ДанныеЛиста.П000030009003_Числ) Тогда
				...
				СтатусПроверки = Ложь;
			ИначеЕсли НЕ ЗначениеЗаполнено(ДанныеЛиста.П000030009003_Знам) Тогда
				...
				СтатусПроверки = Ложь;
			ИначеЕсли ДанныеЛиста.П000030009003_Знам < ДанныеЛиста.П000030009003_Числ Тогда
		...
		// Код льготы в строке 120.
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста.П000030012003_КодЛьготы));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 3 неверно задан код налоговой льготы (в виде уменьшения суммы налога, подлежащей уплате в бюджет)", "Раздел3", "П000030012003_КодЛьготы", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
...
Процедура ПроверитьЗаполнение_СочетаниеРазделов(СочетаниеРазделов, СтатусПроверки)
	...
	ПовторенияРаздела3 = СочетаниеРазделов.Скопировать(СочетанияРаздела3);
	ПовторенияРаздела3.Свернуть("ОКТМО, КадастровыйНомерЗдания, КадастровыйНомерПомещения", "Счетчик3");
	
	Для Каждого СтрокаПроверки Из ПовторенияРаздела3 Цикл
		Если СтрокаПроверки.Счетчик3 > 1 И ЗначениеЗаполнено(СтрокаПроверки.ОКТМО) Тогда
			
			УсловияПоиска = Новый Структура;
			УсловияПоиска.Вставить("ОКТМО", СтрокаПроверки.ОКТМО);
			УсловияПоиска.Вставить("КадастровыйНомерЗдания", СтрокаПроверки.КадастровыйНомерЗдания);
			УсловияПоиска.Вставить("КадастровыйНомерПомещения", СтрокаПроверки.КадастровыйНомерПомещения);
			УсловияПоиска.Вставить("Раздел", 3);
			...
			СообщениеОбОшибке = "Обнаружены дублирующиеся сочетания кода по ОКТМО " + СтрокаПроверки.ОКТМО
			                  + ", кадастрового номера здания " + СтрокаПроверки.КадастровыйНомерЗдания
			                  + ?(ЗначениеЗаполнено(СтрокаПроверки.КадастровыйНомерПомещения), ", кадастрового номера помещения " + СтрокаПроверки.КадастровыйНомерПомещения, "")
			                  + " на страницах " + СписокСтраниц + " раздела 3";
...
Процедура ПроверитьЗаполнение_ТитульныйЛист(ПараметрыВыгрузки, СтатусПроверки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ИННОрг) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан ИНН организации", "Титульный", "ИНН1_1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(ПараметрыВыгрузки.КППОрг) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан КПП организации", "Титульный", "КПП1_1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПараметрыВыгрузки.Период <> "34" И ПараметрыВыгрузки.Период <> "50" Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Значение кода налогового периода должно быть равно ""34"" или ""50""", "Титульный", "Период1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.КодНО) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не задан код налогового органа", "Титульный", "НалоговыйОрган1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ПоМесту) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На титульном листе не задан код места, по которому представляется документ", "Титульный", "ПоМесту1");
		СтатусПроверки = Ложь;
	ИначеЕсли ВозможныеКодыПоМесту.Найти(ПараметрыВыгрузки.ПоМесту) = Неопределено Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На титульном листе задан некорректный код места, по которому представляется документ", "Титульный", "ПоМесту1");
		СтатусПроверки = Ложь;
	КонецЕсли;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель)
	...
	Пока Раздел1.Свойство("П000010001003_" + СтрокаЧГ0(НомерСтроки)) Цикл
		...
		СуммаНалогаУменьш = Раздел1["П000010004003" + Постфикс];
		...
		ЗадатьЗначениеЭлемента(Узел_СумНалПУ, "НалПУ", СуммаНалогаУпл - СуммаНалогаУменьш);
		...
		Для Каждого ЛистРаздела3 Из Раздел3 Цикл
			...
			// Выбор узла с кадастровой или инвентаризационной стоимостью.
			ЗаполненаКадастровая = (ЗначениеЗаполнено(ДанныеРаздела3.П000030002003) ИЛИ ЗначениеЗаполнено(ДанныеРаздела3.П000030002503));
			ЗаполненаИнвентаризационная = (ЗначениеЗаполнено(ДанныеРаздела3.П000030003003) ИЛИ ЗначениеЗаполнено(ДанныеРаздела3.П000030003503));
			
			Узел_ДанРас = ПолучитьПодчиненныйЭлемент(Узел_РасОб, "ДанРас");
			Если НЕ ЗаполненаКадастровая И ЗаполненаИнвентаризационная Тогда
				Узел_СведСтКад = ПолучитьПодчиненныйЭлемент(Узел_ДанРас, "СведСтКад");
				РегламентированнаяОтчетность.УдалитьУзел(Узел_СведСтКад);
			Иначе
				Узел_СведСтИнв = ПолучитьПодчиненныйЭлемент(Узел_ДанРас, "СведСтИнв");
				РегламентированнаяОтчетность.УдалитьУзел(Узел_СведСтИнв);
			КонецЕсли;
...
Процедура ЗаполнитьАвтоНаСервере()
	...
	// { RGS MYurkevich 29.01.2015 10:22:36 - Обновление на 3.0.37.38
	ПараметрыОтчета.Вставить("Подразделение", 			     СтруктураРеквизитовФормы.Подразделение);
	// } RGS MYurkevich 29.01.2015 10:22:36 - Обновление на 3.0.37.38	
	
			                                    		
	Контейнер = Новый Структура();
	Контейнер.Вставить("Раздел1", СтруктураДанныхРаздел1);
	Контейнер.Вставить("Раздел1_ДанныеДопСтрок", П00001000);
...
Процедура Расшифровать(Команда)
	...
	// { RGS MYurkevich 29.01.2015 10:45:49 - Обновление на 3.0.37.38
	//ПараметрыОтчета = Новый Структура();
	//ПараметрыОтчета.Вставить("Организация", 			            СтруктураРеквизитовФормы.Организация);
...
Процедура ПроверитьКС_1_1(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога. подлежащая уплате в бюджет (строка 030 Раздела 1) должна быть равна строка 220 раздела 2 - (строка 230 Раздела 2 + строка 250 раздела 2) + строка 100 Раздела 3 - (строка 110 Раздела 3 + строка 130 Раздела 3) по соответствующим кодам ОКТМО и КБК. а строка 040 раздела 1 должна быть не заполнена, если
	                          |- отсутствует Раздел 2 с кодом имущества = ""4"",
	                          |- строка 220 Раздела 2 - (строка 230 Раздела 2 + строка 250 Раздела 2) + строка 100 Раздела 3 - (строка 110 Раздела 3 + строка 130 Раздела 3) > 0'");
	...
	Р3Стр130 = ПоказательПоСтроке("Р3Стр130");
	...
	Пока Раздел1.Свойство("П000010001003" + Постфикс) Цикл
		...
		ВставитьЗначениеМногострочногоПоказателя(Раздел1, Р1Стр040, НомерСтроки);
		...
		Для Каждого СтраницаР2 Из Раздел2 Цикл
			...
			ВставитьЗначениеПоказателя(ДанныеСтраницыР2, Р2Стр220);
			ВставитьЗначениеПоказателя(ДанныеСтраницыР2, Р2Стр230);
			ВставитьЗначениеПоказателя(ДанныеСтраницыР2, Р2Стр250);
			...
			Если Р2Стр001.Значение = "4" Тогда
				ЕстьРаздел2СКодом4 = Истина;
			КонецЕсли;
			
			КонтрольноеЗначение = КонтрольноеЗначение + Р2Стр220.Значение
			                    - (Р2Стр230.Значение + Р2Стр250.Значение);
		КонецЦикла;
		
		Для Каждого СтраницаР3 Из Раздел3 Цикл
			ДанныеСтраницыР3 = СтраницаР3.Данные[0].Значение;
			НомерСтраницыР3Стр = СтрокаЧГ0(Раздел3.Индекс(СтраницаР3) + 1);
			
			ВставитьЗначениеПоказателя(ДанныеСтраницыР3, Р3Стр010);
			ВставитьЗначениеПоказателя(ДанныеСтраницыР3, Р3Стр100);
			ВставитьЗначениеПоказателя(ДанныеСтраницыР3, Р3Стр110);
			ВставитьЗначениеПоказателя(ДанныеСтраницыР3, Р3Стр130);
			
			Раздел3ОКТМО = СокрЛП(Р3Стр010.Значение);
			Раздел3КБК   = КБКИмуществаИностраннойОрганизации();
			...
			КонтрольноеЗначение = КонтрольноеЗначение + Р3Стр100.Значение
			                    - (Р3Стр110.Значение + Р3Стр130.Значение);
		КонецЦикла;
		
		ПроверятьСоотношение = НЕ ЕстьРаздел2СКодом4 И КонтрольноеЗначение > 0;
		...
		Для Каждого СтраницаР2 Из Раздел2 Цикл
			...
			ВнестиПоказательВРасшифровку(Р2Стр220, "Раздел2", НомерСтраницыР2Стр);
			ВнестиПоказательВРасшифровку(Р2Стр230, "Раздел2", НомерСтраницыР2Стр);
			ВнестиПоказательВРасшифровку(Р2Стр250, "Раздел2", НомерСтраницыР2Стр);
			
			ТекстРасшифровки = Р2Стр220.ЗначениеСтр + " - (" + Р2Стр230.ЗначениеСтр + " + " + Р2Стр250.ЗначениеСтр + ") + ";
		...
		Для Каждого СтраницаР3 Из Раздел3 Цикл
			...
			ВнестиПоказательВРасшифровку(Р3Стр100, "Раздел3", НомерСтраницыР3Стр);
			ВнестиПоказательВРасшифровку(Р3Стр110, "Раздел3", НомерСтраницыР3Стр);
			ВнестиПоказательВРасшифровку(Р3Стр130, "Раздел3", НомерСтраницыР3Стр);
			
			ТекстРасшифровки = Р3Стр100.ЗначениеСтр + " - (" + Р3Стр110.ЗначениеСтр + " + " + Р3Стр130.ЗначениеСтр + ") + ";
			Расшифровка = Расшифровка + ТекстРасшифровки;
			РасшифровкаУсловие = РасшифровкаУсловие + ТекстРасшифровки;
		КонецЦикла;
		...
		Если ЕстьСведенияИсчислений Тогда
			...
			Расшифровка = Расшифровка + " Итог [" + КонтрольноеЗначение + "]"
			            + " и " + Р1Стр040.ЗначениеСтр + " = 0, при условии, что по указанным КБК и ОКТМО нет листа раздела 2 с кодом вида имущества ""4"" и "
			            + РасшифровкаУсловие + " Итог [" + КонтрольноеЗначение + "] > 0";
			
			Если Р1Стр030.Значение > КонтрольноеЗначение ИЛИ ЗначениеЗаполнено(Р1Стр040.Значение) Тогда
				ЭтоОшибка = Истина;
				ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
				ОписаниеОшибки = ОписаниеОшибки1;
			ИначеЕсли Р1Стр030.Значение < КонтрольноеЗначение ИЛИ ЗначениеЗаполнено(Р1Стр040.Значение) Тогда
				ЭтоОшибка = Истина;
				ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		...
		Иначе
			...
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = "Не заполнены листы раздела 2 и раздела 3";
		КонецЕсли;
...
Процедура ПроверитьКС_1_2(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога, подлежащая уплате в бюджет (строка 030 Раздела 1) должна быть равна (строка 220 Раздела 2 - (строка 230 Раздела 2 + строка 250 Раздела 2)) всех разделов 2 с кодами имущества = ""1"", ""2"", ""3"", ""5"", ""6"" - MIN ((строка 220 раздела 2 - строка 250 Раздела 2) или строка 260 Раздела 2) Раздела 2 с кодом вида имущества = ""4""; строка 040 Раздела 1 должна быть не заполнена, если
	                          |- присутствует Раздел 2 с кодом имущества = ""4"";
	                          |- (строка 220 Раздела 2 - (строка 230 Раздела 2 + строка 250 Раздела 2)) всех разделов 2 с кодами имущества = ""1"", ""2"", ""3"", ""5"", ""6"" с соответствующими кодами ОКТМО и КБК - MIN ((строка 220 раздела 2 - строка 250 Раздела 2) или строка 260 Раздела 2)) Раздела 2 с кодом вида имущества = ""4"" > 0'");
	...
	Пока Раздел1.Свойство("П000010001003" + Постфикс) Цикл
		...
		ОКТМО = СокрЛП(Р1Стр010.Значение);
		КБК   = СокрЛП(Р1Стр020.Значение);
		...
		Для Каждого СтраницаР2 Из Раздел2 Цикл
			...
			ВставитьЗначениеПоказателя(ДанныеСтраницыР2, Р2Стр230);
			ВставитьЗначениеПоказателя(ДанныеСтраницыР2, Р2Стр250);
			ВставитьЗначениеПоказателя(ДанныеСтраницыР2, Р2Стр260);
			...
			Если Р2Стр001.Значение = "4" Тогда
				ЕстьРаздел2СКодом4 = Истина;
				КонтрольноеЗначение = КонтрольноеЗначение
				                    - Мин(Р2Стр220.Значение - Р2Стр250.Значение, Р2Стр260.Значение)
			ИначеЕсли ЗначениеСодержитсяВСписке(Р2Стр001.Значение, "1, 2, 3, 5, 6") Тогда
				КонтрольноеЗначение = КонтрольноеЗначение + Р2Стр220.Значение
				                    - (Р2Стр230.Значение + Р2Стр250.Значение);
			КонецЕсли;
		КонецЦикла;
		
		ПроверятьСоотношение = ЕстьРаздел2СКодом4 И КонтрольноеЗначение > 0;
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		Для Каждого СтраницаР2 Из Раздел2 Цикл
			...
			ВнестиПоказательВРасшифровку(Р2Стр001, "Раздел2", НомерСтраницыР2Стр);
			Если Р2Стр001.Значение = "4" Тогда
				ВнестиПоказательВРасшифровку(Р2Стр220, "Раздел2", НомерСтраницыР2Стр);
				ВнестиПоказательВРасшифровку(Р2Стр250, "Раздел2", НомерСтраницыР2Стр);
				ВнестиПоказательВРасшифровку(Р2Стр260, "Раздел2", НомерСтраницыР2Стр);
				
				ТекстРасшифровки = "MIN((" + Р2Стр220.ЗначениеСтр + " - " + Р2Стр250.ЗначениеСтр + "), " + Р2Стр260.ЗначениеСтр + ") + ";
		...
		Если ЕстьСведенияИсчислений Тогда
			...
			Расшифровка = Расшифровка + " Итог [" + КонтрольноеЗначение + "]"
			            + " и " + Р1Стр040.ЗначениеСтр + " = 0, при условии, что по указанным КБК и ОКТМО есть лист раздела 2 с кодом вида имущества ""4"" и "
			            + РасшифровкаУсловие + " Итог [" + КонтрольноеЗначение + "] > 0";
...
Процедура ПроверитьКС_1_3(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога, исчисленная к уменьшению (строка 040 Раздел 1) по соответствующим кодам ОКТМО и КБК должна быть равна - [строка 220 Раздел 2 - (строка 230 Раздел 2 + строка 250 Раздел 2) + строка 100 Раздел 3 - (строка 110 Раздел 3 + строка 130 Раздел 3)] и строка 030 Раздела 1 не заполнена, если:
	                          |- отсутствует раздел 2 с кодом вида имущества = ""4"",
	                          |- строка 220 Раздел 2 - (строка 230 Раздел 2 + строка 250 Раздел 2) + строка 100 Раздел 3 - (строка 110 Раздел 3 + строка 130 Раздел 3) < 0'");
	...
	Пока Раздел1.Свойство("П000010001003" + Постфикс) Цикл
		...
		Если ЕстьСведенияИсчислений Тогда
			Расшифровка = Лев(Расшифровка, СтрДлина(Расшифровка) - 3);
			РасшифровкаУсловие = Лев(РасшифровкаУсловие, СтрДлина(РасшифровкаУсловие) - 3);
			Расшифровка = Расшифровка + ") Итог [" + (-1 * КонтрольноеЗначение) + "]"
			            + " и " + Р1Стр030.ЗначениеСтр + " = 0, при условии, что по указанным КБК и ОКТМО нет листа раздела 2 с кодом вида имущества ""4"" и "
			            + РасшифровкаУсловие + " Итог [" + КонтрольноеЗначение + "] < 0";
			
			Если Р1Стр040.Значение > -1*КонтрольноеЗначение ИЛИ ЗначениеЗаполнено(Р1Стр030.Значение) Тогда
				ЭтоОшибка = Истина;
				ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
				ОписаниеОшибки = ОписаниеОшибки1;
			ИначеЕсли Р1Стр040.Значение < -1*КонтрольноеЗначение ИЛИ ЗначениеЗаполнено(Р1Стр030.Значение) Тогда
				ЭтоОшибка = Истина;
				ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
				ОписаниеОшибки = ОписаниеОшибки2;
			Иначе
...
Процедура ПроверитьКС_1_4(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога, исчисленная к уменьшению (строка 040 Раздела 1) должна быть равна - (строка 220 Раздела 2 - (строка 230 Раздела 2 + строка 250 Раздела 2)) всех разделов 2 с кодами имущества = ""1"", ""2"", ""3"", ""5"", ""6"" - MIN ((строка 220 раздела 2 - строка 250 Раздела 2) или строка 260 Раздела 2) Раздела 2 с кодом вида имущества = ""4""; строка 030 Раздела 1 должна быть не заполнена, если
	                          |- присутствует Раздел 2 с кодом имущества = ""4"";
	                          |- (строка 220 Раздела 2 - (строка 230 Раздела 2 + строка 250 Раздела 2)) всех разделов 2 с кодами имущества = ""1"", ""2"", ""3"", ""5"", ""6"" с соответствующими кодами ОКТМО и КБК - MIN ((строка 220 раздела 2 - строка 250 Раздела 2) или строка 260 Раздела 2) Раздела 2 с кодом вида имущества = ""4"" < 0'");
	...
	Пока Раздел1.Свойство("П000010001003" + Постфикс) Цикл
		...
		Если ЕстьСведенияИсчислений Тогда
			...
			Расшифровка = Расшифровка + ") Итог [" + (-1 * КонтрольноеЗначение) + "]"
			            + " и " + Р1Стр030.ЗначениеСтр + " = 0, при условии, что по указанным КБК и ОКТМО есть лист раздела 2 с кодом вида имущества ""4"" и "
			            + РасшифровкаУсловие + " Итог [" + КонтрольноеЗначение + "] < 0";
...
Процедура ПроверитьКС_1_5(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Среднегодовая стоимость имущества за налоговый период (строка 150 Раздела 2) должна быть равна (строка 020 графа 3 Раздела 2 + строка 030 графа 3 Раздела 2 + строка 040 графа 3 Раздела 2 + строка 050 графа 3 Раздела 2 + строка 060 графа 3 Раздела 2 + строка 070 графа 3 Раздела 2 + строка 080 графа 3 Раздела 2 + строка 090 графа 3 Раздела 2 + строка 100 графа 3 Раздела 2 + строка 110 графа 3 Раздела 2 + строка 120 графа 3 Раздела 2 + строка 130 графа 3 Раздела 2 + строка 140 графа 3 Раздела 2) / 13'");
	
	Нарушение       = НСтр("ru='НК РФ ст.376 п.4'");
	ОписаниеОшибки1 = НСтр("ru='Завышена среднегодовая стоимость имущества за налоговый период'");
	ОписаниеОшибки2 = НСтр("ru='Занижена среднегодовая стоимость имущества за налоговый период'");
	...
	Р2Стр120Гр3 = ПоказательПоСтроке("Р2Стр120Гр3");
	Р2Стр130Гр3 = ПоказательПоСтроке("Р2Стр130Гр3");
	Р2Стр140Гр3 = ПоказательПоСтроке("Р2Стр140Гр3");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр120Гр3);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр130Гр3);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр140Гр3);
		...
		ВнестиПоказательВРасшифровку(Р2Стр120Гр3, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр130Гр3, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр140Гр3, "Раздел2", НомерСтраницыСтр);
		...
		КонтрольноеЗначение = (Р2Стр020Гр3.Значение + Р2Стр030Гр3.Значение + Р2Стр040Гр3.Значение + Р2Стр050Гр3.Значение
		                    ...
		                    + Р2Стр090Гр3.Значение + Р2Стр100Гр3.Значение + Р2Стр110Гр3.Значение
		                    + Р2Стр120Гр3.Значение + Р2Стр130Гр3.Значение + Р2Стр140Гр3.Значение) / 13;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		
		Если Р2Стр150.Значение > КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки1;
		ИначеЕсли Р2Стр150.Значение < КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки2;
		Иначе
		...
		Расшифровка = Р2Стр150.ЗначениеСтр + " = (" + Р2Стр020Гр3.ЗначениеСтр
		            ...
		            + " + " + Р2Стр110Гр3.ЗначениеСтр + " + " + Р2Стр120Гр3.ЗначениеСтр
		            + " + " + Р2Стр130Гр3.ЗначениеСтр + " + " + Р2Стр140Гр3.ЗначениеСтр + ") / 13"
...
Процедура ПроверитьКС_1_6(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Среднегодовая стоимость необлагаемого налогом имущества за налоговый период (строка 170 Раздела 2) должна быть равна (строка 020 графа 4 Раздела 2 + строка 030 графа 4 Раздела 2 + строка 040 графа 4 Раздела 2 + строка 050 графа 4 Раздела 2 + строка 060 графа 4 Раздела 2 + строка 070 графа 4 Раздела 2 + строка 080 графа 4 Раздела 2 + строка 090 графа 4 Раздела 2 + строка 100 графа 4 Раздела 2 + строка 110 графа 4 Раздела 2 + строка 120 графа 4 Раздела 2 + строка 130 графа 4 Раздела 2 + строка 140 графа 4 Раздела 2) / 13'");
	
	Нарушение       = НСтр("ru='НК РФ ст.376 п.4'");
	ОписаниеОшибки1 = НСтр("ru='Завышена среднегодовая стоимость необлагаемого налогом имущества за налоговый период'");
	ОписаниеОшибки2 = НСтр("ru='Занижена среднегодовая стоимость необлагаемого налогом имущества за налоговый период'");
	...
	Р2Стр120Гр4 = ПоказательПоСтроке("Р2Стр120Гр4");
	Р2Стр130Гр4 = ПоказательПоСтроке("Р2Стр130Гр4");
	Р2Стр140Гр4 = ПоказательПоСтроке("Р2Стр140Гр4");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр120Гр4);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр130Гр4);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр140Гр4);
		...
		ВнестиПоказательВРасшифровку(Р2Стр120Гр4, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр130Гр4, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр140Гр4, "Раздел2", НомерСтраницыСтр);
		...
		КонтрольноеЗначение = (Р2Стр020Гр4.Значение + Р2Стр030Гр4.Значение + Р2Стр040Гр4.Значение + Р2Стр050Гр4.Значение
		                    ...
		                    + Р2Стр090Гр4.Значение + Р2Стр100Гр4.Значение + Р2Стр110Гр4.Значение
		                    + Р2Стр120Гр4.Значение + Р2Стр130Гр4.Значение + Р2Стр140Гр4.Значение) / 13;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		
		Если Р2Стр170.Значение > КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки1;
		ИначеЕсли Р2Стр170.Значение < КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки2;
		Иначе
		...
		Расшифровка = Р2Стр170.ЗначениеСтр + " = (" + Р2Стр020Гр4.ЗначениеСтр
		            ...
		            + " + " + Р2Стр110Гр4.ЗначениеСтр + " + " + Р2Стр120Гр4.ЗначениеСтр
		            + " + " + Р2Стр130Гр4.ЗначениеСтр + " + " + Р2Стр140Гр4.ЗначениеСтр + ") / 13"
		            + " Итог [" + КонтрольноеЗначение + "]";
...
Процедура ПроверитьКС_1_7(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Средняя стоимость необлагаемого налогом имущества за отчетный период (строка 170 Раздела 2) должна быть равна нулю, если значение строки 160 Раздела 2 равно нулю или средняя стоимость необлагаемого налогом имущества за отчетный период (строка 170 Раздела 2) должна быть отличной от нуля, если значение строки 160 Раздела 2 отлично от нуля'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		КорректноеЗаполнение = (ЗначениеЗаполнено(Р2Стр160.Значение) = ЗначениеЗаполнено(Р2Стр170.Значение));
		...
		Расшифровка = Р2Стр170.ЗначениеСтр + " = 0 при условии, что код льготы не заполнен (""" + Р2Стр160.ЗначениеСтр + """) или "
		            + Р2Стр170.ЗначениеСтр + " <> 0 при условии, что код льготы заполнен (""" + Р2Стр160.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_1_8(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Налоговая база (строка 190 Раздела 2) должна быть равна произведению разницы строк 150 и 170 Раздела 2 и строки 180 Раздела 2, если код вида имущества (строка 001 Раздела 2) = ""2""'");
	...
	Р2Стр150  = ПоказательПоСтроке("Р2Стр150");
	Р2Стр170  = ПоказательПоСтроке("Р2Стр170");
	Р2Стр180ч = ПоказательПоСтроке("Р2Стр180ч");
	Р2Стр180з = ПоказательПоСтроке("Р2Стр180з");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр150);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр170);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр180ч);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр180з);
		...
		ВнестиПоказательВРасшифровку(Р2Стр150, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр170, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр180ч, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр180з, "Раздел2", НомерСтраницыСтр);
		Если ЗначениеЗаполнено(Р2Стр180з.Значение) Тогда
			РасшифровкаР2Стр180 = " * " + Р2Стр180ч.ЗначениеСтр + "/" + Р2Стр180з.ЗначениеСтр;
		Иначе
			Р2Стр180ч.Значение = 0;
			Р2Стр180з.Значение = 1;
			РасшифровкаР2Стр180 = " * 0 ";
		КонецЕсли;
		
		КонтрольноеЗначение = (Р2Стр150.Значение - Р2Стр170.Значение) * Р2Стр180ч.Значение / Р2Стр180з.Значение;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		...
		Если Р2Стр190.Значение > КонтрольноеЗначение Тогда
			...
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки1;
		ИначеЕсли Р2Стр190.Значение < КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки2;
		Иначе
		...
		Расшифровка = Р2Стр190.ЗначениеСтр + " = (" + Р2Стр150.ЗначениеСтр
		            + " - " + Р2Стр170.ЗначениеСтр + ")" + РасшифровкаР2Стр180
		            + " Итог [" + КонтрольноеЗначение + "]"
...
Процедура ПроверитьКС_1_9(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Налоговая база (строка 190 Раздела 2) должна быть равна разнице строк 150 и 170 Раздела 2, если код вида имущества (строка 001 Раздела 2) = ""1"" или = ""3"" или = ""4"" или = ""5"" или = ""6""'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = ЗначениеСодержитсяВСписке(Р2Стр001.Значение, "1, 3, 4, 5, 6");
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		КонтрольноеЗначение = Р2Стр150.Значение - Р2Стр170.Значение;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		...
		Расшифровка = Р2Стр190.ЗначениеСтр + " = " + Р2Стр150.ЗначениеСтр
		            + " - " + Р2Стр170.ЗначениеСтр
		            + " Итог [" + КонтрольноеЗначение + "]"
		            + " при условии, что """ + Р2Стр001.ЗначениеСтр + """ = [""1"", ""3"", ""4"", ""5"", ""6""]";
...
Процедура ПроверитьКС_1_10(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога за налоговый период (строка 220 Раздела 2) должна быть равна произведению строк 190 и 210 Раздела 2 деленое на 100'");
	
	Нарушение       = НСтр("ru='НК РФ ст.382 п.1, НК РФ ст.383 п.4'");
	ОписаниеОшибки1 = НСтр("ru='Завышена сумма налога'");
	ОписаниеОшибки2 = НСтр("ru='Занижена сумма налога'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		КонтрольноеЗначение = Р2Стр190.Значение * Р2Стр210.Значение / 100;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		
		Если Р2Стр220.Значение > КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки1;
		ИначеЕсли Р2Стр220.Значение < КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки2;
		Иначе
		...
		Расшифровка = Р2Стр220.ЗначениеСтр + " = " + Р2Стр190.ЗначениеСтр
		            + " * " + Р2Стр210.ЗначениеСтр + " / 100"
		            + " Итог [" + КонтрольноеЗначение + "]";
...
Процедура ПроверитьКС_1_11(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма авансовых платежей, исчисленная за отчетные периоды (строка 230 Раздела 2) должна быть равна сумме авансовых платежей по строкам 180 Раздела 2 налогового расчета по авансовому платежу за 1 квартал, полугодие, 9 месяцев теккущего налогового периода'");
	
	Нарушение      = НСтр("ru='НК РФ ст.382 п.2 и 4'");
	ОписаниеОшибки1 = НСтр("ru='Завышена сумма налога'");
	ОписаниеОшибки2 = НСтр("ru='Занижена сумма налога'");
	
	Р2Стр230 = ПоказательПоСтроке("Р2Стр230");
	
	Р2Стр180Авансы = Новый Структура;
	Р2Стр180Авансы.Вставить("Имя", "П000020018003");
	Р2Стр180Авансы.Вставить("Представление", "Сумма авансового платежа (строка 180%1 раздела 2 Налогового расчета авансового платежа по налогу на имущество организаций)");
	Р2Стр180Авансы.Вставить("ИзменяемаяРазмерность", Истина);
	
	Раздел2 = мДанныеОтчета.Раздел2;
	
	СсылкаНаДокумент = СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка;
	АвансыКвартала1 = РасчетАвансовыхПлатежей(СсылкаНаДокумент, 1);
	АвансыКвартала2 = РасчетАвансовыхПлатежей(СсылкаНаДокумент, 2);
	АвансыКвартала3 = РасчетАвансовыхПлатежей(СсылкаНаДокумент, 3);
	
	ПроверятьСоотношение = АвансыКвартала1 <> Неопределено
	                   ИЛИ АвансыКвартала2 <> Неопределено
	                   ИЛИ АвансыКвартала3 <> Неопределено;
	Если НЕ ПроверятьСоотношение Тогда
		Возврат;
	КонецЕсли;
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		СтрокДекларации = СтрокДекларации + 1;
		
		ПроверяемоеЗначение = ПроверяемоеЗначение + Р2Стр230.Значение;
		Расшифровка = Расшифровка + Р2Стр230.ЗначениеСтр + " + ";
	КонецЦикла;
	
	Расшифровка = Лев(Расшифровка, СтрДлина(Расшифровка) - 3);
	Если СтрокДекларации > 1 Тогда
		Расшифровка = Расшифровка + " Итог [" + ПроверяемоеЗначение + "]";
	КонецЕсли;
	...
	Если АвансыКвартала1 <> Неопределено Тогда
		СведенияАвансов = АвансыКвартала1.ДанныеОтчета.Получить();
		Раздел2 = СведенияАвансов.ДанныеМногостраничныхРазделов.Раздел2;
		
		Для Каждого Страница Из Раздел2 Цикл
			ДанныеСтраницы = Страница.Данные;
			НомерСтраницыСтр = СтрокаЧГ0(Раздел2.Индекс(Страница) + 1);
			
			ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр180Авансы);
			
			ВнестиПоказательАвансовВРасшифровку(АвансыКвартала1, Р2Стр180Авансы, "Раздел2", НомерСтраницыСтр);
			СтрокРасчетов = СтрокРасчетов + 1;
			
			КонтрольноеЗначение = КонтрольноеЗначение + Р2Стр180Авансы.Значение;
			Расшифровка = Расшифровка + Р2Стр180Авансы.ЗначениеСтр + " + ";
		КонецЦикла;
	КонецЕсли;
	
	Если АвансыКвартала2 <> Неопределено Тогда
		СведенияАвансов = АвансыКвартала2.ДанныеОтчета.Получить();
		Раздел2 = СведенияАвансов.ДанныеМногостраничныхРазделов.Раздел2;
		...
		Для Каждого Страница Из Раздел2 Цикл
			...
			ВнестиПоказательАвансовВРасшифровку(АвансыКвартала2, Р2Стр180Авансы, "Раздел2", НомерСтраницыСтр);
			СтрокРасчетов = СтрокРасчетов + 1;
	...
	Если АвансыКвартала3 <> Неопределено Тогда
		СведенияАвансов = АвансыКвартала3.ДанныеОтчета.Получить();
		Раздел2 = СведенияАвансов.ДанныеМногостраничныхРазделов.Раздел2;
		...
		Для Каждого Страница Из Раздел2 Цикл
			...
			ВнестиПоказательАвансовВРасшифровку(АвансыКвартала3, Р2Стр180Авансы, "Раздел2", НомерСтраницыСтр);
			СтрокРасчетов = СтрокРасчетов + 1;
	...
	Если ПроверяемоеЗначение < КонтрольноеЗначение Тогда
		...
		ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		ОписаниеОшибки = ОписаниеОшибки1;
	ИначеЕсли ПроверяемоеЗначение > КонтрольноеЗначение Тогда
		ЭтоОшибка = Истина;
		ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		ОписаниеОшибки = ОписаниеОшибки2;
	Иначе
...
Процедура ПроверитьКС_1_12(СтруктураРезультата)
	...
	РазрешенныйКодЛьготы = "2012500";
	
	ТекстФормулы   = НСтр("ru='Проверка раздела 2 (КС 1.12)'");
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы, уменьшающей сумму налога, подлежащую уплате в бюджет (строка 250 Раздела 2) должна быть не равна нулю, если значение строки 240 Раздела 2 равно ""'") + РазрешенныйКодЛьготы + """";
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = (Р2Стр240.Значение = РазрешенныйКодЛьготы);
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		Если Р2Стр250.Значение = 0 Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = Р2Стр250.ЗначениеСтр + " <> 0"
		            + " при условии, что """ + Р2Стр240.ЗначениеСтр + """ = """ + РазрешенныйКодЛьготы + """";
...
Процедура ПроверитьКС_1_15(СтруктураРезультата)
	...
	РазрешенныйКодЛьготы = "2012400";
	
	ТекстФормулы   = НСтр("ru='Проверка раздела 2 (КС 1.15)'");
	ОписаниеКС     = НСтр("ru='Код налоговой льготы, установленной в виде понижения налоговой ставки (строка 200 Раздела 2) должен быть равен '") + РазрешенныйКодЛьготы + ", если такая льгота указана";
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		Если Р2Стр200.Значение <> РазрешенныйКодЛьготы Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = """" + Р2Стр200.ЗначениеСтр + """ = """ + РазрешенныйКодЛьготы + """";
...
Процедура ПроверитьКС_1_16(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Код налоговой льготы в виде уменьшения суммы налога, подлежащей уплате в бюджет (строка 240 Раздела 2) должен быть равен '") + РазрешенныйКодЛьготы + ", если такая льгота указана";
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		Если Р2Стр240.Значение <> РазрешенныйКодЛьготы Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = """" + Р2Стр240.ЗначениеСтр + """ = """ + РазрешенныйКодЛьготы + """";
...
Процедура ПроверитьКС_1_17(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы, уменьшающей сумму налога, подлежащую уплате в бюджет (строка 250 Раздела 2) должна быть равна нулю, если строка 240 раздела не равна ""'") + РазрешенныйКодЛьготы + """";
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = ЗначениеЗаполнено(Р2Стр240.Значение) И Р2Стр240.Значение <> РазрешенныйКодЛьготы;
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ПроверитьКС_1_18(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Налоговая база (строка 060 раздела 3) должна быть равна разнице значений строк 030 и 035 Раздела 3, если значение строки 050 Раздела 3 = 0'");
	
	Нарушение       = НСтр("ru='НК РФ ст.376 п.2, НК РФ ст.375 п.2'");
	ОписаниеОшибки1 = НСтр("ru='Возможно завышение суммы налога'");
	ОписаниеОшибки2 = НСтр("ru='Возможно занижение суммы налога'");
	
	Р3Стр030  = ПоказательПоСтроке("Р3Стр030");
	Р3Стр035  = ПоказательПоСтроке("Р3Стр035");
	Р3Стр050ч = ПоказательПоСтроке("Р3Стр050ч");
	Р3Стр050з = ПоказательПоСтроке("Р3Стр050з");
	Р3Стр060  = ПоказательПоСтроке("Р3Стр060");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр035);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр050ч);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр050з);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр060);
		
		ПроверятьСоотношение = Год(СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка.ДатаОкончания) <= 2013
		                     И НЕ ЗначениеЗаполнено(Р3Стр050ч.Значение)
		                     И НЕ ЗначениеЗаполнено(Р3Стр050з.Значение);
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		ВнестиПоказательВРасшифровку(Р3Стр060, "Раздел3", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р3Стр030, "Раздел3", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р3Стр035, "Раздел3", НомерСтраницыСтр);
		...
		КонтрольноеЗначение = Р3Стр030.Значение - Р3Стр035.Значение;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		
		Если Р3Стр060.Значение > КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки1;
		ИначеЕсли Р3Стр060.Значение < КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки1;
		Иначе
		...
		Расшифровка = Р3Стр060.ЗначениеСтр + " = " + Р3Стр030.ЗначениеСтр + " - " + Р3Стр035.ЗначениеСтр
		            + " Итог [" + КонтрольноеЗначение + "]"
		            + " при условии, что доля стоимости не заполнена";
...
Процедура ПроверитьКС_1_19(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Налоговая база (строка 060 раздела 3) должна быть равна произведению значения строки 050 Раздела и разницы значений строк 030 и 035 Раздела 3, если значение строки 050 Раздела 3 не равно 0'");
	...
	Для Каждого Страница Из Раздел3 Цикл
		ДанныеСтраницы = Страница.Данные[0].Значение;
		НомерСтраницыСтр = СтрокаЧГ0(Раздел3.Индекс(Страница) + 1);
		...
		ПроверятьСоотношение = Год(СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка.ДатаОкончания) <= 2013
		                     И (ЗначениеЗаполнено(Р3Стр050ч.Значение) И ЗначениеЗаполнено(Р3Стр050з.Значение));
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		КонтрольноеЗначение = (Р3Стр030.Значение - Р3Стр035.Значение) * Р3Стр050ч.Значение / Р3Стр050з.Значение;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		...
		Расшифровка = Р3Стр060.ЗначениеСтр + " = (" + Р3Стр030.ЗначениеСтр + " - " + Р3Стр035.ЗначениеСтр + ")"
		            + " * " + Р3Стр050ч.ЗначениеСтр + " / " + Р3Стр050з.ЗначениеСтр
		            + " Итог [" + КонтрольноеЗначение + "]"
		            + " при условии, что доля стоимости заполнена";
...
Процедура ПроверитьКС_1_20(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Налоговая база (строка 060 Раздела 3) должна быть равна (строка 020 Раздела 3 - строка 025 Раздела 3) * строка 050 Раздела 3'");
	
	Нарушение       = НСтр("ru='НК РФ ст.376 п.2, НК РФ ст.375 п.2,3'");
	ОписаниеОшибки1 = НСтр("ru='Завышена сумма налога'");
	ОписаниеОшибки2 = НСтр("ru='Занижена сумма налога'");
	
	Р3Стр020  = ПоказательПоСтроке("Р3Стр020");
	Р3Стр025  = ПоказательПоСтроке("Р3Стр025");
	Р3Стр050ч = ПоказательПоСтроке("Р3Стр050ч");
	Р3Стр050з = ПоказательПоСтроке("Р3Стр050з");
	Р3Стр060  = ПоказательПоСтроке("Р3Стр060");
	...
	Для Каждого Страница Из Раздел3 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр025);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр050ч);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр050з);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр060);
		
		ПроверятьСоотношение = Год(СтруктураРеквизитовФормы.мСохраненныйДок.Ссылка.ДатаОкончания) >= 2014;
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		ВнестиПоказательВРасшифровку(Р3Стр025, "Раздел3", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р3Стр050ч, "Раздел3", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р3Стр050з, "Раздел3", НомерСтраницыСтр);
		Если ЗначениеЗаполнено(Р3Стр050ч.Значение) И ЗначениеЗаполнено(Р3Стр050з.Значение) Тогда
			РасшифровкаР3Стр050 = " * " + Р3Стр050ч.ЗначениеСтр + "/" + Р3Стр050з.ЗначениеСтр;
		Иначе
			Р3Стр050ч.Значение = 1;
			Р3Стр050з.Значение = 1;
			РасшифровкаР3Стр050 = " * 1 [доля стоимости не указана]";
		КонецЕсли;
		
		КонтрольноеЗначение = (Р3Стр020.Значение - Р3Стр025.Значение) * Р3Стр050ч.Значение / Р3Стр050з.Значение;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		...
		Расшифровка = Р3Стр060.ЗначениеСтр + " = (" + Р3Стр020.ЗначениеСтр + " - " + Р3Стр025.ЗначениеСтр + ")"
		            + РасшифровкаР3Стр050
		            + " Итог [" + КонтрольноеЗначение + "]";
...
Процедура ПроверитьКС_1_21(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога за налоговый период (строка 100 Раздела 3) должна быть равна строка 060 Раздела 3 * строка 080 Раздела 3 * строка 090 Раздела 3 / 100, при условии, что строка 090 Раздела 3 заполнена'");
	...
	Р3Стр060  = ПоказательПоСтроке("Р3Стр060");
	Р3Стр080  = ПоказательПоСтроке("Р3Стр080");
	Р3Стр090ч = ПоказательПоСтроке("Р3Стр090ч");
	Р3Стр090з = ПоказательПоСтроке("Р3Стр090з");
	Р3Стр100  = ПоказательПоСтроке("Р3Стр100");
	...
	Для Каждого Страница Из Раздел3 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр060);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр080);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр090ч);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр090з);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр100);
		
		ПроверятьСоотношение = ЗначениеЗаполнено(Р3Стр090ч.Значение) И ЗначениеЗаполнено(Р3Стр090з.Значение);
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		ВнестиПоказательВРасшифровку(Р3Стр060, "Раздел3", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р3Стр080, "Раздел3", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р3Стр090ч, "Раздел3", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р3Стр090з, "Раздел3", НомерСтраницыСтр);
		
		КонтрольноеЗначение = Р3Стр060.Значение * Р3Стр080.Значение * Р3Стр090ч.Значение / Р3Стр090з.Значение / 100;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		
		Если Р3Стр100.Значение > КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки1;
		ИначеЕсли Р3Стр100.Значение < КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
			ОписаниеОшибки = ОписаниеОшибки1;
		Иначе
		...
		Расшифровка = Р3Стр100.ЗначениеСтр + " = " + Р3Стр060.ЗначениеСтр + " * " + Р3Стр080.ЗначениеСтр
		            + " * " + Р3Стр090ч.ЗначениеСтр + " / " + Р3Стр090з.ЗначениеСтр + " / 100"
		            + " Итог [" + КонтрольноеЗначение + "]"
		            + " при условии, что коэффициент К заполнен";
...
Процедура ПроверитьКС_1_22(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога за налоговый период (строка 100 Раздела 3) должна быть равна строка 060 Раздела 3 х строка 080 Раздела 3 / 100, при условии, что строка 090 Раздела 3 не заполнена'");
	...
	Для Каждого Страница Из Раздел3 Цикл
		...
		ПроверятьСоотношение = НЕ (ЗначениеЗаполнено(Р3Стр090ч.Значение) И ЗначениеЗаполнено(Р3Стр090з.Значение));
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		КонтрольноеЗначение = Р3Стр060.Значение * Р3Стр080.Значение / 100;
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, Окр(КонтрольноеЗначение, 2));
		...
		Расшифровка = Р3Стр100.ЗначениеСтр + " = " + Р3Стр060.ЗначениеСтр + " * " + Р3Стр080.ЗначениеСтр + " / 100"
		            + " Итог [" + КонтрольноеЗначение + "]"
		            + " при условии, что коэффициент К не заполнен";
...
Процедура ПроверитьКС_1_23(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы, уменьшающей сумму налога, подлежащую уплате в бюджет (строка 130 Раздела 3) должна быть заполнена, если значение строки 120 Раздела 3 = ""'") + РазрешенныйКодЛьготы + """";
	
	Нарушение      = НСтр("ru='НК РФ ст. 372 п.2'");
	ОписаниеОшибки = НСтр("ru='Завышена сумма налога'");
	
	Р3Стр120 = ПоказательПоСтроке("Р3Стр120");
	Р3Стр130 = ПоказательПоСтроке("Р3Стр130");
	...
	Для Каждого Страница Из Раздел3 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр120);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р3Стр130);
		
		ПроверятьСоотношение = (Р3Стр120.Значение = РазрешенныйКодЛьготы);
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		ВнестиПоказательВРасшифровку(Р3Стр130, "Раздел3", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р3Стр120, "Раздел3", НомерСтраницыСтр);
		
		Если НЕ ЗначениеЗаполнено(Р3Стр130.Значение) Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = Р3Стр130.ЗначениеСтр + " <> 0 при условии что """ + Р3Стр120.ЗначениеСтр + """ = """ + РазрешенныйКодЛьготы + """";
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр120Гр3" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр130Гр3" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр140Гр3" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр120Гр4" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр130Гр4" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр140Гр4" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр180ч" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр180з" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р3Стр025" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р3Стр030" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Инвентаризационная стоимость на 1 января налогового периода (строка 030%1 раздела 3)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р3Стр035" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р3Стр090з" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р3Стр120" Тогда
	...
	ИначеЕсли УсловныйКодПоказателя = "Р3Стр130" Тогда
...
&НаСервере
Процедура ВнестиПоказательАвансовВРасшифровку(ДокументАвансов, Показатель, ИмяСтраницы, НомерСтраницы = Неопределено)
...
&НаСервере
Функция РасчетАвансовыхПлатежей(Декларация, Квартал)
	...
	Запрос.УстановитьПараметр("ИсточникОтчета", "РегламентированныйОтчетАвансыИмущество");
	...
	Запрос.УстановитьПараметр("ДатаНачала", НачалоГода(Декларация.ДатаНачала));
	Запрос.УстановитьПараметр("ДатаОкончания", НачалоДня(ДобавитьМесяц(НачалоГода(Декларация.ДатаНачала), 3 * Квартал) - 1));
...
Процедура ПодразделениеПриИзменении(Элемент)
	СтруктураРеквизитовФормы.Подразделение = Подразделение;
	//ЗаполнитьСведенияОбОрганизацииНаСервере();TODO
КонецПроцедуры
