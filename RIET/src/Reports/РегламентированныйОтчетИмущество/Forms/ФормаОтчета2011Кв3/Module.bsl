...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК = Новый Соответствие;
	СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК.Вставить("1", "18210602020021000110");
	СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК.Вставить("2", "18210602010021000110");
	СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК.Вставить("3", "18210602010021000110");
	СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК.Вставить("4", "18210602010021000110");
	СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК.Вставить("5", "18210602010021000110");
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("СоответствиеКодаВидаИмуществаКБК");
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("Списки2011Кв3");
	...
	Для Каждого Область Из МакетСоставаПоказателей.Области Цикл
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			ШиринаКолонкиКод = МакетСоставаПоказателей.Область(ВерхОбласти, 1).ШиринаКолонки;
			КоэффициентПеренормировки = 0.7;
			ШиринаКолонкиКод = Окр(ШиринаКолонкиКод * КоэффициентПеренормировки, 0, РежимОкругления.Окр15как20);
			ТаблСписка.Колонки.Добавить("Код", , , ШиринаКолонкиКод);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ОКАТО",           11, "ОКАТО");
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010002000_1", 20, , "Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010002000_2", 20, , "Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010002000_3", 20, , "Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010002000_4", 20, , "Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010002000_5", 20, , "Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010002000_6", 20, , "Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2012-01-01' Тогда
		ИмяСпискаЛьгот = "Льготы2012Кв1";
	Иначе
		ИмяСпискаЛьгот = "Льготы";
	КонецЕсли;
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020016003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора[ИмяСпискаЛьгот]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020020003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льгота2012400"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020024003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льгота2012500"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030004003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора[ИмяСпискаЛьгот]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030007003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льгота2012400"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030012003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льгота2012500"]);
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяСтраницыПанели = "Раздел2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
			...
			КодВидаИмущества = СокрЛП(ПолеТабличногоДокументаРаздел2.П000020000100.Значение);
...
Процедура ПолныйРасчетРаздела2(Форма, ОбластьИмя = "")
	...
	Для Каждого СтраницаРаздела2 Из Форма.ТаблицаСтраницыРазделаРаздел2 Цикл
		...
		КодВидаИмущества = СокрЛП(ПолеТабличногоДокументаРаздел2.П000020000100);
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	Если ИмяРаздела = "Раздел2" И ИмяОбласти = "П000020018003_Числ" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000020018003_Знам"].Значение) 
		   И ТабличныйДокумент.Области["П000020018003_Числ"].Значение > ТабличныйДокумент.Области["П000020018003_Знам"].Значение Тогда
			ТабличныйДокумент.Области["П000020018003_Числ"].Значение = ТабличныйДокумент.Области["П000020018003_Знам"].Значение;		
			Сообщение = Новый СообщениеПользователю;			
			Сообщение.Текст = НСтр("ru='Числитель дроби показателя в строке 180 не может превышать значение знаменателя.'");			
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	
	Если ИмяРаздела = "Раздел2" И ИмяОбласти = "П000020018003_Знам" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000020018003_Числ"].Значение) 
		   И ТабличныйДокумент.Области["П000020018003_Числ"].Значение > ТабличныйДокумент.Области["П000020018003_Знам"].Значение Тогда
			ТабличныйДокумент.Области["П000020018003_Знам"].Значение = ТабличныйДокумент.Области["П000020018003_Числ"].Значение;
			Сообщение = Новый СообщениеПользователю;			
			Сообщение.Текст = НСтр("ru='Знаменатель дроби показателя в строке 180 не может быть меньше значения числителя.'");			
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	
	Если ИмяРаздела = "Раздел3" И ИмяОбласти = "П000030005003_Числ" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000030005003_Знам"].Значение) 
		   И ТабличныйДокумент.Области["П000030005003_Числ"].Значение > ТабличныйДокумент.Области["П000030005003_Знам"].Значение Тогда
			ТабличныйДокумент.Области["П000030005003_Числ"].Значение = ТабличныйДокумент.Области["П000030005003_Знам"].Значение;
			Сообщение = Новый СообщениеПользователю;			
			Сообщение.Текст = НСтр("ru='Числитель дроби показателя в строке 050 не может превышать значение знаменателя.'");			
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	
	Если ИмяРаздела = "Раздел3" И ИмяОбласти = "П000030005003_Знам" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000030005003_Числ"].Значение) 
		   И ТабличныйДокумент.Области["П000030005003_Числ"].Значение > ТабличныйДокумент.Области["П000030005003_Знам"].Значение Тогда
			ТабличныйДокумент.Области["П000030005003_Знам"].Значение = ТабличныйДокумент.Области["П000030005003_Числ"].Значение;
			Сообщение = Новый СообщениеПользователю;			
			Сообщение.Текст = НСтр("ru='Знаменатель дроби показателя в строке 050 не может быть меньше значения числителя.'");			
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	
	ЭтоПолеВводаКоэффициента = (ИмяРаздела = "Раздел3" И (ИмяОбласти = "П000030009003_Числ" ИЛИ ИмяОбласти = "П000030009003_Знам"));
	Если ЭтоПолеВводаКоэффициента И Область.Значение > 12 Тогда
		Область.Значение = 12;
	КонецЕсли;
	
	Если ИмяРаздела = "Раздел3" И ИмяОбласти = "П000030009003_Числ" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000030009003_Знам"].Значение) 
		   И ТабличныйДокумент.Области["П000030009003_Числ"].Значение > ТабличныйДокумент.Области["П000030009003_Знам"].Значение Тогда
			ТабличныйДокумент.Области["П000030009003_Числ"].Значение = ТабличныйДокумент.Области["П000030009003_Знам"].Значение;
			Сообщение = Новый СообщениеПользователю;			
			Сообщение.Текст = НСтр("ru='Числитель дроби показателя в строке 090 не может превышать значение знаменателя.'");			
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	
	Если ИмяРаздела = "Раздел3" И ИмяОбласти = "П000030009003_Знам" Тогда
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["П000030009003_Числ"].Значение) 
		   И ТабличныйДокумент.Области["П000030009003_Числ"].Значение > ТабличныйДокумент.Области["П000030009003_Знам"].Значение Тогда
			ТабличныйДокумент.Области["П000030009003_Знам"].Значение = ТабличныйДокумент.Области["П000030009003_Числ"].Значение;
			Сообщение = Новый СообщениеПользователю;			
			Сообщение.Текст = НСтр("ru='Знаменатель дроби показателя в строке 090 не может быть меньше значения числителя.'");			
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели = "")
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел2" Тогда
		...
		КодВидаИмуществаРаздела2 = СокрЛП(Форма.ТабличныйДокумент.Области.П000020000100.Значение);
...
Процедура СформироватьРаздел1()
	...
	Для Каждого Стр из ТаблДанных Цикл
		...
		Если НЕ ПустаяСтрока(ОКАТО) И НЕ ПустаяСтрока(ВидИмущества) И СтрНайти("1234", ВидИмущества) <> Неопределено Тогда
			...
			НовСтр.ОКАТО = ОКАТО;
			НовСтр.КБК = СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК[ВидИмущества];
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	СоответствиеРазделовМакетам.Вставить("Раздел1",			"МЧБ_2011Кв3_2");
	СоответствиеРазделовМакетам.Вставить("Раздел2",			"МЧБ_2011Кв3_3");
	СоответствиеРазделовМакетам.Вставить("Раздел3",			"МЧБ_2011Кв3_4");
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаСхемы",				"NO_IMUD_1_084_00_05_02_01.xsd");
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СхемаВыгрузки502");
...
Процедура ПроверитьЗаполнение_Раздел1(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		Для ИндексБлока = 1 По 6 Цикл
			
			БлокЗаполнен = ЗначениеЗаполнено(ДанныеЛиста["П000010001000_" + ИндексБлока])
			           ...
			           ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста["П000010004000_" + ИндексБлока]);
			...
			Если БлокЗаполнен Тогда
				...
				Если ДлинаОКАТО <> 11 Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 1 на странице " + НомерЛиста + " не" + ?(ДлинаОКАТО = 0, "", " верно") + " задан код по ОКАТО!", "Раздел1", ИмяОбластиОКАТО, НомерЛиста);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ДлинаКБК = СтрДлина(КБК);
				Если ДлинаКБК <> 20 Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 1 на странице " + НомерЛиста + " не" + ?(ДлинаКБК = 0, "", " верно") + " задан КБК!", "Раздел1", ИмяОбластиКБК, НомерЛиста);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				Сочетание = СочетаниеРазделов.Добавить();
				Сочетание.ОКАТО      = ОКАТО;
				Сочетание.КБК        = КБК;
				Сочетание.Раздел     = 1;
				Сочетание.Страница   = НомерЛиста;
				Сочетание.ИмяОбласти = ИмяОбластиОКАТО;
...
Процедура ПроверитьЗаполнение_Раздел2(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		ЛистЗаполнен = ЗначениеЗаполнено(ДанныеЛиста.П000020000100) ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020001000)
		...
		// Кода вида имущества.
		КодВидаИмущества = СокрЛП(ДанныеЛиста.П000020000100);
		Если КодВидаИмущества <> "1" 
		   И КодВидаИмущества <> "2"
		   И КодВидаИмущества <> "3"
		   И КодВидаИмущества <> "4"
		   И КодВидаИмущества <> "5" Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 код вида имущества должен быть установлен в значение ""1"", ""2"", ""3"", ""4"" или ""5""!", "Раздел2", "П000020000100", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		// ОКАТО.
		ОшибкаОКАТО = Ложь;
		ОКАТО = СокрЛП(ДанныеЛиста.П000020001000);
		ДлинаОКАТО = СтрДлина(ОКАТО);
		Если ДлинаОКАТО <> 11 Тогда
		...
		Сочетание = СочетаниеРазделов.Добавить();
		Сочетание.ОКАТО        = ОКАТО;
		Сочетание.КБК          = СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК[КодВидаИмущества];
		Сочетание.ВидИмущества = КодВидаИмущества;
		Сочетание.Раздел       = 2;
		Сочетание.Страница     = НомерЛиста;
		Сочетание.ИмяОбласти   = "П000020001000";
...
Процедура ПроверитьЗаполнение_Раздел3(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		РазделЗаполнен = ЗначениеЗаполнено(ДанныеЛиста.П000030001000) ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030002003)
		             ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000030003003)
		...
		// ОКАТО.
		ОКАТО = СокрЛП(ДанныеЛиста.П000030001000);
		ДлинаОКАТО = СтрДлина(ОКАТО);
		Если ДлинаОКАТО <> 11 Тогда
		...
		Сочетание = СочетаниеРазделов.Добавить();
		Сочетание.ОКАТО        = ОКАТО;
		Сочетание.КБК          = СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК["3"]; // Имущество не являющееся частью ЕСГС
		Сочетание.Раздел       = 3;
		Сочетание.Страница     = НомерЛиста;
		Сочетание.ИмяОбласти   = "П000030001000";
...
Процедура ПроверитьЗаполнение_СочетаниеРазделов(СочетаниеРазделов, СтатусПроверки)
	...
	СочетаниеРазделов23Свернутое = СочетаниеРазделов.Скопировать();
	СочетаниеРазделов23Свернутое.Свернуть("ОКАТО, КБК", "Счетчик2, Счетчик3");
	
	Для Каждого Сочетание Из СочетаниеРазделов23Свернутое Цикл
		Если Сочетание.Счетчик2 <> 0 И Сочетание.Счетчик3 <> 0
		   И ЗначениеЗаполнено(Сочетание.ОКАТО) И ЗначениеЗаполнено(Сочетание.КБК) Тогда
			
			УсловияПоиска = Новый Структура("ОКАТО, КБК, Раздел", Сочетание.ОКАТО, Сочетание.КБК, 2);
			НекорректныеСтроки = СочетаниеРазделов.НайтиСтроки(УсловияПоиска);
			
			СтраницаПерехода = НекорректныеСтроки[0].Страница;
			ПозицияПерехода = "П000020001000";
			
			СообщениеОбОшибке = "Обнаружено одновременное заполнение листов раздела 2 и раздела 3 по коду вида имущества "
			                  + НекорректныеСтроки[0].ВидИмущества + " и ОКАТО " + НекорректныеСтроки[0].ОКАТО;
	...
	ПовторенияРаздела1.Свернуть("ОКАТО, КБК", "Счетчик1");
	
	Для Каждого СтрокаПроверки Из ПовторенияРаздела1 Цикл
		Если СтрокаПроверки.Счетчик1 > 1 И ЗначениеЗаполнено(СтрокаПроверки.ОКАТО) И ЗначениеЗаполнено(СтрокаПроверки.КБК) Тогда
			УсловияПоиска = Новый Структура("ОКАТО, КБК, Раздел", СтрокаПроверки.ОКАТО, СтрокаПроверки.КБК, 1);
			...
			СообщениеОбОшибке = "Обнаружены дублирующиеся сочетания кода по ОКАТО " + СтрокаПроверки.ОКАТО
			                  + " и КБК " + СтрокаПроверки.КБК 
			                  + ?(ТаблицаДубликатов.Количество() = 1, " на странице ", " на страницах ") + СписокСтраниц + " раздела 1!";
	...
	СочетаниеРазделовСвернутое.Свернуть("ОКАТО, КБК", "Счетчик1, Счетчик2, Счетчик3");
	...
	Для Каждого Сочетание Из СочетаниеРазделовСвернутое Цикл
		...
		Если Сочетание.Счетчик1 <> 0 И Сочетание.Счетчик2 = 0 И Сочетание.Счетчик3 = 0
		   И ЗначениеЗаполнено(Сочетание.ОКАТО) И ЗначениеЗаполнено(Сочетание.КБК) Тогда
			УсловияПоиска = Новый Структура("ОКАТО, КБК, Раздел", Сочетание.ОКАТО, Сочетание.КБК, 1);
			...
			СообщениеОбОшибке = "Для сочетания кода по ОКАТО " + Сочетание.ОКАТО
			                  + " и КБК " +  Сочетание.КБК + " на листе " + СтрокаЧГ0(СтраницаПерехода)
		...
		Если Сочетание.Счетчик1 = 0 И Сочетание.Счетчик2 <> 0 И Сочетание.Счетчик3 = 0
		   И ЗначениеЗаполнено(Сочетание.ОКАТО) И ЗначениеЗаполнено(Сочетание.КБК) Тогда
			...
			СообщениеОбОшибке = "Для сочетания кода по виду имущества " + НесвязанныеСтроки[0].ВидИмущества
			                  + " и ОКАТО " + НесвязанныеСтроки[0].ОКАТО + " на листе " + СтрокаЧГ0(СтраницаПерехода)
			                  + " раздела 2 не найдены соответствующие значения кода по ОКАТО и КБК в разделе 1";
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, СообщениеОбОшибке, "Раздел2", ПозицияПерехода, СтраницаПерехода);
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если Сочетание.Счетчик1 = 0 И Сочетание.Счетчик2 = 0 И Сочетание.Счетчик3 <> 0
		   И ЗначениеЗаполнено(Сочетание.ОКАТО) И ЗначениеЗаполнено(Сочетание.КБК) Тогда
			...
			УсловияПоиска = Новый Структура("ОКАТО, КБК, Раздел", Сочетание.ОКАТО, Сочетание.КБК, 3);
			НесвязанныеСтроки = СочетаниеРазделов.НайтиСтроки(УсловияПоиска);
			
			СтраницаПерехода = НесвязанныеСтроки[0].Страница;
			ПозицияПерехода = "П000030001000";
			
			СообщениеОбОшибке = "Для ОКАТО " + НесвязанныеСтроки[0].ОКАТО + " на листе " + СтрокаЧГ0(СтраницаПерехода)
			                  + " раздела 3 не найдены соответствующие значения кода по ОКАТО и КБК в разделе 1";
...
Процедура ПроверитьЗаполнение_ТитульныйЛист(ПараметрыВыгрузки, СтатусПроверки)
	...
	Если ЗначениеЗаполнено(ПараметрыВыгрузки.ИННЮЛРеорг) ИЛИ ЗначениеЗаполнено(ПараметрыВыгрузки.КППРеорг) ИЛИ ЗначениеЗаполнено(ПараметрыВыгрузки.ФормРеорг) Тогда
		...
		Если НЕ ПустаяСтрока(ПараметрыВыгрузки.ФормРеорг) И ПараметрыВыгрузки.ФормРеорг <> "0" Тогда
			...
			Если ДлинаИННРеорг <> 10 ИЛИ НЕ СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(ПараметрыВыгрузки.ИННЮЛРеорг) Тогда
...
Функция ВыгрузкаВозможна(ПараметрыВыгрузки)
	...
	// Таблица для проверки сочетаний ОКАТО и КБК раздела 1 с разделами 2 или 3.
	СочетаниеРазделов = Новый ТаблицаЗначений;
	СочетаниеРазделов.Колонки.Добавить("ОКАТО");
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель)
	...
	Для Каждого ЛистРаздела1 Из Раздел1 Цикл
		...
		Для БлокРаздела1 = 1 По 6 Цикл
			...
			ЗадатьЗначениеЭлемента(Узел_СумНалПУ, "ОКАТО", ОКАТО);
			...
			Для Каждого ЛистРаздела2 Из Раздел2 Цикл
				...
				Если КБК <> СтруктураРеквизитовФормы.СоответствиеКодаВидаИмуществаКБК[СокрЛП(ДанныеРаздела2.П000020000100)] Тогда
					Продолжить;
				КонецЕсли;
				...
				ЗадатьЗначениеЭлемента(Узел_РасОб, "ВидИмущ", ДанныеРаздела2.П000020000100);
				
				ДанРас = ПолучитьПодчиненныйЭлемент(Узел_РасОб, "ДанРас");
				Для Каждого Эл Из ДанРас.Строки Цикл
					Если ПустаяСтрока(Эл.Ключ) Тогда
						Продолжить;
					КонецЕсли;
				...
				ОстСтоим = ПолучитьПодчиненныйЭлемент(СтоимМес, "ВтчНедИм");
				Для Каждого Эл Из ОстСтоим.Строки Цикл
					Если ПустаяСтрока(Эл.Ключ) Тогда
						Продолжить;
					КонецЕсли;
				...
				НалПер = ПолучитьПодчиненныйЭлемент(Узел_РасОб, "НалПер");
				...
				НаименованиеУзлаЛьготы = "КодНалЛьг";
				КодЛьготы = ДанныеРаздела2.П000020016003_КодЛьготы;
				Основание = ДанныеРаздела2.П000020016003_Основание;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					...
					КонецЕсли;
					ЗадатьЗначениеЭлемента(ДанРас, НаименованиеУзлаЛьготы, ПолныйКодЛьготы);
				КонецЕсли;
				
				НаименованиеУзлаЛьготы = "КодЛгПНС";
				КодЛьготы = ДанныеРаздела2.П000020020003_КодЛьготы;
				Основание = ДанныеРаздела2.П000020020003_Основание;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
					ЗадатьЗначениеЭлемента(ДанРас, НаименованиеУзлаЛьготы, ПолныйКодЛьготы);
				КонецЕсли;
				
				НаименованиеУзлаЛьготы = "КодЛгУмен";
				КодЛьготы = ДанныеРаздела2.П000020024003_КодЛьготы;
				Основание = ДанныеРаздела2.П000020024003_Основание;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
					ЗадатьЗначениеЭлемента(НалПер, НаименованиеУзлаЛьготы, ПолныйКодЛьготы);
				КонецЕсли;
			...
			Для Каждого ЛистРаздела3 Из Раздел3 Цикл
				...
				// Дополнение кодов льгот основаниями.
				НаименованиеУзлаЛьготы = "КодНалЛьг";
				КодЛьготы = ДанныеРаздела3.П000030004003_КодЛьготы;
				Основание = ДанныеРаздела3.П000030004003_Основание;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					Если КодЛьготы = "2012000" Тогда
						ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
					Иначе
				...
				НаименованиеУзлаЛьготы = "КодЛгПНС";
				КодЛьготы = ДанныеРаздела3.П000030007003_КодЛьготы;
				Основание = ДанныеРаздела3.П000030007003_Основание;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
					ЗадатьЗначениеЭлемента(ДанРас, НаименованиеУзлаЛьготы, ПолныйКодЛьготы);
				КонецЕсли;
				...
				НаименованиеУзлаЛьготы = "КодЛгУмен";
				КодЛьготы = ДанныеРаздела3.П000030012003_КодЛьготы;
				Основание = ДанныеРаздела3.П000030012003_Основание;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
					ЗадатьЗначениеЭлемента(НалПер, НаименованиеУзлаЛьготы, ПолныйКодЛьготы);
				КонецЕсли;
