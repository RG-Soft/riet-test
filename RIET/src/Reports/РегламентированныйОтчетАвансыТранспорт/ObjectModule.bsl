...
Форма20060101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152027", '20060323', "48н",	"ФормаОтчета2006Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20060101, "3.00000");

Форма20070101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152027", '20061219', "179н",	"ФормаОтчета2007Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Приказ Минфина РФ от 23.03.2006  № 48н";
НоваяФорма.ДатаНачалоДействия = '20060101';
НоваяФорма.ДатаКонецДействия  = '20060930';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2007Кв1";
НоваяФорма.ОписаниеОтчета     = "Приказ Минфина РФ от 23.03.2006  № 48н (в редакции приказа Минфина РФ от 19.12.2006 г. № 179н)";
