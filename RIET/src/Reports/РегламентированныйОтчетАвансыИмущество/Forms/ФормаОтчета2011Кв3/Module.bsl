...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "23/10/2012";
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("Списки2011Кв3");
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "Период", 2, , "Выбор отчетного периода", КоллекцияСписковВыбора["КодыПериодов"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "ПоМесту", 3, , "Выбор места нахождения (учета)", КоллекцияСписковВыбора["КодыМестНахождения"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "КодФормыОрг", 1, , "Выбор формы реорганизации", КоллекцияСписковВыбора["КодыФормРеорганизации"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000010002000_7", 20, , "Выбор КБК", КоллекцияСписковВыбора["КБК"]);
	
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '2012-01-01' Тогда
		ИмяСпискаЛьгот = "КодыЛьгот2012Кв1";
	Иначе
		ИмяСпискаЛьгот = "КодыЛьгот";
	КонецЕсли;
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020013003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора[ИмяСпискаЛьгот]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020016003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора["КодЛьготыПониженияНалоговойСтавки"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020019003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора["КодЛьготыУменьшенияСуммыНалога"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030006003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора["КодЛьготыПониженияНалоговойСтавки"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030010003_КодЛьготы", 7, , "Выбор льготы", КоллекцияСписковВыбора["КодЛьготыУменьшенияСуммыНалога"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020000100", 1, , "Выбор вида имущества", КоллекцияСписковВыбора["КодыВидовИмущества"]);
...
Процедура ОтобразитьНомерКорректировки(Форма)
	...
	ПолеТабличногоДокументаТитульный.Области["НомерКорректировки"].Значение =    НомерКорректировкиСтрока;
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ИзмененаДатаПодписи Тогда
		...
		Форма.ТабличныйДокумент.Области["ИНН1"].Значение=СокрЛП(СведенияОбОрганизации.ИННЮЛ);		
		Форма.ТабличныйДокумент.Области["КПП1"].Значение=СокрЛП(СведенияОбОрганизации.КППЮЛ);
...
Процедура СохранитьНаКлиентеСВопросом(Автосохранение, КодИФНС, КПП, Вариант, ВыполняемоеОповещение, ОткрытьФормуВопросаПриИзмененииВидаДокументаНомераКорректировки, ПодобныйОтчетСуществует)
	...
	Если ПодобныйОтчетСуществует Тогда
		...
		Кнопки, , Кнопки.Получить(1).Значение);
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяСтраницыПанели = "Раздел2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
			...
			// считаем строку 140
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020014003, ОбластьИмя) > 0 Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020018003, ОбластьИмя) > 0 Тогда
				...
				СтоимостьОблагаемогоНалогомИмущества = Макс(ПолеТабличногоДокументаРаздел2.П000020012003.Значение - ПолеТабличногоДокументаРаздел2.П000020014003.Значение, 0);
				
				КодВидаИмущества = СокрЛП(ПолеТабличногоДокументаРаздел2.П000020000100.Значение);
				
				Если КодВидаИмущества = "1"
					ИЛИ КодВидаИмущества = "3" 
					ИЛИ КодВидаИмущества = "5" Тогда	
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел3" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел3" Тогда
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030009003, ОбластьИмя) > 0 Тогда
				...
				КоэффК				= ?(ПолеТабличногоДокументаРаздел3.П000030008003_Знам.Значение = 0, 1, ПолеТабличногоДокументаРаздел3.П000030008003_Числ.Значение / ПолеТабличногоДокументаРаздел3.П000030008003_Знам.Значение);
				...
				ПолеТабличногоДокументаРаздел3.П000030009003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Разность020И030
				* КоэффДоляСтоимости
				* СтавкаНалога
				* КоэффК
				/ 4);
...
Процедура ПолныйРасчетРаздела2(Форма, ОбластьИмя = "")
	...
	Для Каждого СтраницаРаздела2 Из Форма.ТаблицаСтраницыРазделаРаздел2 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020018003, ОбластьИмя) > 0 Тогда
			...
			СтоимостьОблагаемогоНалогомИмущества = Макс(ПолеТабличногоДокументаРаздел2.П000020012003 - ПолеТабличногоДокументаРаздел2.П000020014003, 0);
...
Процедура ПолныйРасчетРаздела3(Форма, ОбластьИмя = "")
	...
	Для Каждого СтраницаРаздела3 Из Форма.ТаблицаСтраницыРазделаРаздел3 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030009003, ОбластьИмя) > 0 Тогда
			...
			КоэффК				= ?(ПолеТабличногоДокументаРаздел3.П000030008003_Знам = 0, 1, ПолеТабличногоДокументаРаздел3.П000030008003_Числ / ПолеТабличногоДокументаРаздел3.П000030008003_Знам);
			...
			ПолеТабличногоДокументаРаздел3.П000030009003 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Разность020И030
			* КоэффДоляСтоимости
			* СтавкаНалога
			* КоэффК
			/ 4);
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели = "")
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел2" Тогда
		...
		КодВидаИмуществаРаздела2 = Форма.ТабличныйДокумент.Области.П000020000100.Значение;
...
Процедура СформироватьРаздел1()
	...
	Для Каждого Стр из ТаблДанных Цикл
		...
		ДанныеСтр = Стр.Данные[0].Значение;
		ОКАТО = ДанныеСтр.П000020001000;
		ВидИмущества = ДанныеСтр.П000020000100;
		Если НЕ ПустаяСтрока(ОКАТО) И НЕ ПустаяСтрока(ВидИмущества) И СтрНайти("1235", ВидИмущества) <> Неопределено Тогда
			НовСтр = ИтоговаяТаблица.Добавить();
			НовСтр.ОКАТО = ОКАТО;
			НовСтр.КБК = КБКПоКодуВидаИмущества(ВидИмущества);
			НовСтр.Сумма = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, ДанныеСтр.П000020018003) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, ДанныеСтр.П000020020003), 0);
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого Стр из ТаблДанных Цикл
		...
		ДанныеСтр = Стр.Данные[0].Значение;	
		ОКАТО = ДанныеСтр.П000030001000;
		Если НЕ ПустаяСтрока(ОКАТО) Тогда
			НовСтр = ИтоговаяТаблица.Добавить();
			НовСтр.ОКАТО = ОКАТО;
			НовСтр.КБК = КБКИмуществаИностраннойОрганизации();
			НовСтр.Сумма = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, ДанныеСтр.П000030009003) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, ДанныеСтр.П000030011003), 0);
		КонецЕсли;
	КонецЦикла;
...
Процедура ЗаполнитьМакетМЧБ(ПараметрыПечати, МакетМЧБ, ОбщиеРеквизитыРазделов)
	...
	// особая обработка ФИО и ОКВЭД на титульном листе
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаСхемы",				"NO_IMUR_1_085_00_05_02_01.xsd");
...
Процедура ПроверитьЗаполнение_Раздел1(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		Для ИндексБлока = 1 По 7 Цикл
			...
			ИЛИ ЗначениеЗаполнено(ДанныеЛиста["П000010003000_" + ИндексБлока]);
			...
			Если БлокЗаполнен Тогда
				...
				Если ДлинаОКАТО <> 11 Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 1 на странице " + СтрокаЧГ0(НомерЛиста) + " не" + ?(ДлинаОКАТО = 0, "", " верно") + " задан код по ОКАТО!", "Раздел1", ИмяОбластиОКАТО, НомерЛиста);
					СтатусПроверки = Ложь;
				КонецЕсли;
				
				ДлинаКБК = СтрДлина(КБК);
				Если ДлинаКБК <> 20 Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 1 на странице " + СтрокаЧГ0(НомерЛиста) + " не" + ?(ДлинаКБК = 0, "", " верно") + " задан КБК!", "Раздел1", ИмяОбластиКБК, НомерЛиста);
					СтатусПроверки = Ложь;
				КонецЕсли;
...
Процедура ПроверитьЗаполнение_Раздел2(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		Если КодВидаИмущества <> "1"
			...
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + СтрокаЧГ0(НомерЛиста) + " раздела 2 код вида имущества должен быть установлен в значение ""1"", ""2"", ""3"" или ""5""!", "Раздел2", "П000020000100", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		КБК = КБКПоКодуВидаИмущества(КодВидаИмущества);
		
		ОКАТО = СокрЛП(ДанныеЛиста.П000020001000);
		ДлинаОКАТО = СтрДлина(ОКАТО);
		Если ДлинаОКАТО <> 11 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + СтрокаЧГ0(НомерЛиста) + " раздела 2 не" + ?(ДлинаОКАТО = 0, "", "верно") + " задан код по ОКАТО!", "Раздел2", "П000020001000", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
...
Процедура ПроверитьЗаполнение_Раздел3(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из ДанныеРаздела Цикл
		...
		ДанныеЛиста3 = Лист.Данные[0].Значение;
		НомерЛиста = ДанныеРаздела.Индекс(Лист) + 1;
		
		ЛистЗаполнен = ЗначениеЗаполнено(ДанныеЛиста3.П000030001000)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030002003)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030003003)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030004003_КодЛьготы) ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030004003_Основание)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030005003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030005003_Знам)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030006003_КодЛьготы) ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030006003_Основание)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030007003)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030008003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030008003_Знам)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030009003)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030010003_КодЛьготы) ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030010003_Основание)
		ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030011003);
		Если НЕ ЛистЗаполнен Тогда
			Продолжить;
		КонецЕсли;
		
		КБК = КБКИмуществаИностраннойОрганизации();
		
		ОКАТО = СокрЛП(СокрЛП(ДанныеЛиста3.П000030001000));
		ДлинаОКАТО = СтрДлина(ОКАТО);
		Если ДлинаОКАТО <> 11 Тогда
		...
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста3.П000030004003_КодЛьготы));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
		...
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста3.П000030006003_КодЛьготы));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
		...
		// Коэффициент К.
		Если ЗначениеЗаполнено(ДанныеЛиста3.П000030008003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста3.П000030008003_Знам) Тогда
			Если НЕ ЗначениеЗаполнено(ДанныеЛиста3.П000030008003_Числ) Тогда
				...
				СтатусПроверки = Ложь;
			ИначеЕсли НЕ ЗначениеЗаполнено(ДанныеЛиста3.П000030008003_Знам) Тогда
				...
				СтатусПроверки = Ложь;
			ИначеЕсли ДанныеЛиста3.П000030008003_Знам < ДанныеЛиста3.П000030008003_Числ Тогда
		...
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста3.П000030010003_КодЛьготы));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
...
Процедура ПроверитьЗаполнение_СочетаниеРазделов(СочетаниеРазделов, СтатусПроверки)
	...
	Если СочетанияРаздела1.Количество() = 0 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 1 не заполнен ни один блок с информацией о суммах авансового платежа!", "Раздел1", "П000010001000_1", 1);
		СтатусПроверки = Ложь;
	...
	Для Каждого Сочетание Из СочетаниеРазделовСвернутое Цикл
		...
		Если Сочетание.Счетчик1 <> 0 И Сочетание.Счетчик2 = 0 И Сочетание.Счетчик3 = 0
			...
			+ " раздела 1 не обнаружены заполненые листы разделов исчисления суммы авансового платежа";
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, СообщениеОбОшибке, "Раздел1", ПозицияПерехода, СтраницаПерехода);
			СтатусПроверки = Ложь;
		КонецЕсли;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель)
	...
	Для Каждого ЛистРаздела1 Из Раздел1 Цикл
		...
		Для БлокРаздела1 = 1 По 7 Цикл
			...
			СуммаПлатежа = ДанныеЛистаРаздела1["П000010003000_" + БлокРаздела1];
			...
			ЗадатьЗначениеЭлемента(Узел_СумНалПУ, "НалПУ", СуммаПлатежа);
			...
			Для Каждого ЛистРаздела2 Из Раздел2 Цикл
				...
				Если КБК <> КБКПоКодуВидаИмущества(СокрЛП(ДанныеРаздела2.П000020000100)) Тогда
					Продолжить;
				КонецЕсли;
				...
				ЗадатьЗначениеЭлемента(ДанРас, "СтИмущ", ДанныеРаздела2.П000020012003);
				ЗадатьЗначениеЭлемента(ДанРас, "СтИмущНеобл", ДанныеРаздела2.П000020014003);
				Если ЗначениеЗаполнено(ДанныеРаздела2.П000020015003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеРаздела2.П000020015003_Знам) Тогда
					ЗадатьЗначениеЭлемента(ДанРас, "ДолСт", СокрЛП(Формат(ДанныеРаздела2.П000020015003_Числ, "ЧГ=") + "/" + Формат(ДанныеРаздела2.П000020015003_Знам, "ЧГ=")));
				КонецЕсли;
				ЗадатьЗначениеЭлемента(ДанРас, "НалСтав", ДанныеРаздела2.П000020017003);
				...
				ОтчПер = ПолучитьПодчиненныйЭлемент(Узел_РасОб, "ОтчПер");
				Для Каждого Эл Из ОтчПер.Строки Цикл
					Если ПустаяСтрока(Эл.Ключ) Тогда
						Продолжить;
					КонецЕсли;
					ЗадатьЗначениеЭлемента(ОтчПер, Эл.Код, ДанныеРаздела2[Эл.Ключ]);
				КонецЦикла;
				
				// Дополнение кодов льгот основаниями.
				НаименованиеУзлаЛьготы = "КодНалЛьг";
				КодЛьготы = ДанныеРаздела2.П000020013003_КодЛьготы;
				Основание = ДанныеРаздела2.П000020013003_Основание;
				...
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
					ЗадатьЗначениеЭлемента(ОтчПер, НаименованиеУзлаЛьготы, ПолныйКодЛьготы);
				КонецЕсли;
			...
			Для Каждого ЛистРаздела3 Из Раздел3 Цикл
				...
				ДанРас = ПолучитьПодчиненныйЭлемент(Узел_РасОб, "ДанРас");
				ЗадатьЗначениеЭлемента(ДанРас, "СтИмущ", ДанныеРаздела3.П000030002003);
				ЗадатьЗначениеЭлемента(ДанРас, "СтИмущНеобл", ДанныеРаздела3.П000030003003);
				Если ЗначениеЗаполнено(ДанныеРаздела3.П000030005003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеРаздела3.П000030005003_Знам) Тогда
					ЗадатьЗначениеЭлемента(ДанРас, "ДолСт", СокрЛП(Формат(ДанныеРаздела3.П000030005003_Числ, "ЧГ=") + "/" + Формат(ДанныеРаздела3.П000030005003_Знам, "ЧГ=")));
				КонецЕсли;
				ЗадатьЗначениеЭлемента(ДанРас, "НалСтав", ДанныеРаздела3.П000030007003);
				Если ЗначениеЗаполнено(ДанныеРаздела3.П000030008003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеРаздела3.П000030008003_Знам) Тогда
					ЗадатьЗначениеЭлемента(ДанРас, "КоэфК", СокрЛП(Формат(ДанныеРаздела3.П000030008003_Числ, "ЧГ=") + "/" + Формат(ДанныеРаздела3.П000030008003_Знам, "ЧГ=")));
				КонецЕсли;
				...
				Для Каждого Эл Из ОтчПер.Строки Цикл
					Если ПустаяСтрока(Эл.Ключ) Тогда
						Продолжить;
					КонецЕсли;
					ЗадатьЗначениеЭлемента(ОтчПер, Эл.Код, ДанныеРаздела3[Эл.Ключ]);
				КонецЦикла;
				...
				НаименованиеУзлаЛьготы = "КодЛгПНС";
				КодЛьготы = ДанныеРаздела3.П000030006003_КодЛьготы;
				Основание = ДанныеРаздела3.П000030006003_Основание;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
					ЗадатьЗначениеЭлемента(ДанРас, НаименованиеУзлаЛьготы, ПолныйКодЛьготы);
				КонецЕсли;
				...
				НаименованиеУзлаЛьготы = "КодЛгУмен";
				КодЛьготы = ДанныеРаздела3.П000030010003_КодЛьготы;
				Основание = ДанныеРаздела3.П000030010003_Основание;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					ПолныйКодЛьготы = КодЛьготы + "/" + Основание;
					ЗадатьЗначениеЭлемента(ОтчПер, НаименованиеУзлаЛьготы, ПолныйКодЛьготы);
				КонецЕсли;
...
Процедура УстановитьМаскиВПоляхВвода(ИмяТекРаздела)
	...
	МаскаКодаОКАТО = "99999999999";
	МаскаКодаЛьготы = "9999999";
	...
	ИначеЕсли ИмяТекРаздела = "Раздел1" Тогда 
		...
		Для Инд = 1 По 7 Цикл
			ТабличныйДокумент.Области["П000010001000_" + Инд].Маска = МаскаКодаОКАТО;
		КонецЦикла;
		
	ИначеЕсли ИмяТекРаздела = "Раздел2" Тогда
		
		ТабличныйДокумент.Области.П000020001000.Маска = МаскаКодаОКАТО;
		
		ТабличныйДокумент.Области.П000020013003_КодЛьготы.Маска = МаскаКодаЛьготы;
		ТабличныйДокумент.Области.П000020016003_КодЛьготы.Маска = МаскаКодаЛьготы;
		ТабличныйДокумент.Области.П000020019003_КодЛьготы.Маска = МаскаКодаЛьготы;
		
	ИначеЕсли ИмяТекРаздела = "Раздел3" Тогда
		
		ТабличныйДокумент.Области.П000030001000.Маска = МаскаКодаОКАТО;
		
		ТабличныйДокумент.Области.П000030004003_КодЛьготы.Маска = МаскаКодаЛьготы;
		ТабличныйДокумент.Области.П000030006003_КодЛьготы.Маска = МаскаКодаЛьготы;
		ТабличныйДокумент.Области.П000030010003_КодЛьготы.Маска = МаскаКодаЛьготы;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020012003", "П000020002003;П000020003003;П000020004003;П000020005003;П000020006003;П000020007003;П000020008003;П000020009003;П000020010003;П000020011003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020014003", "П000020002004;П000020003004;П000020004004;П000020005004;П000020006004;П000020007004;П000020008004;П000020009004;П000020010003;П000020011004");
	//Для строки 180 используеются как собственные условия, так и условия строк 120, 140 целиком
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020018003", "П000020000100;П000020012003;П000020014003;П000020015003;П000020017003;П000020002003;П000020003003;П000020004003;П000020005003;П000020006003;П000020007003;П000020008003;П000020009003;П000020010003;П000020011003;П000020002004;П000020003004;П000020004004;П000020005004;П000020006004;П000020007004;П000020008004;П000020009004;П000020010003;П000020011004");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000030009003", "П000030002003;П000030003003;П000030005003;П000030007003;П000030008003");
