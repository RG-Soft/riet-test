...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("Списки");
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020013003", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льготы"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020016003", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льгота2012000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020019003", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льгота2012000"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030006003", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льгота2012000"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000030010003", 7, , "Выбор льготы", КоллекцияСписковВыбора["Льгота2012000"]);
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если ИмяСтраницыПанели = "Раздел2" Тогда
		...
		ПолеТабличногоДокументаРаздел2 = Форма.ТабличныйДокумент;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020012003, ОбластьИмя) > 0 Тогда
			...
			Делимое120 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020002003.Значение)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма,ПолеТабличногоДокументаРаздел2.Области.П000020003003.Значение)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020004003.Значение)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020005003.Значение);	
			...
			Если Месяц(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) > 3 Тогда
				...
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020006003.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020007003.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020008003.Значение);
			...
			Если Месяц(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) > 6 Тогда
				...
				Делимое120 = Делимое120
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020009003.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020010003.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020011003.Значение);
			...
			ПолеТабличногоДокументаРаздел2.Области.П000020012003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое120 / Делитель);	
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020014003, ОбластьИмя) > 0 Тогда
			...
			Делимое140 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020002004.Значение)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020003004.Значение)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020004004.Значение)
			+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020005004.Значение);
			...
			Если Месяц(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) > 3 Тогда
				...
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020006004.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020007004.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020008004.Значение);
			...
			Если Месяц(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) > 6 Тогда
				...
				Делимое140 = Делимое140
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020009004.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020010004.Значение)
				+ РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел2.Области.П000020011004.Значение);
				
				Делитель = 10;
				
			КонецЕсли;
			
			ПолеТабличногоДокументаРаздел2.Области.П000020014003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое140 / Делитель);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020018003, ОбластьИмя) > 0 Тогда
			...
			СтоимостьОблагаемогоНалогомИмущества = Макс(ПолеТабличногоДокументаРаздел2.Области.П000020012003.Значение - ПолеТабличногоДокументаРаздел2.Области.П000020014003.Значение, 0);
			
			КодВидаИмущества = СокрЛП(ПолеТабличногоДокументаРаздел2.Области.П000020000100.Значение);
			
			Если КодВидаИмущества = "3" Тогда
				
				Делимое = СтоимостьОблагаемогоНалогомИмущества * ПолеТабличногоДокументаРаздел2.Области.П000020017003.Значение / 100;
				
				ПолеТабличногоДокументаРаздел2.Области.П000020018003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое / 4);
				
			ИначеЕсли КодВидаИмущества = "1" ИЛИ КодВидаИмущества = "2" Тогда
				
				Коэффициент150 = ?(ПолеТабличногоДокументаРаздел2.Области.П000020015003_Знам.Значение = 0, 0, СтоимостьОблагаемогоНалогомИмущества * ПолеТабличногоДокументаРаздел2.Области.П000020015003_Числ.Значение / ПолеТабличногоДокументаРаздел2.Области.П000020015003_Знам.Значение);
				
				Делимое = Коэффициент150 * ПолеТабличногоДокументаРаздел2.Области.П000020017003.Значение / 100;
				
				ПолеТабличногоДокументаРаздел2.Области.П000020018003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Делимое / 4);
				
			Иначе
				
				ПолеТабличногоДокументаРаздел2.Области.П000020018003.Значение = 0;
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел3" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000030009003, ОбластьИмя) > 0 Тогда
			...
			ПолеТабличногоДокументаРаздел3 = Форма.ТабличныйДокумент;
			
			КоэффДоляСтоимости	= ?(ПолеТабличногоДокументаРаздел3.Области.П000030005003_Знам.Значение = 0, 1, ПолеТабличногоДокументаРаздел3.Области.П000030005003_Числ.Значение / ПолеТабличногоДокументаРаздел3.Области.П000030005003_Знам.Значение);
			КоэффК				= ?(ПолеТабличногоДокументаРаздел3.Области.П000030008003_Знам.Значение = 0, 1, ПолеТабличногоДокументаРаздел3.Области.П000030008003_Числ.Значение / ПолеТабличногоДокументаРаздел3.Области.П000030008003_Знам.Значение);
			
			Разность020И030 = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел3.Области.П000030002003.Значение) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, ПолеТабличногоДокументаРаздел3.Области.П000030003003.Значение), 0);
			СтавкаНалога = ПолеТабличногоДокументаРаздел3.Области.П000030007003.Значение / 100;
			ПолеТабличногоДокументаРаздел3.Области.П000030009003.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(Форма, Разность020И030
			* КоэффДоляСтоимости
			* СтавкаНалога
			* КоэффК
			/ 4);
...
Процедура СформироватьРаздел1()
	...
	Для Каждого Стр из ТаблДанных Цикл
		...
		Если НЕ ПустаяСтрока(ОКАТО) И НЕ ПустаяСтрока(ВидИмущества) И СтрНайти("123", ВидИмущества) <> Неопределено Тогда
...
КонецПроцедуры // УдалитьВсеСтраницы()
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("КНД",			"1152028");
	...
	ПараметрыВыгрузки.Вставить("ИмяФайлаСхемы",				"NO_IMUR_1_085_00_05_01_01.xsd");
	ПараметрыВыгрузки.Вставить("ПрефиксИмениФайлаВыгрузки",	"NO_IMUR");
	
	ПараметрыВыгрузки.Вставить("ИмяКлючевогоУзлаСодержательнойЧасти", "Имущ");
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки)
	...
	Для Каждого Лист Из Раздел1 Цикл
		...
		Для ИндексБлока = 1 По 7 Цикл
			...
			Если ЗначениеЗаполнено(ДанныеЛиста["П000010001000_" + ИндексБлока])
				...
				ИЛИ ЗначениеЗаполнено(ДанныеЛиста["П000010003000_" + ИндексБлока]) Тогда
				
				ЗаполненХотяБыОдинБлокВРазделе1 = Истина;
				
				ИмяОбластиОКАТО = "П000010001000_" + ИндексБлока;
				ДлинаОКАТО = СтрДлина(СокрЛП(ДанныеЛиста[ИмяОбластиОКАТО]));
				...
				ДлинаКБК = СтрДлина(СокрЛП(ДанныеЛиста[ИмяОбластиКБК]));
	...
	Если НЕ ЗаполненХотяБыОдинБлокВРазделе1 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 1 не заполнен ни один блок с информацией о сумме платежа!", "Раздел1", "П000010001000_1", 1);
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Для Каждого Лист2 Из Раздел2 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ДанныеЛиста2.П000020000100) И НЕ ЗначениеЗаполнено(ДанныеЛиста2.П000020001000) Тогда
			Продолжить;
		КонецЕсли;
		
		// проверяем правильность задания кода кида имущества
		КодВидаИмущества = СокрЛП(ДанныеЛиста2.П000020000100);
		Если КодВидаИмущества <> "1" И КодВидаИмущества <> "2" И КодВидаИмущества <> "3" Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 код вида имущества должен быть установлен в значение ""1"", ""2"" или ""3""!", "Раздел2", "П000020000100", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		// проверяем ОКАТО
		ДлинаОКАТО = СтрДлина(СокрЛП(ДанныеЛиста2.П000020001000));
		Если ДлинаОКАТО <> 11 Тогда
		...
		// проверяем код льготы (стр. 130)
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста2.П000020013003));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 неверно задан код налоговой льготы!", "Раздел2", "П000020013003", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		// проверяем долю балансовой стоимости
		Если ЗначениеЗаполнено(ДанныеЛиста2.П000020015003_Числ) ИЛИ ЗначениеЗаполнено(ДанныеЛиста2.П000020015003_Знам) Тогда
			Если НЕ ЗначениеЗаполнено(ДанныеЛиста2.П000020015003_Числ) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 не задан числитель в доле балансовой стоимости объекта недвижимого имущества на территории субъекта РФ!", "Раздел2", "П000020015003_Числ", НомерЛиста);
				СтатусПроверки = Ложь;
			ИначеЕсли НЕ ЗначениеЗаполнено(ДанныеЛиста2.П000020015003_Знам) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 не задан знаменатель в доле балансовой стоимости объекта недвижимого имущества на территории субъекта РФ!", "Раздел2", "П000020015003_Знам", НомерЛиста);
				СтатусПроверки = Ложь;
			ИначеЕсли ДанныеЛиста2.П000020015003_Знам < ДанныеЛиста2.П000020015003_Числ Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 числитель больше знаменателя в доле балансовой стоимости объекта недвижимого имущества на территории субъекта РФ!", "Раздел2", "П000020015003_Числ", НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
		...
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 неверно задан код налоговой льготы (установленной в виде понижения налоговой ставки)!", "Раздел2", "П000020016003", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		// проверяем код льготы (стр. 190)
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста2.П000020019003));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На странице " + НомерЛиста + " раздела 2 неверно задан код налоговой льготы (в виде уменьшения суммы налога, подлежащей уплате в бюджет)!", "Раздел2", "П000020019003", НомерЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
	...
	Для Каждого Лист3 Из Раздел3 Цикл
		...
		// проверяем ключевые поля на заполненность
		Если НЕ ЗначениеЗаполнено(ДанныеЛиста3.П000030001000) И НЕ ЗначениеЗаполнено(ДанныеЛиста3.П000030002003) Тогда
			Продолжить;
		КонецЕсли;
		
		// проверяем ОКАТО
		ДлинаОКАТО = СтрДлина(СокрЛП(ДанныеЛиста3.П000030001000));
		Если ДлинаОКАТО <> 11 Тогда
		...
		// проверяем код льготы (стр. 060)
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста3.П000030006003));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
		...
		// проверяем код льготы (стр. 100)
		ДлинаКодаЛьготы = СтрДлина(СокрЛП(ДанныеЛиста3.П000030010003));
		Если ДлинаКодаЛьготы <> 0 И ДлинаКодаЛьготы <> 7 Тогда
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("СтруктураXML501");
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель)
	...
	Для Каждого ЛистРаздела1 Из Раздел1 Цикл
		...
		Для БлокРаздела1 = 1 По 7 Цикл
			...
			ЗадатьЗначениеЭлемента(УзелРаздел1, "НалПУ", СуммаПлатежа);
			...
			Для Каждого ЛистРаздела2 Из Раздел2 Цикл
				...
				ЗадатьЗначениеЭлемента(ДанРас, "КодНалЛьг",		ДанныеРаздела2.П000020013003);
				...
				КонецЕсли;
				ЗадатьЗначениеЭлемента(ДанРас, "КодЛгПНС",		ДанныеРаздела2.П000020016003);
				...
				ОтчПер = ПолучитьПодчиненныйЭлемент(УзелРаздел2, "ОтчПер");
			...
			Если КБК <> СоответствиеКодаВидаИмуществаКБК["2"] Тогда
				Продолжить;
			КонецЕсли;
			...
			Для Каждого ЛистРаздела3 Из Раздел3 Цикл
				...
				ЗадатьЗначениеЭлемента(ДанРас, "КодНалЛьг",		ДанныеРаздела3.П000030004003);
				...
				КонецЕсли;
				ЗадатьЗначениеЭлемента(ДанРас, "КодЛгПНС",		ДанныеРаздела3.П000030006003);
				...
				ОтчПер = ПолучитьПодчиненныйЭлемент(УзелРаздел3, "ОтчПер");
				Для Каждого Эл Из ОтчПер.Строки Цикл
