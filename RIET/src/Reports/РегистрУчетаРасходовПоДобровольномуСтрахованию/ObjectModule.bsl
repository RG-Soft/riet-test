...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок, ВысотаЗаголовка, ТолькоЗаголовок = Ложь) Экспорт
	...
	|	НалоговыйДвиженияССубконто.СубконтоКт1.ВидРБП КАК ВидРБП,
	...
	|		ПО НалоговыйДвиженияССубконто.СубконтоКт2 = РаботникиОрганизацийСрезПоследних.Физлицо
	|ГДЕ
	...
	Пока Результат.Следующий() Цикл
		...
		ИначеЕсли Результат.ВидРБП = Страхование3 Тогда
			...
			Если СтрокаРаботника = Неопределено Тогда
				...
				СтрокаРаботника.Расходы = Мин(Результат.Сумма, 10000);

			Иначе

				СтрокаРаботника.Расходы = Мин(СтрокаРаботника.Расходы + Результат.Сумма, 10000);
