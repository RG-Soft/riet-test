...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если ЗначениеПоляРасшифровки.Свойство("Ссылка") Тогда
		Если ТипЗнч(ЗначениеПоляРасшифровки.Ссылка) = Тип("ДокументСсылка.СчетФактураВыданный") Тогда
...
Процедура УстановитьКомментарийНаСервере(ЗначениеПоляРасшифровки, Коммент)
	...
	Реализация = ЗначениеПоляРасшифровки.Ссылка.ДокументОснование;
	НаборЗаписей = РегистрыСведений.НомераИнвойсовLawson.СоздатьНаборЗаписей();
	НаборЗаписей.Отбор.Документ.Установить(Реализация);
	НаборЗаписей.Прочитать();
	Для каждого Запись Из НаборЗаписей Цикл
		Запись.Коммент = Коммент;
	КонецЦикла;
