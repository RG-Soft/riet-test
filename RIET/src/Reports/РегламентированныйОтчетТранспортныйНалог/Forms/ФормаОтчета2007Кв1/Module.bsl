...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мИдГруппы1  = "П0000200020";
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "01/06/2012";
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета >= '20110101' Тогда
		...
		НовСтр = ТаблицаВариантыЗаполненияРаздел1[0].ТаблицаВариантовЗаполнения.Вставить(0);
		НовСтр.КодПоказателя            = "Сумма40_1";
		НовСтр.ВариантЗаполнения        = 5;
		НовСтр.КодПоказателяПоСтруктуре = "Сумма40Раздел1";
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020002011", "П000020002006;П000020002009;П000020002010");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020002014", "П000020002006;П000020002009;П000020002010;П000020002013");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Сумма50_1", "Сумма1_1;Сумма40_1");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("Сумма60_1", "Сумма1_1;Сумма40_1");
...
Процедура ЗагрузитьПоказателиИзМакета (РазделВМакете)
	...
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("Списки2007Кв1");
...
Процедура ВосстановитьСведенияОбОрганизацииИзТитульногоЛистаСтарогоОбразца(ПоказателиОтчета)
	...
	Для Каждого Показатель Из ПоказателиТаблПоле Цикл
		...
		ИначеЕсли ИмяПоказателя = "КПП1_1" Тогда
			...
			КонецЦикла;
		ИначеЕсли ИмяПоказателя = "НомКоррект" Тогда
			СтруктураДанныхТитульный.Вставить("НомерКорректировки", ПоказателиТаблПоле["НомКоррект"]);
			СтруктураДанныхТитульный.Удалить("НомКоррект");
...
Процедура ЗаполнениеЗначенийВКвадратиках(Форма, Знач ИмяСтраницы)
	...
	Если СтрНайти(ИмяСтраницы, "ПолеТабличногоДокумента") > 0 Тогда
	...
	Если ИмяСтраницыП = "Раздел1" Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(Форма, "Раздел1", "Сумма1_", 15, Форма.мСтруктураПеременных.Сумма30Раздел1, Истина);
		РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(Форма, "Раздел1", "Сумма40_", 15, Форма.мСтруктураПеременных.Сумма40Раздел1, Истина);
		РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(Форма, "Раздел1", "Сумма50_", 15, Форма.мСтруктураПеременных.Сумма50Раздел1, Истина);
		РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(Форма, "Раздел1", "Сумма60_", 15, Форма.мСтруктураПеременных.Сумма60Раздел1, Истина);
...
Процедура УстановитьФорматВывода(Форма, НаимРаздела) Экспорт
	...
	Для Каждого СтрПоказатели Из Форма.мТаблицаСоставПоказателей Цикл
		...
		Если (ТипДанныхПоказателя = "Е") И (НЕ ПустаяСтрока(КодПоказателяПоСтруктуре)) Тогда
			...
			Если КодПоказателяПоСтруктуре = "Сумма30Раздел1" Тогда
				
				ФорматируемаяОбласть = ТекТабличноеПоле.Области.Сумма1_1;
			...
			ИначеЕсли КодПоказателяПоСтруктуре = "Сумма40Раздел1" Тогда
				
				ФорматируемаяОбласть = ТекТабличноеПоле.Области.Сумма40_1;
				ФорматируемаяОбласть.ТипЗначения = Форма.СтруктураРеквизитовФормы.мОписаниеТиповЧислоЕ;
				ФорматируемаяОбласть.Формат = Форма.СтруктураРеквизитовФормы.мСтрокаФормата;
				
			ИначеЕсли КодПоказателяПоСтруктуре = "Сумма50Раздел1" Тогда
				
				ФорматируемаяОбласть = ТекТабличноеПоле.Области.Сумма50_1;
				ФорматируемаяОбласть.ТипЗначения = Форма.СтруктураРеквизитовФормы.мОписаниеТиповЧислоЕ;
				ФорматируемаяОбласть.Формат = Форма.СтруктураРеквизитовФормы.мСтрокаФормата;
				
			ИначеЕсли КодПоказателяПоСтруктуре = "Сумма60Раздел1" Тогда
				
				ФорматируемаяОбласть = ТекТабличноеПоле.Области.Сумма60_1;
				ФорматируемаяОбласть.ТипЗначения = Форма.СтруктураРеквизитовФормы.мОписаниеТиповЧислоЕ;
				ФорматируемаяОбласть.Формат = Форма.СтруктураРеквизитовФормы.мСтрокаФормата;
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	#Если НаКлиенте Тогда
		Результат = РегламентированнаяОтчетностьКлиент.ЗаполнитьСведенияОбОрганизацииНаКлиенте(Форма, ОргСведения, Форма.СтруктураРеквизитовФормы.ИП, Сведения);
	#Иначе
		Результат = РегламентированнаяОтчетностьВызовСервера.ЗаполнитьСведенияОбОрганизацииНаСервере(Форма, Сведения);
	#КонецЕсли
	...
	Если (НЕ ВПрограммеИзмененаДатаПодписи) И (Результат <> Неопределено) Тогда
		...
		Форма.ТабличныйДокумент.Области["КодИМНС"].Значение 	= Результат.КодНО;
		Форма.ТабличныйДокумент.Области.ИНН1.Значение    		= Результат.ИННЮЛ;
		Форма.ТабличныйДокумент.Области.КПП1.Значение    		= Результат.КППЮЛ;

		
		Если (НЕ Форма.СтруктураРеквизитовФормы.мВПрограммеИзмененаОрганизация) И (НЕ Форма.СтруктураРеквизитовФормы.мДокументВосстановлен) Тогда
			
			Если СтрДлина(Результат.ОКАТО) = 11 И СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(Результат.ОКАТО) Тогда
				Форма.мСтруктураПеременных.Вставить("ОКАТОРаздел1", Результат.ОКАТО);
				РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(Форма, "Раздел1", "ОКАТО", 11, Результат.ОКАТО);
			Иначе
				Форма.мСтруктураПеременных.Вставить("ОКАТОРаздел1", "");
				РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(Форма, "Раздел1", "ОКАТО", 11, "           ");
			КонецЕсли;
...
КонецПроцедуры // ВставитьОбластьВТабличныйДокументНаСервере()
...
Процедура ОчисткаИПодготовкаРаздела1()
	...
	ОчиститьТабличноеПолеНаСервере("ТабличныйДокумент");
...
Процедура СформироватьРаздел1()
	...
	Для Инд = 0 По КоличествоСтраниц - 1 Цикл
		...
		ОКАТО = ТаблицаСтраницРаздела2[Инд].Данные[0].Значение["ОкатоРаздел2"];
		
		Сумма = ПолучитьСуммуИзРаздела2ПоОКАТО(ЭтаФорма,ОКАТО);
	...
	СтруктураРеквизитовФормы.ВременноЗапретитьАвторасчетДляФормированияРаздела1 = Истина;
	...
	Для Инд = 0 По ДляХраненияМассиваОкатоСумма.Количество() - 1 Цикл				
		...
		Попытка
			...
			ТабличныйДокумент.Области["ОКАТО_1"].Значение=МассивОкато[Инд];
			ТабличныйДокумент.Области["Сумма1_1"].Значение=ДляХраненияМассиваОкатоСумма[МассивОкато[Инд]];
			ТабличныйДокумент.Области["Сумма40_1"].Значение=0;
			ТабличныйДокумент.Области["Сумма50_1"].Значение=0;			
			ТабличныйДокумент.Области["Сумма60_1"].Значение=0;
			
			СтруктураРеквизитовФормы.ВременноЗапретитьАвторасчетДляФормированияРаздела1=Ложь;
			РасчетНаСервере("Раздел1","Сумма1_1");
			СтруктураРеквизитовФормы.ВременноЗапретитьАвторасчетДляФормированияРаздела1=Истина;
...
Процедура ОбнулитьПеременныеМодуляХранящиеЗначенияКвадратногоПредставленияПоРазделу(Форма, Знач ИмяРаздела, ПеременныеМодуля)
	...
	Если ТипЗнч(Форма.мСтруктураПеременных) <> Тип("Структура") Тогда
	...
	ИначеЕсли ИмяСтраницы = "Раздел1" Тогда
		...
		Форма.мСтруктураПеременных.Вставить("КБКРаздел1", "");
		Форма.мСтруктураПеременных.Вставить("ОКАТОРаздел1", "");
		Форма.мСтруктураПеременных.Вставить("Сумма30Раздел1", 0);
		Форма.мСтруктураПеременных.Вставить("Сумма40Раздел1", 0);
		Форма.мСтруктураПеременных.Вставить("Сумма50Раздел1", 0);
		Форма.мСтруктураПеременных.Вставить("Сумма60Раздел1", 0);

	ИначеЕсли ИмяСтраницы = "Раздел2" Тогда
		Форма.мСтруктураПеременных.Вставить("ОКАТОРаздел2", "");
	КонецЕсли;
...
Процедура ВывестиМакетВТаблДокНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета, ЗаголовокРаздела = Ложь)
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2" Тогда			  
		...
		СписокДанных = ЭтаФорма[НаимТаблицыСтраницы][НомерСтраницыРазделаОтчета - 1].Данные;//[0].Значение;
...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "") Экспорт
	...
	Если Форма.СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет
	 ИЛИ Форма.СтруктураРеквизитовФормы.ВременноЗапретитьАвторасчетДляФормированияРаздела1 Тогда
		Возврат;
	КонецЕсли;
	...
	Если ИмяТекущейСтраницыПанели = "Раздел1" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
			...
			ПолеТабличногоДокументаРаздел1 = Форма.ТабличныйДокумент.Области;
			
			Колонка = Сред(ОбластьИмя, 1, 13);
			
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Сумма50_1, ОбластьИмя) > 0
				ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.Сумма60_1, ОбластьИмя) > 0 Тогда
				
				Если Форма.СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета >= '20110101' Тогда
					ПолеТабличногоДокументаРаздел1["Сумма50_1"].Значение = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма1_1"].Значение), 0);
				Иначе
					ПолеТабличногоДокументаРаздел1["Сумма50_1"].Значение = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма1_1"].Значение) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма40_1"].Значение), 0);
				КонецЕсли;
				
				ПолеТабличногоДокументаРаздел1["Сумма60_1"].Значение = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма40_1"].Значение)
				- РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма1_1"].Значение), 0);
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "Раздел2" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
			...
			Если НЕ ЗначениеЗаполнено(Колонка) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020002011, Колонка) > 0 Тогда
				
				ПолеТабличногоДокументаРаздел2["П000020002011_" + ИндексЯчейки].Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел2["П000020002006_" + ИндексЯчейки].Значение
				* ПолеТабличногоДокументаРаздел2["П000020002009_" + ИндексЯчейки].Значение
				* ПолеТабличногоДокументаРаздел2["П000020002010_" + ИндексЯчейки].Значение);
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(Колонка) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020002014, Колонка) > 0  Тогда
				
				ПолеТабличногоДокументаРаздел2["П000020002014_" + ИндексЯчейки].Значение = Макс( ПолеТабличногоДокументаРаздел2["П000020002011_" + ИндексЯчейки].Значение
				- РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел2["П000020002013_" + ИндексЯчейки].Значение), 0);
...
Процедура ПолныйРасчетРаздела1(Форма, ОбластьИмя = "")
	...
	Для Каждого СтраницаРаздела1 Из Форма.ТаблицаСтраницыРазделаРаздел1 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета >= '20110101' Тогда
				ПолеТабличногоДокументаРаздел1["Сумма50_1"] = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма1_1"]), 0);
			Иначе
				ПолеТабличногоДокументаРаздел1["Сумма50_1"] = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма1_1"]) - РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма40_1"]), 0);
			КонецЕсли;
			
			ПолеТабличногоДокументаРаздел1["Сумма60_1"] = Макс(РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма40_1"])
			- РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолеТабличногоДокументаРаздел1["Сумма1_1"]), 0);
...
Процедура ПолныйРасчетРаздела2(Форма, ОбластьИмя = "")
	...
	Для Каждого СтраницаРаздела2 Из Форма.ТаблицаСтраницыРазделаРаздел2 Цикл
		...
		ДанныеДопСтрок = СтраницаРаздела2.ДанныеДопСтрок[0].Значение;
		...
		Для Каждого ДопСтрока Из ДанныеДопСтрок Цикл
			...
			Если НЕ ЗначениеЗаполнено(Колонка) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020002011, Колонка) > 0 Тогда
				...
				ДопСтрока.П000020002011 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ДопСтрока.П000020002006
				* ДопСтрока.П000020002009
				* ДопСтрока.П000020002010);
				
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(Колонка) ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020002014, Колонка) > 0  Тогда
				
				ДопСтрока.П000020002014 = Макс( ДопСтрока.П000020002011
				- РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ДопСтрока.П000020002013), 0);
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
		...
		Если СтрНайти(ОбластьИмя, "ОКАТО") > 0 И ЗначениеЗаполнено(Область.Значение) Тогда
		...
		ИначеЕсли СтрНайти(ОбластьИмя, "Сумма1_") > 0 Тогда 
			мСтруктураПеременных.Вставить("Сумма30Раздел1", Область.Значение);
			РасчетНаКлиенте("Раздел1", ОбластьИмя);
		// Строка 040.
		ИначеЕсли СтрНайти(ОбластьИмя, "Сумма40_") > 0 Тогда
			мСтруктураПеременных.Вставить("Сумма40Раздел1", Область.Значение);
			РасчетНаКлиенте("Раздел1", ОбластьИмя);
		// Строка 050.
		ИначеЕсли СтрНайти(ОбластьИмя, "Сумма50_") > 0 Тогда
			мСтруктураПеременных.Вставить("Сумма50Раздел1", Область.Значение);
		// Строка 060.
		ИначеЕсли СтрНайти(ОбластьИмя, "Сумма60_") > 0 Тогда
				мСтруктураПеременных.Вставить("Сумма60Раздел1", Область.Значение);
		Конецесли;
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
		...
		Если СтрНайти(ОбластьИмя, "ОКАТОРаздел2") > 0 И ЗначениеЗаполнено(Область.Значение) Тогда
			ДлинаЗначения = СтрДлина(СокрЛП(Область.Значение));
			Для Инд = ДлинаЗначения+1 По 11 Цикл
				Область.Значение = СокрЛП(Область.Значение) + "0";
			КонецЦикла;
		ИначеЕсли НЕ СтрНайти(ОбластьИмя, "ОКАТОРаздел2") > 0 Тогда
...
Процедура ТабличныйДокументПриАктивизацииОбласти(Элемент)
	...
	Если СтрЧислоВхождений(Элемент.ТекущаяОбласть.Имя, "П0000200020") > 0 Тогда
...
Процедура ТабличныйДокументВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел1" Тогда
		...
		// Строка 010.
		Если СтрНайти(Ячейка,"КБК") > 0 И НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
			
			ПервоначальноеЗначение = Область.Значение;
			
			СтандартнаяОбработка = Ложь;
			
			Если мКодыБюджетнойКлассификации2005.Количество() = 0 Тогда
			...
			ПараметрыФормы = Новый Структура;
			ПараметрыФормы.Вставить("Заголовок",          "Выберите КБК (20 знаков)");
			...
			ОписаниеОповещения = Новый ОписаниеОповещения("ОткрытьФормуВыбораКБКЗавершение", ЭтотОбъект);
	...
	ИначеЕсли Элементы.РазделыОтчета.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Раздел2" Тогда
		...
		ОбластьИмя = Область.Имя;		
		// Графа 2. Код вида ТС.                    // Графа 7. Код ОКЕИ                        // Графа 12. Налоговая льгота.
		Если  СтрНайти(Область.Имя, "П000020002002") > 0 ИЛИ СтрНайти(ОбластьИмя, "П000020002007") > 0 ИЛИ  СтрНайти(Область.Имя, "П000020002012") > 0 Тогда
			Если НЕ СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
				
				СтандартнаяОбработка = Ложь;
				Если СтрНайти(Область.Имя, "П000020002002") > 0 Тогда
					
					Если мВидыТранспортныхСредств.Количество() = 0 Тогда
						ЗагрузитьПоказателиИзМакета("ВидыТранспортныхСредств");
					КонецЕсли;										
					ТаблицаКодов = мВидыТранспортныхСредств;
					ЗаголовокФормыВыбора="Выберите код вида транспортного средства";
					
				ИначеЕсли СтрНайти(ОбластьИмя, "П000020002007") > 0 Тогда
					
					Если мКодыОКЕИ.Количество() = 0 Тогда
						ЗагрузитьПоказателиИзМакета("КодыОКЕИ");
					КонецЕсли;										
					ТаблицаКодов = мКодыОКЕИ;
					ЗаголовокФормыВыбора="Выберите Ед. измерения налоговой базы по ОКЕИ";
					
				Иначе
					
					Если мКодыЛьгот.Количество() = 0 Тогда
						ЗагрузитьПоказателиИзМакета("КодыЛьгот");
					КонецЕсли;										
					ТаблицаКодов = мКодыЛьгот;
					ЗаголовокФормыВыбора="Выберите код налоговой льготы";
				...
				ОписаниеОповещения = Новый ОписаниеОповещения("ОткрытьФормуВводаКодаЛьготЗавершение", ЭтотОбъект, ДополнительныеПараметры);
				ОткрытьФорму("Обработка.ОбщиеОбъектыРеглОтчетности.Форма.ФормаВыбораЗначенияИзТаблицы", ПараметрыФормы, ЭтаФорма,,,, ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);	
...
&НаКлиенте
Процедура ОткрытьФормуВводаКодаЛьготЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ТабличныйДокумент.Области[Область.Имя].Значение = Результат["Код"];
...
Процедура ОткрытьФормуВыбораКБКЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ТабличныйДокумент.Области["КБК_1"].Значение = Результат["Код"];
...
&НаСервере
Процедура ВставитьДополнительнуюСтрокуНаСервере(ИмяГруппы = Неопределено)
	
	ВставитьДополнительнуюСтроку(ЭтаФорма, ИмяГруппы);
	
КонецПроцедуры // ВставитьДополнительнуюСтрокуНаСервере()

&НаКлиенте
Процедура ВставитьДополнительнуюСтрокуНаКлиенте(ИмяГруппы = Неопределено)
...
Процедура ВставитьДополнительнуюСтроку(Форма, ТекущаяСтраница)
	...
	Текст = Форма[ТекТабличноеПолеИмя].Область().Текст;
	ТекТабличноеПоле = Форма[ТекТабличноеПолеИмя];
	Форма.мСтруктураМногострочныхРазделов.Свойство(ИмяГруппы, СтруктураГруппы);
	СтруктураГруппы = Форма[СтруктураГруппы];
...
Процедура ВставитьДополнительнуюСтраницуНаСервере(ИмяТекущейСтраницыПанели = Неопределено ) Экспорт
	...
	Если СтрНайти(ИмяТекущейСтраницыПанели,"Раздел2")<>0 Тогда
		РасчетНаСервере("Раздел2","П000020002009_1");
	КонецЕсли;
...
КонецПроцедуры // ВставитьДополнительнуюСтраницуНаКлиенте()
	...
	Для Каждого Область Из ИсходныйМакет.Области Цикл
		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник И Область.СодержитЗначение Тогда
			...
			ИначеЕсли ПараметрыПечати.ИмяСтраницы = "Раздел1" Тогда
				...
				Если СтрЧислоВхождений(Область.Имя, "КБК") > 0
				 ИЛИ СтрЧислоВхождений(Область.Имя, "ОКАТО") > 0 Тогда
				 	...
				 	// Введено из-за оптимизаторов, не соблюдающих нотации при переименовании полей.
				 	НовИмяОбласти=Лев(Область.Имя,СтрДлина(Область.Имя)-2);
					НовЗначениеОбласти=СтрЗаменить(Строка(Область.Значение)," ","");
					Для Ном = 1 По СтрДлина(НовЗначениеОбласти) Цикл						
						МакетПечатнойФормы.Области[НовИмяОбласти + Ном].Значение = Сред(НовЗначениеОбласти, Ном, 1);
					КонецЦикла;
					
					Продолжить;
					
				ИначеЕсли СтрЧислоВхождений(Область.Имя, "Сумма1_") > 0
							ИЛИ СтрЧислоВхождений(Область.Имя, "Сумма40_") > 0
							ИЛИ СтрЧислоВхождений(Область.Имя, "Сумма50_") > 0
					  		ИЛИ СтрЧислоВхождений(Область.Имя, "Сумма60_") > 0 Тогда
					  ...
					  Если ЗначениеЗаполнено(Область.Значение) Тогда 
						  ...
						  Для Ном = 1 По СтрДлина(НовЗначениеОбласти) Цикл
							  ...
							  МакетПечатнойФормы.Области[НовИмяОбласти + "_" + (16 - Ном)].Значение = Сред(НовЗначениеОбласти, СтрДлина(НовЗначениеОбласти) + 1 - Ном, 1);
			...
			ИначеЕсли ПараметрыПечати.ИмяСтраницы = "Раздел2" Тогда
				...
				Если СтрЧислоВхождений(Область.Имя, "ОКАТОРаздел2") > 0 Тогда
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	Если ИдГруппы <> Неопределено Тогда
		...
		ВремПер						 = ОбластьМнгЧасти.ПолучитьОбласть(ВысотаОбластиМнгЧасти - 2, , ВысотаОбластиМнгЧасти);
		ИмяОбластиПоследнейДопСтроки = ВремПер.Области[0].Имя;
		...
		Если КолвоСтрокВТаблДок > КолвоСтрокВПечатнойФорме Тогда
			...
			Мпер=ИдГруппы + Формат(мСтруктураКолвоКолонокРазделов[ИдГруппы], "ЧЦ=2; ЧВН=") + "_" + КолвоСтрокВПечатнойФорме;
			...
			Для Каждого Область Из МакетМЧБ.ПолучитьОбласть(НомерВерхЯчейкиОбласти + КолвоДопСтрок*3, , НомерНижнЯчейкиОбласти + КолвоДопСтрок*3).Области Цикл
			...
			Для Ном = 0 По КолвоДопСтрок - 1 Цикл
				...
				Для Каждого Область Из МакетМЧБ.ПолучитьОбласть(НомерВерхЯчейкиОбласти + КолвоДопСтрок*3, , НомерНижнЯчейкиОбласти + КолвоДопСтрок*3).Области Цикл
					...
					НайденнаяОбласть = МакетМЧБ.Область(НомерВерхЯчейкиОбласти + Ном*3, Область.Лево, НомерВерхЯчейкиОбласти + Ном*3, Область.Право);
			...
			Для Ном = 1 По КолвоДопСтрок Цикл
				...
				Если НЕ МакетМЧБ.Области.Найти("П000020002001_" + (Ном + 11)) = Неопределено Тогда
					МакетМЧБ.Области["П000020002001_" + (Ном + 11)].Текст = Ном + 11;
				КонецЕсли;
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель)
	...
	Для Каждого Лист Из Раздел1 Цикл
		...
		ЗадатьЗначениеЭлемента(ТекСтр1, "КБК", ДанныеЛиста.КБК_1);
		ЗадатьЗначениеЭлемента(ТекСтр1, "ОКАТО", ДанныеЛиста.ОКАТО_1);
		ЗадатьЗначениеЭлемента(ТекСтр1, "Исчислено", ДанныеЛиста.Сумма1_1);
		ЗадатьЗначениеЭлемента(ТекСтр1, "СумУплАв", ДанныеЛиста.Сумма40_1);
		ЗадатьЗначениеЭлемента(ТекСтр1, "СумУплНал", ?(ДанныеЛиста.Сумма50_1 < 0, 0, ДанныеЛиста.Сумма50_1));
		ЗадатьЗначениеЭлемента(ТекСтр1, "СумУмен", ?(ДанныеЛиста.Сумма60_1 < 0, 0, ДанныеЛиста.Сумма60_1));
		...
		Для Каждого Лист2 Из Раздел2 Цикл
			...
			Если СокрЛП(ДанныеЛиста.ОКАТО_1) = СокрЛП(ДанныеЛиста2.ОКАТОРаздел2) Тогда
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СтруктураXML2007");
...
//
&НаКлиентеНаСервереБезКонтекста
Функция ПолучитьСуммуИзРаздела2ПоОКАТО(Форма, Знач ОКАТО)

	НакопительнаяСуммаКолонка14 = 0;
	Для Каждого Стр Из Форма[Форма.мСтруктураМногостраничныхРазделов.Раздел2] Цикл
		
		Если Стр.Данные[0].Значение["ОКАТОРаздел2"] = ОКАТО Тогда
			// 1 - Окато 13 -строки без индексного столбца
			КоличСтрокДляСуммы= (Стр.Данные[0].Значение.Количество() - 1)/13;
			Для Инд = 0 По КоличСтрокДляСуммы-1 Цикл				
				НакопительнаяСуммаКолонка14=НакопительнаяСуммаКолонка14+Стр.Данные[0].Значение["П000020002014_"+Строка(Инд+1)];
			КонецЦикла;
		КонецЕсли;
	КонецЦикла;
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.ФамилияПред) И ПустаяСтрока(ПараметрыВыгрузки.ИмяПред) Тогда
	...
	Если ПустаяСтрока(Титульный.КодИМНС) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На задан код налогового органа!", "Титульный", "КодИМНС");
		СтатусПроверки = Ложь;
	КонецЕсли;
	
	Если ПустаяСтрока(Титульный.ОКВЭД)Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "На титульном листе не задан код ОКВЭД!", "Титульный", "ОКВЭД1");
		СтатусПроверки = Ложь;
	КонецЕсли;
	...
	Для Каждого Лист Из Раздел1 Цикл
		...
		ДлинаКБК = СтрДлина(ДанныеЛиста.КБК_1);
		Если ДлинаКБК <> 20 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 1 на странице " + ИндексЛиста + " не" + ?(ДлинаКБК = 0, "", " верно") + " задан КБК!", "Раздел1", "КБК1", ИндексЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
		
		ДлинаОКАТО = СтрДлина(ДанныеЛиста.ОКАТО_1);
		Если ДлинаОКАТО <> 11 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В разделе 1 на странице " + ИндексЛиста + " не" + ?(ДлинаОКАТО = 0, "", " верно") + " задан ОКАТО!", "Раздел1", "ОКАТО1", ИндексЛиста);
			СтатусПроверки = Ложь;
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого Лист2 Из Раздел2 Цикл
		...
		Пока ДанныеЛиста2.Свойство("П000020002002_" + _НомСтр)
			...
			Если ДлинаКодаВидаТС <> 5 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В строке " + НомСтр + " страницы " + НомерЛиста + " раздела 2 не" + ?(ДлинаКодаВидаТС = 0, "", "верно") + " задан код вида транспортного средства!", "Раздел2", "П000020002002_" + _НомСтр, НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если СтрДлина(РегЗнакТС) = 0 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В строке " + НомСтр + " страницы " + НомерЛиста + " раздела 2 не задан регистрационный знак транспортного средства!", "Раздел2", "П000020002005_" + _НомСтр, НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			ДлинаОКЕИНалБаза = СтрДлина(ОКЕИНалБаза);
			Если ДлинаОКЕИНалБаза = 0 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В строке " + НомСтр + " страницы " + НомерЛиста + " раздела 2 не" + ?(ДлинаОКЕИНалБаза = 0, "", "верно") + " задана единица измерения налоговой базы по ОКЕИ!", "Раздел2", "П000020002007_" + _НомСтр, НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			ДлинаКодаНалЛьг = СтрДлина(КодНалЛьг);
			Если ДлинаКодаНалЛьг <> 0 И ДлинаКодаНалЛьг <> 5 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "В строке " + НомСтр + " страницы " + НомерЛиста + " раздела 2 неверно задан код налоговой льготы!", "Раздел2", "П000020002012_" + _НомСтр, НомерЛиста);
				СтатусПроверки = Ложь;
			КонецЕсли;
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("НаимОрг",		?(ПустаяСтрока(Титульный.ИноОргНазв), СокрЛП(Титульный.ОргНазв), СокрЛП(Титульный.ИноОргНазв)));
	...
	ПараметрыВыгрузки.Вставить("ОКВЭДОрг",		ОКВЭД);
	ПараметрыВыгрузки.Вставить("ТелОрг",		СокрЛП(Титульный.ТелОрганизации));
	ПараметрыВыгрузки.Вставить("КНД",			"1152004");
...
Процедура ЗаполнитьАвтоНаСервере()
	...
	Контейнер.Вставить("Раздел2_ДанныеДопСтрок",          П0000200020);
	Контейнер.Вставить("Раздел2_ХранилищеДанныхДопСтрок", ХранилищеП0000200020);
