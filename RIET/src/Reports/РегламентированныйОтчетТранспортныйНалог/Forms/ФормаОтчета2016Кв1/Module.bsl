...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "09/01/2017";
	...
	// { RGS VShamin 27.01.2015 14:25:24 - Обновление на 3.0.37.38 - перенос из предыдущей версии (LFedotova 29.01.2018 12:27:12 - вопрос SLI-0007473)
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	// { RGS LFedotova 29.01.2018 18:36:55 - вопрос
	//СтруктураРеквизитовФормы.Вставить("ОтображатьКнопкуЗаполнить", Ложь);
	СтруктураРеквизитовФормы.Вставить("ОтображатьКнопкуЗаполнить", Истина);
	// } RGS LFedotova 29.01.2018 18:37:00 - вопрос 
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	// { RGS LFedotova 29.01.2018 16:44:55 - вопрос SLI-0007473
	//РегламентированнаяОтчетность.ДобавитьКнопкуПрисоединенныеФайлы(ЭтаФорма);
	// } RGS LFedotova 29.01.2018 16:45:14 - вопрос SLI-0007473
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020010003", 3, , "Выбор единицы измерения налоговой базы", КоллекцияСписковВыбора["КодыОКЕИ"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020011003", 1, , "Выбор экологического класса", КоллекцияСписковВыбора["КодыЭкологическихКлассов"]);
	
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) >= 2018 Тогда
		ИмяСекцииЗначенияКоэффициентаКп = "ЗначенияКоэффициентаКп_20180101";
	Иначе
		ИмяСекцииЗначенияКоэффициентаКп = "ЗначенияКоэффициентаКп";
	КонецЕсли;
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020018003", 3, , "Выбор значения коэффициента Кп", КоллекцияСписковВыбора[ИмяСекцииЗначенияКоэффициентаКп]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020022003_КодЛьготы", 5, , "Выбор кода льготы", КоллекцияСписковВыбора["КодыЛьготОсвобожденияОтНалогообложения"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020024003_КодЛьготы", 5, , "Выбор кода льготы", КоллекцияСписковВыбора["КодыЛьготУменьшенияСуммыНалога"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020026003_КодЛьготы", 5, , "Выбор кода льготы", КоллекцияСписковВыбора["КодыЛьготСниженияНалоговойСтавки"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020028003", 5, , "Выбор кода вычета", КоллекцияСписковВыбора["КодыНалоговыхВычетов"]);
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	// Раздел 2
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020016003", "П000020014003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020019003", "П000020009003;П000020014003;П000020015003_Числ;П000020015003_Знам;П000020016003;П000020017003;П000020018003");
...
Процедура ВосстановитьСохраненныеДанные()
	...
	// { RGS LFedotova 30.01.2018 17:02:15 - вопрос SLI-0007478
	//Если СтруктураРеквизитовФормы.Организация <> СтруктураРеквизитовФормы.мСохраненныйДок.Организация
	Если СтруктураРеквизитовФормы.мСохраненныйДок <> Неопределено 
		// } RGS LFedotova 30.01.2018 17:02:21 - вопрос SLI-0007478
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ВПрограммеИзмененаДатаПодписи Тогда
		...
		// { RGS VShamin 01.27.2015 14:25:24 - Обновление на 3.0.37.38 убрали телефон организации - перенос из предыдущей версии (LFedotova 29.01.2018 12:27:12 - вопрос SLI-0007473)
		...
		КонецЕсли;
		// } RGS VShamin 01.27.2015 14:25:24 - Обновление на 3.0.37.38 - перенос из предыдущей версии (LFedotova 29.01.2018 12:27:12 - вопрос SLI-0007473)					
	...
	// { RGS LFedotova 29.01.2018 15:00:38 - вопрос SLI-0007473
	...
	Попытка
		Форма.ТабличныйДокумент.Области.ОКВЭД.Значение = СокрЛП(Форма.СтруктураРеквизитовФормы.ОКВЭД);																 
	Исключение
	КонецПопытки; 																 
	// } RGS LFedotova 29.01.2018 15:00:59 - вопрос SLI-0007473
...
Функция Сохранить(Автосохранение = Ложь, КодИФНС, КПП, Вариант, ВидДокументаНомерКорректировкиИзменен = Неопределено, НаимТекРаздела) Экспорт
	...
	Попытка
		...
		// { RGS LFedotova 29.01.2018 21:27:05 - вопрос SLI-0007473
		//РегламентированнаяОтчетность.СохранитьСтатусОтправкиРеглОтчета(ЭтаФорма);
		// } RGS LFedotova 29.01.2018 21:27:28 - вопрос SLI-0007473 
	Исключение
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	// { RGS LFedotova 29.01.2018 17:00:04 -  вопрос SLI-0007473
	...
	// } RGS LFedotova 29.01.2018 17:00:07 -  вопрос SLI-0007473	
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	// { RGS LFedotova 29.01.2018 17:53:02 - вопрос SLI-0007473
	//Если ЗавершениеРаботы Тогда
	//			
	//	Возврат;
	//	
	//КонецЕсли;
	// } RGS LFedotova 29.01.2018 17:53:06 - вопрос SLI-0007473
		...
		Для Инд = 1 По КоличествоСходныхБлоковНаЛисте Цикл
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Если ЗначениеЗаполнено(Строка020) Тогда
					...
					Округлять = Истина;
					ЗначениеСтроки021 = Форма.СуммаПоказателяРазделаПоСтраницам("Раздел2", "П000020030003", УсловиеСуммирования, Округлять);
				Иначе
					ЗначениеСтроки021 = 0;
				КонецЕсли;
...
Процедура РасчетРаздела2(Форма, ОбластьИмя = "", МестоРазмещенияДанных)
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Или ТипЗнч(МестоРазмещенияДанных) = Тип("Структура") Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020019003, ОбластьИмя) > 0 Тогда
			...
			ЗначениеДляСтроки190 = ЗначениеСтроки090 * ЗначениеСтроки170 * ЗначениеСтроки150 * ЗначениеСтроки160 * ЗначениеСтроки180;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020021003, ОбластьИмя) > 0 Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Не ПустаяСтрока(КодЛьготыВСтроке220) Тогда
				ЗначениеДляСтроки230 = ЗначениеСтроки090 * ЗначениеСтроки170 * ЗначениеСтроки150 * ЗначениеСтроки180 * ЗначениеСтроки210;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Не ПустаяСтрока(КодЛьготыВСтроке240) Тогда
				ЗначениеДляСтроки250 = ЗначениеСтроки090 * ЗначениеСтроки170 * ЗначениеСтроки150 * ЗначениеСтроки180 * ЗначениеСтроки210 * (ЗначениеСтроки240а / 100);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020027003, ОбластьИмя) > 0 Тогда
			...
			Если Не ПустаяСтрока(КодЛьготыВСтроке260) Тогда
				ЗначениеДляСтроки270 = ((ЗначениеСтроки090 * ЗначениеСтроки170) - (ЗначениеСтроки090 * ЗначениеСтроки260а)) * ЗначениеСтроки150 * ЗначениеСтроки180 * ЗначениеСтроки210;
			Иначе
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			ЗначениеСтроки190 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020019003"));
			ЗначениеСтроки230 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020023003"));
			ЗначениеСтроки250 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020025003"));
			ЗначениеСтроки270 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020027003"));
			ЗначениеСтроки290 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020029003"));
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	ПрефиксИмениМакетов = "ПечатныйБланк2016Кв1_";
...
// { RGS LFedotova 29.01.2018 12:23:22 - вопрос SLI-0007473
	//РегламентированнаяОтчетностьЗагрузкаКлиент.ЗагрузитьИзФайлаОтчет(ЭтотОбъект);
// } RGS LFedotova 29.01.2018 12:23:35 - вопрос SLI-0007473
...
Функция ЗагрузкаОтчетаИзФайла(ДанныеДляЗагрузки) Экспорт
	...
	// { RGS LFedotova 29.01.2018 12:21:24 - вопрос SLI-0007473
	//Если Модифицированность Тогда
	//	Сообщение = Новый СообщениеПользователю;
	...
	Сообщение = Новый СообщениеПользователю;
	Сообщение.Текст = СтрШаблон(НСтр("ru='Загрузка из файла отчета ""%1"" не предусмотрена.'"), ЭтотОбъект.Заголовок);
	
	Возврат Ложь;
	// } RGS LFedotova 29.01.2018 12:21:36 - вопрос SLI-0007473
	
КонецФункции

// { RGS LFedotova 29.01.2018 12:22:27 - вопрос SLI-0007473
//&НаСервере
...
//	
//КонецФункции
// } RGS LFedotova 29.01.2018 12:22:34 - вопрос SLI-0007473
...
Процедура ПроверитьЗаполнение_Раздел2(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из Раздел2 Цикл
		...
		Если ЛистЗаполнен ИЛИ ЗаданоОКТМО Тогда
			...
			// Даты регистрации и снятия с учета, год выпуска транспортного средства.
			...
			Если НЕ Область1Заполнена Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы + " раздела 2 не задана дата регистрации транспортного средства",
			...
			ИначеЕсли Год(ДанныеЛиста[ИмяПроверяемойОбласти1]) > Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы + " раздела 2 дата регистрации транспортного средства должна быть не больше даты окончания налогового периода.",
					"Раздел2", ИмяПроверяемойОбласти1, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			Если Область2Заполнена Тогда
				Если Год(ДанныеЛиста[ИмяПроверяемойОбласти2]) < Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
						"На странице " + НомерСтраницы + " раздела 2 дата прекращения регистрации транспортного средства (снятия с учета) должна быть не меньше даты начала налогового периода.",
				...
				Если ДанныеЛиста[ИмяПроверяемойОбласти1] > ДанныеЛиста[ИмяПроверяемойОбласти2] Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
						"На странице " + НомерСтраницы + " раздела 2 дата регистрации транспортного средства должна быть не больше даты прекращения регистрации транспортного средства (снятия с учета).",
						"Раздел2", ИмяПроверяемойОбласти1, НомерСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
			КонецЕсли;
			Если Область3Заполнена И Область1Заполнена Тогда
				Если Число(ДанныеЛиста[ИмяПроверяемойОбласти3]) > Год(ДанныеЛиста[ИмяПроверяемойОбласти1]) Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
						"На странице " + НомерСтраницы + " раздела 2 год выпуска транспортного средства должен быть не больше года, указанного в дате регистрации транспортного средства.",
...
Процедура ЗаполнитьАвтоЗавершение(Отказ, ДополнительныеПараметры) Экспорт
	...
	// { RGS LFedotova 30.01.2018 9:21:30 - вопрос SLI-0007473
	Попытка
	...
	Исключение
	КонецПопытки;
	// } RGS LFedotova 30.01.2018 9:21:53 - вопрос SLI-0007473
...
Процедура ЗаполнитьАвтоНаСервере()
	...
	// { RGS LFedotova 30.01.2018 9:02:28 - вопрос SLI-0007473
	...
	Иначе
		Инициализация();	
	КонецЕсли;
	// } RGS LFedotova 30.01.2018 9:02:44 - вопрос SLI-0007473 
...
// { RGS LFedotova 29.01.2018 16:34:29 - вопрос SLI-0007473
Процедура ПолучитьЗначениеОКВЭД(ДатаПодписи, СтруктураРеквизитовФормы) Экспорт
	...
	СтруктураРеквизитовФормы.Вставить("ОКВЭД2", СокрЛП(СведенияОбОрганизации.ОКВЭД));
		
КонецПроцедуры
// } RGS LFedotova 29.01.2018 16:35:15 - вопрос SLI-0007473