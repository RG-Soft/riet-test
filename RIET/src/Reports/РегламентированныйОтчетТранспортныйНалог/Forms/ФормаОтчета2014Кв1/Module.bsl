//
//Обновление на 3.0.37.38
//RG-SOFT - VShamin  27.01.2016
//
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мВерсияФормы = "01/09/2014";
	...
	// { RGS VShamin 27.01.2015 14:25:24 - Обновление на 3.0.37.38
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СпискиВыбора2014Кв1");
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020003003", 5, , "Выбор вида транспортного средства", КоллекцияСписковВыбора["ВидыТранспортныхСредств"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020015003", 3, , "Выбор значения коэффициента Кп", КоллекцияСписковВыбора["ЗначенияКоэффициентаКп"]);
	
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020019003_КодЛьготы", 5, , "Выбор льготы", КоллекцияСписковВыбора["КодыЛьготОсвобожденияОтНалогообложения"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020021003_КодЛьготы", 5, , "Выбор льготы", КоллекцияСписковВыбора["КодыЛьготУменьшенияСуммыНалога"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000020023003_КодЛьготы", 5, , "Выбор льготы", КоллекцияСписковВыбора["КодыЛьготСниженияНалоговойСтавки"]);
...
Процедура ИнициализироватьМаскиПолейВводаТабличныхДокументов(ИмяТекРаздела)
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2" Тогда
		...
		ТабличныйДокумент.Области.П000020008003.Маска = "999";
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели = "")
	...
	ИначеЕсли ИмяСтраницыПанели = "Раздел2" Тогда
		...
		ОбрабатываемаяОбласть = Форма.ТабличныйДокумент.Области.П000020019003_Основание;
		...
		ОбрабатываемаяОбласть2 = Форма.ТабличныйДокумент.Области.П000020021003_Процент;
		...
		ОпределяющаяОбласть = Форма.ТабличныйДокумент.Области.П000020023003_КодЛьготы;
		
		ОбрабатываемаяОбласть1 = Форма.ТабличныйДокумент.Области.П000020023003_Основание;
		ОбрабатываемаяОбласть2 = Форма.ТабличныйДокумент.Области.П000020023003_Ставка;
		ОбрабатываемаяОбласть3 = Форма.ТабличныйДокумент.Области.П000020024003;
...
Процедура ЗаполнитьСтруктуруЗависимыхЯчеекДляАвторасчета()
	...
	// Раздел 2
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020013003", "П000020011003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020016003", "П000020007003;П000020011003;П000020012003_Числ;П000020012003_Знам;П000020013003;П000020014003;П000020015003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020018003", "П000020017003");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020020003", "П000020007003;П000020012003_Числ;П000020012003_Знам;П000020014003;П000020015003;П000020017003;П000020018003;П000020019003_КодЛьготы");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020022003", "П000020007003;П000020012003_Числ;П000020012003_Знам;П000020014003;П000020015003;П000020017003;П000020018003;П000020021003_Процент");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020024003", "П000020007003;П000020012003_Числ;П000020012003_Знам;П000020014003;П000020015003;П000020017003;П000020018003;П000020023003_Ставка;П000020023003_КодЛьготы");
	СтруктураЗависимыхЯчеекДляАвторасчета.Вставить("П000020025003", "П000020007003;П000020011003;П000020012003_Числ;П000020012003_Знам;П000020013003;П000020014003;П000020015003;П000020017003;П000020018003;П000020019003_КодЛьготы;П000020021003_Процент;П000020023003_Ставка;П000020023003_КодЛьготы");
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ВПрограммеИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ВПрограммеИзмененаДатаПодписи Тогда
		...
		// { RGS VShamin 01.27.2015 14:25:24 - Обновление на 3.0.37.38 убрали телефон организации
		...
		КонецЕсли;
		// } RGS VShamin 01.27.2015 14:25:24 - Обновление на 3.0.37.38					
		...
		Форма.ТабличныйДокумент.Области["ОКВЭД"].Значение = СокрЛП(СведенияОбОрганизации.ОКВЭД);
...
Процедура СформироватьРаздел1()
	...
	Для Инд = 0 По КоличествоСтраниц - 1 Цикл
		...
		Если НЕ ПустаяСтрока(ОКАТО) Тогда
			...
			Сумма = СуммаПоказателяРазделаПоСтраницам("Раздел2", "П000020025003", УсловиеСуммирования, Истина);
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Или ТипЗнч(МестоРазмещенияДанных) = Тип("Структура") Тогда
		...
		Для Инд = 1 По КоличествоСходныхБлоковНаЛисте Цикл
			...
			Если НЕ ЗначениеЗаполнено(ОбластьИмя)
				...
				Строка020 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000010002003" + ПостфиксИмениОбласти); // ОКТМО
				
				Если ЗначениеЗаполнено(Строка020) Тогда
					УсловиеСуммирования = Новый Структура;
					УсловиеСуммирования.Вставить("П000020002003", Строка020);
					Округлять = Истина;
					ЗначениеСтроки021 = Форма.СуммаПоказателяРазделаПоСтраницам("Раздел2", "П000020025003", УсловиеСуммирования, Округлять);
				Иначе
					ЗначениеСтроки021 = 0;
				КонецЕсли;
...
Процедура РасчетРаздела2(Форма, ОбластьИмя = "", МестоРазмещенияДанных)
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Или ТипЗнч(МестоРазмещенияДанных) = Тип("Структура") Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020013003, ОбластьИмя) > 0 Тогда
			
			ЗначениеСтроки110 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020011003");
			ЗначениеДляСтроки130 = Окр(ЗначениеСтроки110 / 12, 4);
			ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П000020013003", ЗначениеДляСтроки130);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			ЗначениеСтроки120_Числ = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020012003_Числ");
			ЗначениеСтроки120_Знам = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020012003_Знам");
			ЗначениеСтроки120 = 0;
			Если ЗначениеСтроки120_Числ > 0 И ЗначениеСтроки120_Знам > 0 Тогда
				ЗначениеСтроки120 = ЗначениеСтроки120_Числ / ЗначениеСтроки120_Знам;
			КонецЕсли;
			
			ЗначениеСтроки150 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020015003");
			ЗначениеСтроки150 = ?(ЗначениеСтроки150 = 0, 1, ЗначениеСтроки150);
			
			ЗначениеДляСтроки160 = ЗначениеСтроки070 * ЗначениеСтроки140 * ЗначениеСтроки120 * ЗначениеСтроки130 * ЗначениеСтроки150;
			ЗначениеДляСтроки160 = Окр(ЗначениеДляСтроки160, 2);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			ЗначениеДляСтроки180 = Окр(ЗначениеСтроки170 / 12, 4);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Не ПустаяСтрока(КодЛьготыВСтроке190) Тогда
				ЗначениеДляСтроки200 = ЗначениеСтроки070 * ЗначениеСтроки140 * ЗначениеСтроки120 * ЗначениеСтроки150 * ЗначениеСтроки180;
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			...
			ЗначениеСтроки140  = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020014003");
			ЗначениеСтроки180  = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020018003");
			ЗначениеСтроки210а = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020021003_Процент");
			...
			Если Не ПустаяСтрока(КодЛьготыВСтроке210) Тогда
				ЗначениеДляСтроки220 = ЗначениеСтроки070 * ЗначениеСтроки140 * ЗначениеСтроки120 * ЗначениеСтроки150 * ЗначениеСтроки180 * (ЗначениеСтроки210а / 100);
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020024003, ОбластьИмя) > 0 Тогда
			
			ЗначениеСтроки070  = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020007003");
			ЗначениеСтроки140  = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020014003");
			ЗначениеСтроки180  = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020018003");
			ЗначениеСтроки230а = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020023003_Ставка");
			...
			КодЛьготыВСтроке230 = ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020023003_КодЛьготы");
			Если Не ПустаяСтрока(КодЛьготыВСтроке230) Тогда
				ЗначениеДляСтроки240 = ((ЗначениеСтроки070 * ЗначениеСтроки140) - (ЗначениеСтроки070 * ЗначениеСтроки230а)) * ЗначениеСтроки120 * ЗначениеСтроки150 * ЗначениеСтроки180;
			Иначе
				ЗначениеДляСтроки240 = 0;
			КонецЕсли;
			ЗначениеДляСтроки240 = Окр(ЗначениеДляСтроки240, 2);
			ПоместитьДанныеПоМестуРазмещения(МестоРазмещенияДанных, "П000020024003", ЗначениеДляСтроки240);
			
		КонецЕсли;
		
		Если НЕ ЗначениеЗаполнено(ОбластьИмя)
			ИЛИ СтрЧислоВхождений(Форма.СтруктураЗависимыхЯчеекДляАвторасчета.П000020025003, ОбластьИмя) > 0 Тогда
			
			ЗначениеСтроки160 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020016003"));
			...
			ЗначениеСтроки240 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(Форма, ПолучитьДанныеИзМестаРазмещения(МестоРазмещенияДанных, "П000020024003"));
			
			Если ЗначениеСтроки200 <> 0 Тогда
				ЗначениеДляСтроки250 = ЗначениеСтроки160 - ЗначениеСтроки200;
			Иначе
				ЗначениеДляСтроки250 = ЗначениеСтроки160 - ЗначениеСтроки220 - ЗначениеСтроки240;
			КонецЕсли;
...
Процедура ОчиститьТекущуюСтраницу(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ОчиститьТекущуюСтраницуЗавершение", ЭтотОбъект, ДополнительныеПараметры);
	РегламентированнаяОтчетностьКлиент.МеханизмыОчисткиРегламентированныхОтчетов(
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
		...
		ЭтоПолеВводаКоличестваМесяцев = (ОбластьИмя = "П000020011003" ИЛИ ОбластьИмя = "П000020017003");
		Если ЭтоПолеВводаКоличестваМесяцев И Область.Значение > 12 Тогда
			Область.Значение = 12;
		КонецЕсли;
		
		Если ОбластьИмя = "П000020019003_КодЛьготы"
		 ИЛИ ОбластьИмя = "П000020021003_КодЛьготы"
		 ИЛИ ОбластьИмя = "П000020023003_КодЛьготы" Тогда
			
			УстановитьДоступностьОбластей(ЭтаФорма, "Раздел2");
			
		КонецЕсли;
		
		Если ОбластьИмя = "П000020023003_Ставка" Тогда
			
			НалоговаяСтавка = ТабличныйДокумент.Области.П000020014003.Значение;
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	Если Область.Имя = КодПоказателя Тогда
		Если Область.Имя = "П000020015003" Тогда
...
Процедура ИзменитьФорматНевведенныхПоказателей(Форма)
	...
	ИначеЕсли Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел2" Тогда
		...
		Если ЛистЗаполнен Тогда
			Форма.ТабличныйДокумент.Области.П000020014003.Формат = "ЧДЦ=2; ЧН=";
			Форма.ТабличныйДокумент.Области.П000020016003.Формат = СтрокаФорматаНольЦифрой;
			Форма.ТабличныйДокумент.Области.П000020025003.Формат = СтрокаФорматаНольЦифрой;
		Иначе
			Форма.ТабличныйДокумент.Области.П000020014003.Формат = "ЧДЦ=2; ЧН=-";
			Форма.ТабличныйДокумент.Области.П000020016003.Формат = СтрокаФорматаНольПрочерком;
			Форма.ТабличныйДокумент.Области.П000020025003.Формат = СтрокаФорматаНольПрочерком;
		КонецЕсли;
	КонецЕсли;
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено)
	...
	ПрефиксИмениМакетов = "ПечатныйБланк2014Кв1_";
	...
	Для Каждого ЛистРаздела1 Из Раздел1 Цикл
		...
		Для НомерБлока = 1 По КоличествоОднородныхБлоковНаЛистеРаздела1 Цикл
			...
			Для Каждого ЛистРаздела2 Из Раздел2 Цикл
				...
				КодЛьготы = ДанныеРаздела2.П000020023003_КодЛьготы;
				Основание = ДанныеРаздела2.П000020023003_Основание;
				СуммаЛьготы = ДанныеРаздела2.П000020024003;
				Если НЕ ПустаяСтрока(КодЛьготы) Тогда
					Если ПустаяСтрока(Основание) Тогда
						ПолныйКодЛьготы = КодЛьготы;
					Иначе
...
Функция ИзвлечьСтруктуруXML()
	...
	Макет = Отчеты[Сред(Лев(ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, ".Форма.") - 1), 7)].ПолучитьМакет("СхемаВыгрузки503");
...
Процедура ПроверитьЗаполнение_ТитульныйЛист(ПараметрыВыгрузки, СтатусПроверки)
	...
	Если ПараметрыВыгрузки.ТипПодписанта = "2" И ПустаяСтрока(ПараметрыВыгрузки.НаимДокПредставителя) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма, "Не указан документ, удостоверяющий полномочия представителя", "Титульный", "ДокУпПред");
		СтатусПроверки = Ложь;
	КонецЕсли;
		...
		Для Инд = 1 По КоличествоБлоковРаздела Цикл
			...
			Если ЗаданоОКТМО Тогда
				...
				Если ДлинаОКТМО <> 11 И ДлинаОКТМО <> 8 ИЛИ НЕ СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(ОКТМО) Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
						"В разделе 1 на странице " + НомерСтраницы + " неверно задан код по ОКТМО", "Раздел1", ИмяОбластиОКТМО, НомерСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
			Иначе
				Если ЗаданыСуммыНалогаИПлатежей Тогда
					РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
						"В разделе 1 на странице " + НомерСтраницы + " не задан код по ОКТМО", "Раздел1", ИмяОбластиОКТМО, НомерСтраницы);
					СтатусПроверки = Ложь;
				КонецЕсли;
			КонецЕсли;
...
Процедура ПроверитьЗаполнение_Раздел2(СочетаниеРазделов, СтатусПроверки)
	...
	Для Каждого Лист Из Раздел2 Цикл
		...
		ЛистЗаполнен
			...
			ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020012003_Числ)
			ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020012003_Знам)
			...
			ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020016003)
			ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020017003)
			ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020018003)
			ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020019003_КодЛьготы)
			ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020020003)
			ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020021003_КодЛьготы)
			ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020022003)
			ИЛИ ЗначениеЗаполнено(ДанныеЛиста.П000020023003_КодЛьготы)
			ИЛИ ЗначениеСуммыЗаполнено(ДанныеЛиста.П000020024003)
		...
		Если ЗаданоОКТМО Тогда
			...
			Если ДлинаОКТМО <> 11 И ДлинаОКТМО <> 8 ИЛИ НЕ СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(ОКТМО) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"В разделе 2 на странице " + НомерСтраницы + " неверно задан код по ОКТМО", "Раздел2", ИмяОбластиОКТМО, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		Иначе
			Если ЛистЗаполнен Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"В разделе 2 на странице " + НомерСтраницы + " не задан код по ОКТМО", "Раздел2", ИмяОбластиОКТМО, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
		КонецЕсли;
		...
		Если ЛистЗаполнен ИЛИ ЗаданоОКТМО Тогда
			...
			Если ДлинаЗначенияОбласти <> 5 Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы + " раздела 2 не" + ?(ДлинаЗначенияОбласти = 0, "", "верно")
					+ " задан код вид транспортного средства", "Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			...
			Если НЕ ОбластьЗаполнена Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы + " раздела 2 не задан регистрационный знак транспортного средства",
					"Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Налоговая база.
			ИмяПроверяемойОбласти = "П000020007003";
			ОбластьЗаполнена = ЗначениеЗаполнено(ДанныеЛиста[ИмяПроверяемойОбласти]);
			Если НЕ ОбластьЗаполнена Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы + " раздела 2 не задана налоговая база",
					"Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Код вида единицы измерения по ОКЕИ.
			ИмяПроверяемойОбласти = "П000020008003";
			ДлинаЗначенияОбласти = СтрДлина(СокрЛП(ДанныеЛиста[ИмяПроверяемойОбласти]));
			Если ДлинаЗначенияОбласти <> 3 ИЛИ НЕ СтроковыеФункцииКлиентСервер.ТолькоЦифрыВСтроке(ДанныеЛиста[ИмяПроверяемойОбласти]) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы + " раздела 2 не" + ?(ДлинаЗначенияОбласти = 0, "", "верно")
					+ " задан код единицы измерения по ОКЕИ", "Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Количество полных месяцев владения транспортным средством.
			ИмяПроверяемойОбласти = "П000020011003";
			Если НЕ ЗначениеЗаполнено(ДанныеЛиста[ИмяПроверяемойОбласти]) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы
					+ " раздела 2 не указано количество полных месяцев владения транспортным средством",
					"Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Экологический класс.
			ДопустимыеЭкологическиеКлассы = "0, 1, 2, 3, 4, 5";
			...
			Если ЗначениеЗаполнено(ДанныеЛиста[ИмяПроверяемойОбласти])
			   И НЕ ЗначениеСодержитсяВСписке(ДанныеЛиста[ИмяПроверяемойОбласти], ДопустимыеЭкологическиеКлассы) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"Экологический класс на странице " + НомерСтраницы
					+ " раздела 2 должен быть равен одному из следующих значений: "
					+ ДопустимыеЭкологическиеКлассы, "Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Коэффициент Кв.
			ИмяПроверяемойОбласти = "П000020013003";
			Если НЕ ЗначениеЗаполнено(ДанныеЛиста[ИмяПроверяемойОбласти]) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы + " раздела 2 не указан коэффициент Кв",
					"Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Доля налогоплательщика в праве на транспортное средство.
			Если НЕ ЗначениеЗаполнено(ДанныеЛиста.П000020012003_Числ) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы
					+ " раздела 2 не задан числитель в доле налогоплательщика в праве на транспортное средство",
					"Раздел2", "П000020012003_Числ", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если НЕ ЗначениеЗаполнено(ДанныеЛиста.П000020012003_Знам) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы
					+ " раздела 2 не задан знаменатель в доле налогоплательщика в праве на транспортное средство",
					"Раздел2", "П000020012003_Знам", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ДанныеЛиста.П000020012003_Числ) И ЗначениеЗаполнено(ДанныеЛиста.П000020012003_Знам)
			   И ДанныеЛиста.П000020012003_Знам < ДанныеЛиста.П000020012003_Числ Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"На странице " + НомерСтраницы
					+ " раздела 2 числитель больше знаменателя в доле налогоплательщика в праве на транспортное средство",
					"Раздел2", "П000020012003_Числ", НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Код льготы в строке 190.
			ДопустимыеКодыЛьгот = "20200, 20210, 30200";
			ИмяПроверяемойОбласти = "П000020019003_КодЛьготы";
			КодЛьготы = ДанныеЛиста[ИмяПроверяемойОбласти];
			Если ЗначениеЗаполнено(КодЛьготы)
			   И НЕ ЗначениеСодержитсяВСписке(КодЛьготы, ДопустимыеКодыЛьгот) Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"Код налоговой льготы в виде освобождения от налогообложения на странице " + НомерСтраницы
					+ " раздела 2 должен быть равен одному из следующих значений: " + ДопустимыеКодыЛьгот,
					"Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Код льготы в строке 210.
			ДопустимыйКодЛьготы = "20220";
			ИмяПроверяемойОбласти = "П000020021003_КодЛьготы";
			КодЛьготы = ДанныеЛиста[ИмяПроверяемойОбласти];
			Если ЗначениеЗаполнено(КодЛьготы)
			   И КодЛьготы <> ДопустимыйКодЛьготы Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"Код налоговой льготы в виде уменьшения суммы налога на странице " + НомерСтраницы
					+ " раздела 2 должен быть равен " + ДопустимыйКодЛьготы,
					"Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
			
			// Код льготы в строке 230.
			ДопустимыйКодЛьготы = "20230";
			ИмяПроверяемойОбласти = "П000020023003_КодЛьготы";
			КодЛьготы = ДанныеЛиста[ИмяПроверяемойОбласти];
			Если ЗначениеЗаполнено(КодЛьготы)
			   И КодЛьготы <> ДопустимыйКодЛьготы Тогда
				РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
					"Код налоговой льготы в виде снижения налоговой ставки на странице " + НомерСтраницы
					+ " раздела 2 должен быть равен " + ДопустимыйКодЛьготы,
					"Раздел2", ИмяПроверяемойОбласти, НомерСтраницы);
				СтатусПроверки = Ложь;
			КонецЕсли;
...
Процедура ПроверитьЗаполнение_СочетаниеРазделов(СочетаниеРазделов, СтатусПроверки)
	...
	Если СочетанияРаздела2.Количество() = 0 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
			"В декларации отсутствуют заполненные листы раздела 2", "Раздел2", "П000020001001", 1);
		СтатусПроверки = Ложь;
	...
	Для Каждого Сочетание Из СочетаниеРазделовСвернутое Цикл
		...
		Если Сочетание.Счетчик1 <> 0 И Сочетание.Счетчик2 = 0 И ЗначениеЗаполнено(Сочетание.ОКТМО) Тогда
			...
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтаФорма,
				"Для кода по ОКТМО " + НесвязанныеСтроки[0].ОКТМО + " на листе " + Формат(СтраницаПерехода, "ЧН=; ЧГ=0")
				+ " раздела 1 не обнаружены заполненые листы раздела 2",
				"Раздел1", ПозицияПерехода);
			СтатусПроверки = Ложь;
		КонецЕсли;
...
Процедура ДополнитьСохраненныеПоказателиОтчета()
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		Числитель   = Данные.П000020012003_Числ;
		Знаменатель = Данные.П000020012003_Знам;
		...
		Иначе
			Доля = "";
		КонецЕсли;
		Данные.Вставить("П100020012003", Доля);
...
Функция ПроверитьКонтрольныеСоотношенияВОтчете() Экспорт
	...
	ПроверитьКС_1_12__1_17(СтруктураРезультата);
	...
	ПроверитьКС_1_21__1_22(СтруктураРезультата);
...
Процедура ПроверитьКС_1_1(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 021 Раздел 1) должна быть равна сумме всех значений по строкам 250 Раздела 2 по соответствующим кодам ОКТМО'");
	...
	Для Каждого СтраницаР1 Из Раздел1 Цикл
		...
		Для Инд = 1 По 3 Цикл
			...
			Для Каждого СтраницаР2 Из Раздел2 Цикл
				...
				ВставитьЗначениеМногострочногоПоказателя(ДанныеСтраницыР2, Р2Стр250, Инд);
				...
				КонтрольноеЗначение = КонтрольноеЗначение + Р2Стр250.Значение;
				Расшифровка = Расшифровка + Р2Стр250.ЗначениеСтр + " + ";
...
Процедура ПроверитьКС_1_2(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога, исчисленная к уплате в бюджет (строка 030 Раздела 1) должна быть равна значению строки 021 Раздела 1 за минусом суммы значений по строкам 023, 025, 027 Раздела 1 по соответствующим кодам ОКТМО, если значение строки 021 Раздела 1 за минусом суммы значений по строкам 023, 025, 027 Раздела 1 по соответствующим кодам ОКТМО больше или равно нулю'");
...
Процедура ПроверитьКС_1_3(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налога, исчисленная к уменьшению (строка 040 Раздела 1) должна быть равна разнице суммы значений по строкам 023, 025, 027 Раздела 1 и строки 021 Раздела 1 по соответствующим кодам ОКТМО, если строка 021 Раздела 1 за минусом суммы значений по строкам 023, 025, 027 Раздела 1 по соответствующим кодам ОКТМО меньше нуля'");
...
Процедура ПроверитьКС_1_4(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Код налоговой льготы в виде освобождения от налогообложения (строка 190 Раздела 2) должен быть заполнен, если значение строки 200 Раздела 2 больше нуля'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = (Р2Стр200.Значение > 0);
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(Р2Стр190.Значение) Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = "Код льготы заполнен (""" + Р2Стр190.ЗначениеСтр + """)"
			+ " при условии, что " + Р2Стр200.ЗначениеСтр + " > 0";
...
Процедура ПроверитьКС_1_5(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы (строка 200 Раздела 2) должна быть больше нуля, если значение строки 190 Раздела 2 заполнено'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		Если НЕ Р2Стр200.Значение > 0 Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = Р2Стр200.ЗначениеСтр + " > 0"
			+ " при условии, что код льготы заполнен (""" + Р2Стр190.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_1_6(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Код налоговой льготы в виде уменьшения суммы налога (строка 210 Раздела 2) должен быть заполнен, если значение строки 220 Раздела 2 больше нуля'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = (Р2Стр220.Значение > 0);
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		Расшифровка = "Код льготы заполнен (""" + Р2Стр210.ЗначениеСтр + """)"
			+ " при условии, что " + Р2Стр220.ЗначениеСтр + " > 0";
...
Процедура ПроверитьКС_1_7(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы (строка 220 Раздела 2) должна быть больше нуля, если значение строки 210 Раздела 2 заполнено'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		Если НЕ Р2Стр220.Значение > 0 Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = Р2Стр220.ЗначениеСтр + " > 0"
			+ " при условии, что код льготы заполнен (""" + Р2Стр210.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_1_8(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Код налоговой льготы в виде снижения налоговой ставки (строка 230 Раздела 2) должен быть заполнен, если значение строки 240 Раздела 2 больше нуля'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = (Р2Стр240.Значение > 0);
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		Расшифровка = "Код льготы заполнен (""" + Р2Стр230.ЗначениеСтр + """)"
			+ " при условии, что " + Р2Стр240.ЗначениеСтр + " > 0";
...
Процедура ПроверитьКС_1_9(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы (строка 240 Раздела 2) должна быть больше нуля, если значение строки 230 Раздела 2 заполнено'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		Если НЕ Р2Стр240.Значение > 0 Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = Р2Стр240.ЗначениеСтр + " > 0"
			+ " при условии, что код льготы заполнен (""" + Р2Стр230.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_1_10(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Количество полных месяцев использования льготы (строка 170 Раздела 2) должно быть заполнено одновременно с показателями кода налоговой льготы (строка 190 или строка 210 или строка 230 Раздела 2) и суммы налоговой льготы (строка 200 или строка 220 или строка 240 Раздела 2)'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = ЗначениеЗаполнено(Р2Стр170.Значение)
			ИЛИ ЗначениеЗаполнено(Р2Стр190.Значение)
			ИЛИ ЗначениеЗаполнено(Р2Стр200.Значение)
			ИЛИ ЗначениеЗаполнено(Р2Стр210.Значение)
		...
		СоотношениеВыполняется = ЗначениеЗаполнено(Р2Стр170.Значение)
		                       И ((ЗначениеЗаполнено(Р2Стр190.Значение) И ЗначениеЗаполнено(Р2Стр200.Значение))
		                       ИЛИ (ЗначениеЗаполнено(Р2Стр210.Значение) И ЗначениеЗаполнено(Р2Стр220.Значение))
		                       ИЛИ (ЗначениеЗаполнено(Р2Стр230.Значение) И ЗначениеЗаполнено(Р2Стр240.Значение)));
		...
		КонецЕсли;
			...
			Расшифровка = Р2Стр170.ЗначениеСтр + " <> 0 и "
			            + " (код льготы в строке 190 заполнен (""" + Р2Стр190.ЗначениеСтр
			            + """) или код льготы в строке 210 заполнен (""" + Р2Стр210.ЗначениеСтр
			            + """) или код льготы в строке 230 заполнен (""" + Р2Стр230.ЗначениеСтр + """))"
			            + " и (" + Р2Стр200.ЗначениеСтр + " <> 0 или " + Р2Стр220.ЗначениеСтр + " <> 0 или " + Р2Стр240.ЗначениеСтр + " <> 0)";
...
&НаСервере
Процедура ПроверитьКС_1_12__1_17(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы   = НСтр("ru='Проверка раздела 2 (КС 1.12, 1.17)'");
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы (строка 200 Раздела 2) должна быть равна строка 070 Раздела 2 * строка 140 Раздела 2 * строка 120 Раздела 2 * строка 150 Раздела 2 * строка 180 Раздела 2, если заполнен код льготы (строка 190 Раздела 2)'");
	...
	Р2Стр120_Числ = ПоказательПоСтроке("Р2Стр120_Числ");
	Р2Стр120_Знам = ПоказательПоСтроке("Р2Стр120_Знам");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр120_Числ);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр120_Знам);
		...
		ВнестиПоказательВРасшифровку(Р2Стр120_Числ, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр120_Знам, "Раздел2", НомерСтраницыСтр);
		Если ЗначениеЗаполнено(Р2Стр120_Знам.Значение) Тогда
			РасшифровкаР2Стр120 = " * " + Р2Стр120_Числ.ЗначениеСтр + "/" + Р2Стр120_Знам.ЗначениеСтр;
		Иначе
			РасшифровкаР2Стр120 = " * 0";
			Р2Стр120_Числ.Значение = 0;
			Р2Стр120_Знам.Значение = 1;
		КонецЕсли;
		
		Если ЗначениеЗаполнено(Р2Стр150.Значение) Тогда
			ВнестиПоказательВРасшифровку(Р2Стр150,  "Раздел2", НомерСтраницыСтр);
			РасшифровкаР2Стр150 = " * " + Р2Стр150.ЗначениеСтр;
		Иначе
			Р2Стр150.Значение = 1;
			РасшифровкаР2Стр150 = "";
		КонецЕсли;
		...
		КонтрольноеЗначение = Окр(Р2Стр070.Значение * Р2Стр140.Значение * (Р2Стр120_Числ.Значение / Р2Стр120_Знам.Значение)
			* Р2Стр150.Значение * Р2Стр180.Значение, 2);
		...
		Если Р2Стр200.Значение <> КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = Р2Стр200.ЗначениеСтр + " = " + Р2Стр070.ЗначениеСтр + " * " + Р2Стр140.ЗначениеСтр
			+ РасшифровкаР2Стр120 + РасшифровкаР2Стр150 + " * " + Р2Стр180.ЗначениеСтр
			+ " Итог [" + КонтрольноеЗначение + "]"
			+ " при условии, что код льготы заполнен ("""+ Р2Стр190.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_1_13(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Коэффициент Кв (строка 130 Раздела 2) должен быть равен 1, если строка 110 Раздела 2 = 12 (транспортное средство использовалось в течение всего налогового периода)'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = (Р2Стр110.Значение = 12);
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		Если Р2Стр130.Значение <> КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = Р2Стр130.ЗначениеСтр + " = " + КонтрольноеЗначение
			+ " при условии, что " + Р2Стр110.ЗначениеСтр + " = 12";
...
Процедура ПроверитьКС_1_14(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма исчисленного налога (строка 160 Раздела 2) должна быть равна произведению строк 070, 140, 120, 130, 150 Раздела 2'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ЛистЗаполнен
			...
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020006003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020007003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020008003)
			...
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020012003_Числ)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020012003_Знам)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020013003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020014003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020015003)
			ИЛИ ЗначениеСуммыЗаполнено(ДанныеСтраницы.П000020016003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020017003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020018003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020019003_КодЛьготы)
			ИЛИ ЗначениеСуммыЗаполнено(ДанныеСтраницы.П000020020003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020021003_КодЛьготы)
			ИЛИ ЗначениеСуммыЗаполнено(ДанныеСтраницы.П000020022003)
			ИЛИ ЗначениеЗаполнено(ДанныеСтраницы.П000020023003_КодЛьготы)
			ИЛИ ЗначениеСуммыЗаполнено(ДанныеСтраницы.П000020024003)
		...
		КонтрольноеЗначение = Окр(Р2Стр070.Значение * Р2Стр140.Значение * (Р2Стр120_Числ.Значение / Р2Стр120_Знам.Значение)
			* Р2Стр130.Значение * Р2Стр150.Значение, 2);
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(ЭтаФорма, КонтрольноеЗначение);
		...
		Расшифровка = Р2Стр160.ЗначениеСтр + " = " + Р2Стр070.ЗначениеСтр + " * " + Р2Стр140.ЗначениеСтр
			+ РасшифровкаР2Стр120 + " * " + Р2Стр130.ЗначениеСтр + РасшифровкаР2Стр150
			+ " Итог [" + КонтрольноеЗначение + "]";
...
Процедура ПроверитьКС_1_18(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы (строка 220 Раздела 2) должна быть равна произведению значений строк 070, 140, 120, 150, 180, 210а Раздела 2 / 100%, если заполнен код льготы (строка 210 Раздела 2)'");
	...
	Р2Стр180      = ПоказательПоСтроке("Р2Стр180");
	Р2Стр210      = ПоказательПоСтроке("Р2Стр210");
	Р2Стр210а     = ПоказательПоСтроке("Р2Стр210а");
	Р2Стр220      = ПоказательПоСтроке("Р2Стр220");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр180);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр210);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр210а);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр220);
		...
		ВнестиПоказательВРасшифровку(Р2Стр180, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр210а, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр210, "Раздел2", НомерСтраницыСтр);
		
		КонтрольноеЗначение = Р2Стр070.Значение * Р2Стр140.Значение * (Р2Стр120_Числ.Значение / Р2Стр120_Знам.Значение)
			* Р2Стр150.Значение * Р2Стр180.Значение * Р2Стр210а.Значение / 100;
		...
		Расшифровка = Р2Стр220.ЗначениеСтр + " = " + Р2Стр070.ЗначениеСтр + " * " + Р2Стр140.ЗначениеСтр
			+ РасшифровкаР2Стр120 + РасшифровкаР2Стр150 + " * " + Р2Стр180.ЗначениеСтр
			+ " * " + Р2Стр180.ЗначениеСтр + " * " + Р2Стр210а.ЗначениеСтр + " / 100"
			+ " Итог [" + КонтрольноеЗначение + "]"
			+ " при условии, что код льготы заполнен (""" + Р2Стр210.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_1_19(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Сумма налоговой льготы в виде снижения ставки налога (строка 240 Раздела 2) должна быть равна (строка 070 Раздела 2 х строка 140 Раздела 2) - (строка 070 Раздела 2 х строка 230а Раздела 2) х значение доли в строке 120 х значение коэффициента Кп в строке 150 x значение коэффициента Кл в строке 180, если заполнен код льготы (строка 230 Раздела 2)'");
	...
	Р2Стр180      = ПоказательПоСтроке("Р2Стр180");
	Р2Стр230      = ПоказательПоСтроке("Р2Стр230");
	Р2Стр230а     = ПоказательПоСтроке("Р2Стр230а");
	Р2Стр240      = ПоказательПоСтроке("Р2Стр240");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр180);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр230);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр230а);
		ВставитьЗначениеПоказателя(ДанныеСтраницы, Р2Стр240);
		...
		ВнестиПоказательВРасшифровку(Р2Стр070, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр140, "Раздел2", НомерСтраницыСтр);
		ВнестиПоказательВРасшифровку(Р2Стр230а, "Раздел2", НомерСтраницыСтр);
		...
		КонтрольноеЗначение = Окр(Р2Стр070.Значение * (Р2Стр140.Значение - Р2Стр230а.Значение)
			* (Р2Стр120_Числ.Значение / Р2Стр120_Знам.Значение) * Р2Стр150.Значение * Р2Стр180.Значение, 2);
		КонтрольноеЗначение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФорматуДелителя(ЭтаФорма, КонтрольноеЗначение);
		
		Если Р2Стр240.Значение <> КонтрольноеЗначение Тогда
			ЭтоОшибка = Истина;
			ОбщееЧислоОшибок = ОбщееЧислоОшибок + 1;
		Иначе
			ЭтоОшибка = Ложь;
		...
		Расшифровка = Р2Стр240.ЗначениеСтр + " = " + Р2Стр070.ЗначениеСтр
			+ " * (" + Р2Стр140.ЗначениеСтр + " - " + Р2Стр230а.ЗначениеСтр + ")"
			+ РасшифровкаР2Стр120 + РасшифровкаР2Стр150 + " * " + Р2Стр180.ЗначениеСтр
			+ " Итог [" + КонтрольноеЗначение + "]"
			+ " при условии, что код льготы заполнен (""" + Р2Стр230.ЗначениеСтр + """)";
...
Процедура ПроверитьКС_1_20(СтруктураРезультата)
	...
	ОписаниеКС     = НСтр("ru='Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 250 Раздела 2) должна быть равна разнице строк 160 и 200 Раздела 2, если строка 200 Раздела 2 (сумма налоговой льготы) больше нуля и при этом заполнен код льготы по строке 190 Раздела 2'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = (Р2Стр200.Значение > 0 И ЗначениеЗаполнено(Р2Стр190.Значение));
		Если НЕ ПроверятьСоотношение Тогда
			Продолжить;
		КонецЕсли;
		...
		КонтрольноеЗначение = Р2Стр160.Значение - Р2Стр200.Значение;
		...
		Расшифровка = Р2Стр250.ЗначениеСтр + " = " + Р2Стр160.ЗначениеСтр + " - " + Р2Стр200.ЗначениеСтр
			+ " Итог [" + КонтрольноеЗначение + "]"
			+ " при условии, что " + Р2Стр200.ЗначениеСтр + " > 0 и заполнен код льготы (""" + Р2Стр190.ЗначениеСтр + """)";
...
&НаСервере
Процедура ПроверитьКС_1_21__1_22(СтруктураРезультата)
	
	ОбщееЧислоОшибок    = СтруктураРезультата.КоличествоНайденныхОшибок;
	ОбщееЧислоБезОшибок = СтруктураРезультата.КоличествоНайденныхБезОшибок;
	СтруктураОшибок     = СтруктураРезультата.СтруктураОшибок;
	
	ТекстФормулы   = НСтр("ru='Проверка раздела 2 (КС 1.21, 1.22)'");
	ОписаниеКС     = НСтр("ru='Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (строка 250 Раздела 2) должна быть равна строка 160 Раздела 2 - строка 220 Раздела 2 - строка 240 Раздела 2, если строка 220 Раздела 2 (сумма налоговой льготы) больше нуля и при этом заполнен код льготы по строке 210 Раздела 2 и\или строка 240 Раздела 2 (сумма налоговой льготы) больше нуля и при этом заполнен код льготы по строке 230 Раздела 2'");
	...
	Для Каждого Страница Из Раздел2 Цикл
		...
		ПроверятьСоотношение = (Р2Стр220.Значение > 0 И ЗначениеЗаполнено(Р2Стр210.Значение))
			ИЛИ (Р2Стр240.Значение > 0 И ЗначениеЗаполнено(Р2Стр230.Значение));
		...
		КонтрольноеЗначение = Р2Стр160.Значение - Р2Стр220.Значение - Р2Стр240.Значение;
		...
		КонецЕсли;
			...
			Расшифровка = Р2Стр250.ЗначениеСтр + " = " + Р2Стр160.ЗначениеСтр + " - " + Р2Стр220.ЗначениеСтр+ " - " + Р2Стр240.ЗначениеСтр
				+ " Итог [" + КонтрольноеЗначение + "]"
				+ " при условии, что " + Р2Стр220.ЗначениеСтр + " > 0 и код льготы в строке 210 заполнен (""" + Р2Стр210.ЗначениеСтр + """)"
				+ " и/или " + Р2Стр240.ЗначениеСтр + " > 0 и код льготы в строке 230 заполнен (""" + Р2Стр230.ЗначениеСтр + """)";
...
Функция ПоказательПоСтроке(УсловныйКодПоказателя)
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр070" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Налоговая база (строка 070%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр090" Тогда
		Результат.Вставить("Имя", "П000020009003");
		Результат.Вставить("Представление", НСтр("ru='Экологический класс (строка 090%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр100" Тогда
		Результат.Вставить("Имя", "П000020010003");
		Результат.Вставить("Представление", НСтр("ru='Количество полных лет, прошедших с года выпуска транспортного средства (строка 100%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр110" Тогда
		Результат.Вставить("Имя", "П000020011003");
		Результат.Вставить("Представление", НСтр("ru='Количество полных месяцев владения транспортным средством (строка 110%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр120_Числ" Тогда
		Результат.Вставить("Имя", "П000020012003_Числ");
		Результат.Вставить("Представление", НСтр("ru='Доля налогоплательщика в праве на транспортное средство (числитель в строке 120%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр120_Знам" Тогда
		Результат.Вставить("Имя", "П000020012003_Знам");
		Результат.Вставить("Представление", НСтр("ru='Доля налогоплательщика в праве на транспортное средство (знаменатель в строке 120%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр130" Тогда
		Результат.Вставить("Имя", "П000020013003");
		Результат.Вставить("Представление", НСтр("ru='Коэффициент Кв (строка 130%1 раздела 2)'"));
	...
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр150" Тогда
		...
		Результат.Вставить("Представление", НСтр("ru='Коэффициент Кп (строка 150%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр160" Тогда
		Результат.Вставить("Имя", "П000020016003");
		Результат.Вставить("Представление", НСтр("ru='Сумма исчисленного налога (руб.) (строка 160%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр170" Тогда
		Результат.Вставить("Имя", "П000020017003");
		Результат.Вставить("Представление", НСтр("ru='Количество полных месяцев использования льготы (строка 170%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр180" Тогда
		Результат.Вставить("Имя", "П000020018003");
		Результат.Вставить("Представление", НСтр("ru='Коэффициент Кл (строка 180%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр190" Тогда
		Результат.Вставить("Имя", "П000020019003_КодЛьготы");
		Результат.Вставить("Представление", НСтр("ru='Код налоговой льготы в виде освобождения от налогообложения (строка 190%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр200" Тогда
		Результат.Вставить("Имя", "П000020020003");
		Результат.Вставить("Представление", НСтр("ru='Сумма налоговой льготы (руб.) (строка 200%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр210" Тогда
		Результат.Вставить("Имя", "П000020021003_КодЛьготы");
		Результат.Вставить("Представление", НСтр("ru='Код налоговой льготы в виде уменьшения суммы налога (строка 210%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр210а" Тогда
		Результат.Вставить("Имя", "П000020021003_Процент");
		Результат.Вставить("Представление", НСтр("ru='Процент, уменьшающий исчисленную сумму налога (строка 210а%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр220" Тогда
		Результат.Вставить("Имя", "П000020022003");
		Результат.Вставить("Представление", НСтр("ru='Сумма налоговой льготы (руб.) (строка 220%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр230" Тогда
		Результат.Вставить("Имя", "П000020023003_КодЛьготы");
		Результат.Вставить("Представление", НСтр("ru='Код налоговой льготы в виде снижения налоговой ставки (строка 230%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр230а" Тогда
		Результат.Вставить("Имя", "П000020023003_Ставка");
		Результат.Вставить("Представление", НСтр("ru='Пониженная налоговая ставка (строка 230а%1 раздела 2)'"));
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр240" Тогда
		Результат.Вставить("Имя", "П000020024003");
		Результат.Вставить("Представление", НСтр("ru='Сумма налоговой льготы (руб.) (строка 240%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
		
	ИначеЕсли УсловныйКодПоказателя = "Р2Стр250" Тогда
		Результат.Вставить("Имя", "П000020025003");
		Результат.Вставить("Представление", НСтр("ru='Исчисленная сумма налога, подлежащая уплате в бюджет за налоговый период (руб.) (строка 250%1 раздела 2)'"));
		Результат.Вставить("ИзменяемаяРазмерность", Истина);
...
КонецПроцедуры // } RGS VShamin 27.01.2015 14:25:24 - Обновление на 3.0.37.38