...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение №1 к приказу ФНС России от 20.02.2012 № ММВ-7-11/99@ (в ред. приказа ФНС России от 25 апреля 2014 г. № ММВ-7-11/254@).";
	НоваяФорма.РедакцияФормы      = "от 25 апреля 2014 г. № ММВ-7-11/254@.";
	НоваяФорма.ДатаНачалоДействия = '2014-01-01';
	
	// { RGS LFedotova 29.01.2018 14:11:58 - вопрос SLI-0007473
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение №1 к приказу ФНС России от 20.02.2012 № ММВ-7-11/99@ (в ред. приказа ФНС России от 25 апреля 2014 г. № ММВ-7-11/254@).";
	НоваяФорма.РедакцияФормы      = "от 05 декабря 2016 г. № ММВ-7-21/668@";
	НоваяФорма.ДатаНачалоДействия = '2017-01-01';
	НоваяФорма.ДатаКонецДействия  = РегламентированнаяОтчетностьКлиентСервер.ПустоеЗначениеТипа(Тип("Дата"));
	// } RGS LFedotova 29.01.2018 14:12:16 - вопрос SLI-0007473
