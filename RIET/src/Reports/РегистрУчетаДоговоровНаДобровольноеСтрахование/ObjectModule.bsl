...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок, ВысотаЗаголовка, ТолькоЗаголовок = Ложь) Экспорт
	...
	|	НалоговыйДвиженияССубконто.СубконтоДт1 КАК РБП,
	|	НалоговыйДвиженияССубконто.СубконтоДт1.ВидРБП КАК ВидРБП,
	|	НалоговыйДвиженияССубконто.СубконтоДт2 КАК Работник,
	|	РаботникиОрганизацииСрезПоследних.ТабельныйНомер КАК ТабельныйНомер,
	|	НалоговыйДвиженияССубконто.СубконтоДт1.ДатаНачалаСписания КАК ДатаНачала,
	|	НалоговыйДвиженияССубконто.СубконтоДт1.ДатаОкончанияСписания КАК ДатаЗавершения,
	...
	|           И СубконтоДт1.ВидРБП В(&ВидРБП)) КАК НалоговыйДвиженияССубконто
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РаботникиОрганизаций.СрезПоследних(&КонецПериода, ) КАК РаботникиОрганизацииСрезПоследних
	|		ПО НалоговыйДвиженияССубконто.СубконтоДт2 = РаботникиОрганизацииСрезПоследних.Физлицо
	|
	|УПОРЯДОЧИТЬ ПО
	|	ДатаОперации";
	...
	Пока Результат.Следующий() Цикл
		...
		Если (НЕ ОбщегоНазначения.ЗначениеНеЗаполнено(Результат.ДатаНачала)) 
		   И (НЕ ОбщегоНазначения.ЗначениеНеЗаполнено(Результат.ДатаЗавершения))
