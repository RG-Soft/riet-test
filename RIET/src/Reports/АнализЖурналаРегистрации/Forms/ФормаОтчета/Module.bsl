...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если Не НаименованиеТекущегоВарианта = ВернутьСтр("ru = 'Продолжительность работы регламентных заданий'") Тогда
	...
	Если ТипРасшифровки = "РасшифровкаРегламентногоЗадания" Тогда
		...
		ВариантРасшифровки.Добавить("СведенияОРегламентномЗадании", ВернутьСтр("ru = 'Сведения о регламентном задании'"));
		ВариантРасшифровки.Добавить("ОткрытьЖурналРегистрации", ВернутьСтр("ru = 'Перейти к журналу регистрации'"));
...
Процедура РезультатОбработкаРасшифровкиЗавершение(ВыбранныйВариант, Расшифровка) Экспорт
	...
	Если Действие = "СведенияОРегламентномЗадании" Тогда
		...
		Для Каждого ТочкаДиаграммыГанта Из СписокТочек Цикл
			...
			Если ТочкаДиаграммыГанта.Значение = ВернутьСтр("ru = 'Фоновые задания'") Тогда
				Продолжить;
			КонецЕсли;
...
Функция СформироватьОтчетСервер(ПараметрыОтчета)
	...
	Иначе
		РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыОтчета, 
			ВернутьСтр("ru = 'Выполнение отчета: Анализ журнала регистрации'"));
