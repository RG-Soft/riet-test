...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураОтбора = УправлениеКонтактнойИнформациейКлассификаторы.ВернутьСтрокуАдресногоКлассификатораПоАдреснымЭлементам(
...
Процедура ОсуществитьВыбор()
	...
	Результат.Вставить("КодРегиона", ТекущиеДанные.КодРегионаВКоде);
	Результат.Вставить("Код", ТекущиеДанные.Код);
		
	Результат.Вставить("Уровень", Уровень);
	Результат.Вставить("СтруктураАдреса", УправлениеКонтактнойИнформациейКлассификаторы.ПолучитьСтруктуруАдресаНаСервере(Результат.Код));
...
Функция ПолучитьОграниченияПоУровню(Уровень)
	...
	Ограничения = УправлениеКонтактнойИнформациейКлассификаторы.ВернутьСтруктуруОграниченийПоРодителю(
...
Процедура УстановитьЗаголовокФормы(Уровень)
	Если Уровень = 1 Тогда
		Заголовок = ВернутьСтр("ru = 'Выберите регион или область'");
	ИначеЕсли Уровень = 2 Тогда
		Заголовок = ВернутьСтр("ru = 'Выберите район'");
	ИначеЕсли Уровень = 3 Тогда
		Заголовок = ВернутьСтр("ru = 'Выберите город'");
	ИначеЕсли Уровень = 4 Тогда
		Заголовок = ВернутьСтр("ru = 'Выберите населенный пункт'");
	ИначеЕсли Уровень = 5 Тогда
		Заголовок = ВернутьСтр("ru = 'Выберите улицу'");
	КонецЕсли;
КонецПроцедуры
...
Функция ЗагружатьРегион(Регион)
	...
	АдресноеСокращение = "";
	НаименованиеРегиона = УправлениеКонтактнойИнформацией.ПолучитьИмяИАдресноеСокращение(Регион, АдресноеСокращение);
