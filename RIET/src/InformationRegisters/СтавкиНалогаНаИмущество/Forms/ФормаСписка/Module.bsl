...
Процедура СписокПередУдалением(Элемент, Отказ)
	...
	//НастройкиУчетаФормаСпискаКлиент.СписокПередУдалением(ЭтотОбъект, Элемент, Отказ, "Запись_СтавкиНалогаНаИмущество");
...
Процедура СписокПослеУдаления(Элемент)
	...
	//НастройкиУчетаФормаСпискаКлиент.СписокПослеУдаления(ЭтотОбъект, "Запись_СтавкиНалогаНаИмущество");
