...
Процедура ОбновитьГруппировкиПользователей(Параметры = Неопределено, ЕстьИзменения = Неопределено) Экспорт
	...
	Иначе
		ВызватьИсключение
			ВернутьСтр("ru = 'Ошибка в процедуре ОбновитьГруппировкиПользователей
...
Процедура ОбновитьГруппыЗначенияДоступа(ЗначениеДоступа, ЕстьИзменения)
	...
	ЗаголовокОшибки =
		ВернутьСтр("ru = 'Ошибка при обновлении групп значений доступа.
		           |
		           |'");
...
Процедура ОбновитьГруппыИсполнителей(ГруппыИсполнителей = Неопределено,
	...
	Иначе
		ВызватьИсключение
			ВернутьСтр("ru = 'Ошибка в процедуре ОбновитьГруппыИсполнителей
