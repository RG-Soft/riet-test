...
Процедура КадастроваяСтоимостьОпределенаПоПлощадиПриИзменении(Элемент)
	...
	Иначе
		СохранитьЗначениеРеквизитаФормы("ДоляПлощадиЧислитель",   ЭтаФорма, Запись, СтруктураСохраняемыхРеквизитов);
		СохранитьЗначениеРеквизитаФормы("ДоляПлощадиЗнаменатель", ЭтаФорма, Запись, СтруктураСохраняемыхРеквизитов);
	КонецЕсли;
...
Процедура ОбщаяСобственностьПриИзменении(Элемент)
	...
	Иначе
		СохранитьЗначениеРеквизитаФормы("ДоляВПравеОбщейСобственностиЧислитель",   ЭтаФорма, Запись, СтруктураСохраняемыхРеквизитов);
		СохранитьЗначениеРеквизитаФормы("ДоляВПравеОбщейСобственностиЗнаменатель", ЭтаФорма, Запись, СтруктураСохраняемыхРеквизитов);
	КонецЕсли;
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.КодВидаИмущества.РасширеннаяПодсказка.Заголовок = Форма.КодыВидовИмущества.Получить(Объект.КодВидаИмущества);
