...
//  - СхемаКомпановкиДанных, соответствующая (одноименная) значению перечисления
// 	Если схема не найдена, возвращается пустая схема компановки данных
//
...
Функция РазделИсточникаДанных(ИсточникДанных, Характеристика) Экспорт
	...
	Если ИсточникДанных = ФинансовоеСостояние 
		...
		ИначеЕсли Характеристика = "КапиталИРезервы" 
			...
			Или Характеристика = "Капитал" Тогда
...
Процедура ДобавитьОтборПоАдресамКонтрагентов(Показатели) Экспорт
	...
	Для Каждого ОписаниеОбъектаНаблюдения Из ОбъектыСАдресами Цикл
		...
		Контрагенты = РезультатЗапроса.ВыгрузитьКолонку("Контрагент");
