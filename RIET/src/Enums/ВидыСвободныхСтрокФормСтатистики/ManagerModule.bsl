...
// Возвращает имя области макета списков, в котором содежатся данные
...
Функция КраткоеПредставлениеКлассификатора(Значение) Экспорт
	...
	Если Значение = ВидыДеятельности Тогда
		Возврат ВернутьСтр("ru = 'ОКВЭД'");
	ИначеЕсли Значение = ВидыПродукцииОпт Или Значение = ВидыПродукцииПроизводство Или  Значение = ВидыПродукцииРозница Тогда
		Возврат ВернутьСтр("ru = 'ОКПД'");
	ИначеЕсли Значение = УслугиНаселению Тогда
		Возврат ВернутьСтр("ru = 'ОКУН'");
	Иначе
		Возврат ВернутьСтр("");
	КонецЕсли;
