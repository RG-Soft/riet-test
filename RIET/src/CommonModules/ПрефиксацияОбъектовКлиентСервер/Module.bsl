...
//  УдалитьПрефиксОрганизации - Булево (необязательный) - признак удаления префикса организации; по умолчанию равен
//                              Ложь;
//  УдалитьПрефиксИнформационнойБазы - Булево (необязательный) - признак удаления префикса информационной базы; по
//                                     умолчанию равен Ложь;
//
// Примеры:
