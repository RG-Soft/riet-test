...
Функция ФильтрДиалоговВыбораИСохранения() Экспорт
	...
	Фильтр = ВернутьСтр("ru = 'Внешние отчеты и обработки (*.%1, *.%2)|*.%1;*.%2|Внешние отчеты (*.%1)|*.%1|Внешние обработки (*.%2)|*.%2'");
...
Функция НаименованиеПодсистемы(ДляПользователя) Экспорт
	...
	Возврат ВернутьСтр("ru = 'Дополнительные отчеты и обработки'", КодЯзыка);
КонецФункции
