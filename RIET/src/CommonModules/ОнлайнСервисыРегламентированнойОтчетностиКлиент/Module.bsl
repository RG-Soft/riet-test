...
Процедура ПродолжитьПослеЗапросаПодтвержденияДоступаВИнтернет(Знач ОписаниеОповещенияДляПродолжения) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПродолжитьПослеЗапросаПодтвержденияДоступаВИнтернетЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПродолжитьПослеЗапросаПодтвержденияДоступаВИнтернетЗавершение(РезультатПоказа, ДополнительныеПараметры) Экспорт
	...
	Если РезультатПоказа = Ложь Тогда
		...
		ОбщегоНазначенияВызовСервера.ХранилищеОбщихНастроекСохранить("ОнлайнСервисыРО_ДоступЗапрещенВерсияРелиза", , ОнлайнСервисыРегламентированнойОтчетности.ВерсияПрограммы());
	КонецЕсли;
...
Процедура ЗапроситьПараметрыПрокси(Знач ОписаниеОповещенияДляПродолжения = Неопределено) Экспорт
	...
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("ОписаниеОповещенияДляПродолжения", ОписаниеОповещенияДляПродолжения);
	ОписаниеОповещения = Новый ОписаниеОповещения("ЗапроситьПараметрыПроксиЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура АктуализироватьСлужебнуюИнформациюМеханизмаОнлайнСервисовРОПриНеобходимости(УникальныйИдентификаторФормы) Экспорт
	...
	НастройкиМеханизмаОнлайнСервисов = ОнлайнСервисыРегламентированнойОтчетности.ПолучитьНастройкиМеханизмаОнлайнСервисовРО();
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("АктуализироватьСлужебнуюИнформациюМеханизмаОнлайнСервисовРОПриНеобходимостиЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
	...
	Если РазрешитьДоступВИнтернет = Неопределено ИЛИ РазрешитьДоступВИнтернет = Ложь Тогда
		...
		Если ВерсияРелизаНаКоторомДоступВИнтернетЗапрещен <> ОнлайнСервисыРегламентированнойОтчетности.ВерсияПрограммы() Тогда
...
Процедура АктуализироватьСлужебнуюИнформациюМеханизмаОнлайнСервисовРОПриНеобходимостиЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если НЕ ОнлайнСервисыРегламентированнойОтчетности.ЕстьПравоИзмененияРегистраРесурсыМеханизмаОнлайнСервисовРО() Тогда
		Возврат;
	КонецЕсли;
	
	ОнлайнСервисыРегламентированнойОтчетности.ЗапуститьФоновоеЗаданиеАктуализироватьСлужебнуюИнформациюМеханизмаОнлайнСервисовРО(УникальныйИдентификаторФормы);
...
Процедура ПроверкаОнлайнБлокировки(ВыполняемоеОповещение, Объект, БлокируемаяФункция = "И") Экспорт
	...
	Если НЕ ОнлайнСервисыРегламентированнойОтчетности.МеханизмОнлайнСервисовВключен() Тогда
		ВыполнитьОбработкуОповещения(ВыполняемоеОповещение, Истина);
		Возврат;
	КонецЕсли;
	
	ВерсияОтчета = ПолучитьКраткуюВерсиюОтчета(Объект);
	ВерсияВыпуска = ВРЕГ(?(ЗначениеЗаполнено(ВерсияОтчета), ВерсияОтчета, ОнлайнСервисыРегламентированнойОтчетности.ИнформацияОПрограмме().ВерсияКонфигурации));
	...
	СведенияПоБлокировке = ОнлайнСервисыРегламентированнойОтчетности.ПроверкаОнлайнБлокировкиСервер(ВерсияВыпуска, ИДОтчета, ИДФормы, БлокируемаяФункция);
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПроверкаОнлайнБлокировкиЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПроверкаФормыПоПериодуПрименения(ВыполняемоеОповещение, Форма) Экспорт
	...
	СведенияПоБлокировке = ОнлайнСервисыРегламентированнойОтчетности.ПроверкаФормыПоПериодуПримененияСервер(
	...
	ДополнительныеПараметры = Новый Структура();
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПроверкаФормыПоПериодуПримененияЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПроверкаФорматаПоПериодуПрименения(ВыполняемоеОповещение, Форма) Экспорт
	...
	СведенияПоБлокировке = ОнлайнСервисыРегламентированнойОтчетности.ПроверкаФорматаПоПериодуПримененияСервер(
		СтруктураРеквизитовФормы, ДатаКонцаПериодаОтчета, ИмяФормы, ИДОтчета);
	...
	ДополнительныеПараметры = Новый Структура();
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПроверкаФорматаПоПериодуПримененияЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПоказатьУведомлениеОБлокировке(ВыполняемоеОповещение, Объект, СвойстваБлокировки)
	...
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПоказатьУведомлениеОБлокировкеЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПоказатьУведомлениеОБлокировкеУтвержденнойФормы(ВыполняемоеОповещение, Объект, СведенияПоБлокировке) Экспорт
	...
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПоказатьУведомлениеОБлокировкеУтвержденнойФормыЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПоказатьУведомлениеОБлокировкеУтвержденногоФормата(ВыполняемоеОповещение, Объект, СведенияПоБлокировке) Экспорт
	...
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПоказатьУведомлениеОБлокировкеУтвержденногоФорматаЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПередОткрытиемФормыРегламентированногоОтчета(ВыполняемоеОповещение, Форма, Отказ) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПередОткрытиемФормыРегламентированногоОтчетаПродолжение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПередОткрытиемФормыРегламентированногоОтчетаПродолжение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПередОткрытиемФормыРегламентированногоОтчетаЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, НовыеДополнительныеПараметры);
...
Процедура ПередПечатьюРегламентированногоОтчета(ВыполняемоеОповещение, Форма, Отказ) Экспорт
	...
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ДополнительныеПараметры.Вставить("Отказ", Отказ);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПередПечатьюРегламентированногоОтчетаЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПередПечатьюМЧБРегламентированногоОтчета(ВыполняемоеОповещение, Форма, Отказ) Экспорт
	...
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ДополнительныеПараметры.Вставить("Отказ", Отказ);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПередПечатьюМЧБРегламентированногоОтчетаЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПередВыгрузкойРегламентированногоОтчета(ВыполняемоеОповещение, Форма, Отказ) Экспорт
	...
	ДополнительныеПараметры.Вставить("Форма", Форма);
	ДополнительныеПараметры.Вставить("Отказ", Отказ);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПередВыгрузкойРегламентированногоОтчетаПродолжение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПередВыгрузкойРегламентированногоОтчетаПродолжение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПередВыгрузкойРегламентированногоОтчетаЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, НовыеДополнительныеПараметры);
...
Процедура ПередЗаполнениемРегламентированногоОтчета(ВыполняемоеОповещение, Форма, Отказ) Экспорт
	...
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ДополнительныеПараметры.Вставить("Отказ", Отказ);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПередЗаполнениемРегламентированногоОтчетаЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Процедура ПередОтправкойРегламентированногоОтчета(ВыполняемоеОповещение, Форма, Отказ) Экспорт
	...
	ДополнительныеПараметры.Вставить("ВыполняемоеОповещение", ВыполняемоеОповещение);
	ДополнительныеПараметры.Вставить("Отказ", Отказ);
	ОписаниеОповещения = Новый ОписаниеОповещения("ПередОтправкойРегламентированногоОтчетаЗавершение", ОнлайнСервисыРегламентированнойОтчетностиКлиент, ДополнительныеПараметры);
...
Функция ПредставлениеОбъектаБлокировки(Объект)
	...
	Если ТипЗнч(Объект) = Тип("УправляемаяФорма") Тогда
		...
		Если РегламентированнаяОтчетностьКлиентСервер.СвойствоОпределено(СтруктураРеквизитовФормы, "мВыбраннаяФорма") Тогда
			...
			ПредставлениеФормы = ОнлайнСервисыРегламентированнойОтчетности.ПредставлениеФормы(ИДОтчета, ВыбраннаяФорма);
...
Процедура ПопытатьсяПерейтиПоНавигационнойСсылке(Ссылка) Экспорт
	...
	ИспользоватьКомандуЗапуститьПриложение = Ложь;
	
	#Если ВебКлиент Тогда		
		ИнформацияОСистеме = Новый СистемнаяИнформация;			
		ИспользуетсяБраузерIE = СтрЧислоВхождений(ВРег(ИнформацияОСистеме.ИнформацияПрограммыПросмотра), "TRIDENT") > 0;
		Если ИспользуетсяБраузерIE И ПодключитьРасширениеРаботыСФайлами() Тогда
			ИспользоватьКомандуЗапуститьПриложение = Истина;
		КонецЕсли;				
	#КонецЕсли 	
	
	Если ИспользоватьКомандуЗапуститьПриложение Тогда 
		ЗапуститьПриложение(Ссылка);
	Иначе
		Попытка
			ПерейтиПоНавигационнойСсылке(Ссылка);
		Исключение
			ПоказатьПредупреждение(, ВернутьСтр("ru = 'Не удалось перейти по указанной ссылке!'"));
		КонецПопытки; 
