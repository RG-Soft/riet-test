...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Прототип.Представление = ВернутьСтр("ru = 'Оптимизировать программу'");
	Прототип.Подсказка     = ВернутьСтр("ru = 'Ускорить проведение документов и формирование отчетов.
...
Функция РасписаниеЗаданияПоУмолчанию(Знач Имя)
	...
	Иначе
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ВернутьСтр("ru = 'Неизвестное имя задания %1'"), Имя);
