...
//               //	Команда.Заголовок = ВернутьСтр("ru = 'Моя команда...'");
//               //	
...
Функция ПредставлениеЭлементаУсловногоОформления(ЭлементКД) Экспорт
	...
	Если ПредставлениеОформления = "" Тогда
		ПредставлениеОформления = ВернутьСтр("ru = 'Не оформлять'");
	КонецЕсли;
	
	ПредставлениеПолей = Строка(ЭлементКД.Поля);
	Если ПредставлениеПолей = "" Тогда
		ПредставлениеПолей = ВернутьСтр("ru = 'Все поля'");
	Иначе
		ПредставлениеПолей = ВернутьСтр("ru = 'Поля:'") + " " + ПредставлениеПолей;
	КонецЕсли;
	...
	Иначе
		Разделитель = "; ";
		ПредставлениеОтбора = ВернутьСтр("ru = 'Условие:'") + " " + ПредставлениеОтбора;
	КонецЕсли;
...
Функция ПредставлениеЦвета(Цвет)
	...
	ИначеЕсли Цвет.Вид = ВидЦвета.Абсолютный Тогда
		...
		Если Представление = "0, 0, 0" Тогда
			Представление = ВернутьСтр("ru = 'Черный'");
		ИначеЕсли Представление = "255, 255, 255" Тогда
			Представление = ВернутьСтр("ru = 'Белый'");
		КонецЕсли;
	ИначеЕсли Цвет.Вид = ВидЦвета.АвтоЦвет Тогда
		Представление = ВернутьСтр("ru = 'Авто'");
	Иначе
		Представление = "";
	КонецЕсли;
	Возврат Представление;
...
Функция ПараметрыКопирования(ТипЭлемента, Коллекция)
	...
	Иначе
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			ВернутьСтр("ru = 'Копирование элементов ""%1"" не поддерживается'"),
			ТипЭлемента);
