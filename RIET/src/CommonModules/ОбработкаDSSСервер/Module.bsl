...
Функция НайтиAU(СтрокаТЧ, Локация, мЮниты, PeriodLawson) 	
	...
	Если AU = Неопределено Тогда // AU с соответствующими сегментами не найден в кэше
		...
		// { RGS LFedotova 18.04.2018 15:11:35 - вопрос SLI-0007537
		Сообщить("AU " + Код + " с сегментом " + Segment + ", субсегментом " + SubSegment + ", субсубсегментом " + SsubSegment + " не найдено. 
		|Нужно обновить AU в базе RIET и выполнить обмен с базой Logelco." );
		...
		// } RGS LFedotova 18.04.2018 15:11:44 - вопрос SLI-0007537 
	КонецЕсли;
