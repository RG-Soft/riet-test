...
Функция Словарь() Экспорт
	...
	Представление = ВернутьСтр("ru = 'Получение данных из сети Интернет'");
	Описание = ВернутьСтр("ru = 'Дополнительному отчету или обработке будет разрешено получать данные из сети Интернет'");
	
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "Host", ВернутьСтр("ru = 'с сервера %1'"), ВернутьСтр("ru = 'с любого сервера'"));
	ДобавитьПараметр(Параметры, "Protocol", ВернутьСтр("ru = 'по протоколу %1'"), ВернутьСтр("ru = 'по любому протоколу'"));
	ДобавитьПараметр(Параметры, "Port", ВернутьСтр("ru = 'через порт %1'"), ВернутьСтр("ru = 'через любой порт'"));
	...
	Представление = ВернутьСтр("ru = 'Передача данных в сеть Интернет'");
	Описание = ВернутьСтр("ru = 'Дополнительному отчету или обработке будет разрешено отправлять данные в сеть Интернет'");
	Последствия = ВернутьСтр("ru = 'Внимание! Отправка данных потенциально может использоваться дополнительным
	...
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "Host", ВернутьСтр("ru = 'на сервер %1'"), ВернутьСтр("ru = 'на любой сервера'"));
	ДобавитьПараметр(Параметры, "Protocol", ВернутьСтр("ru = 'по протоколу %1'"), ВернутьСтр("ru = 'по любому протоколу'"));
	ДобавитьПараметр(Параметры, "Port", ВернутьСтр("ru = 'через порт %1'"), ВернутьСтр("ru = 'через любой порт'"));
	...
	Представление = ВернутьСтр("ru = 'Обращение к веб-сервисам в сети Интернет'");
	Описание = ВернутьСтр("ru = 'Дополнительному отчету или обработке будет разрешено обращаться к веб-сервисам, расположенным в сети Интернет (при этом возможно как получение дополнительным отчетом или обработкой информации из сети Интернет, так и передача.'");
	Последствия = ВернутьСтр("ru = 'Внимание! Обращение к веб-сервисам потенциально может использоваться дополнительным
                        |отчетом или обработкой для совершения действий, не предполагаемых администратором
                        |информационной базы.
                        |
                        |Используйте данный дополнительный отчет или обработку только в том случае, если Вы доверяете
	...
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "WsdlDestination", ВернутьСтр("ru = 'по адресу %1'"), ВернутьСтр("ru = 'по любому адресу'"));
	...
	Представление = ВернутьСтр("ru = 'Создание COM-объекта'");
	Описание = ВернутьСтр("ru = 'Дополнительному отчету или обработке будет разрешено использовать механизмы внешнего программного обеспечения с помощью COM-соединения'");
	Последствия = ВернутьСтр("ru = 'Внимание! Использование средств стороннего программного обеспечения может использоваться
	...
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "ProgId", ВернутьСтр("ru = 'с программным идентификатором %1'"), ВернутьСтр("ru = 'с любым программным идентификатором'"));
	...
	Представление = ВернутьСтр("ru = 'Создание объекта внешней компоненту'");
	Описание = ВернутьСтр("ru = 'Дополнительному отчету или обработке будет разрешено использовать механизмы внешнего программного обеспечения с помощью создания объекта внешней компоненты, поставляемой в макете конфигурации'");
	Последствия = ВернутьСтр("ru = 'Внимание! Использование средств стороннего программного обеспечения может использоваться
                        |дополнительным отчетом или обработкой для совершения действий, не предполагаемых администратором
                        |информационной базы, а также для несанкционированного обхода ограничений, накладываемых на дополнительную обработку
                        |в безопасном режиме.
	...
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "TemplateName", ВернутьСтр("ru = 'из макета %1'"), ВернутьСтр("ru = 'из любого макета'"));
	...
	Представление = ВернутьСтр("ru = 'Получение файлов из внешнего объекта'");
	Описание = ВернутьСтр("ru = 'Дополнительному отчету или обработке будет разрешено получать файлы из внешнего программного обеспечения (например, с помощью COM-соединения или внешней компоненты)'");
	...
	Представление = ВернутьСтр("ru = 'Передача файлов во внешний объект'");
	Описание = ВернутьСтр("ru = 'Дополнительному отчету или обработке будет разрешено передавать файлы во внешнее программное обеспечение (например, с помощью COM-соединения или внешней компоненты)'");
	...
	Представление = ВернутьСтр("ru = 'Проведение документов'");
	Описание = ВернутьСтр("ru = 'Дополнительному отчету или обработке будет разрешено изменять состояние проведенности документов'");
	
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "DocumentType", ВернутьСтр("ru = 'документы с типом %1'"), ВернутьСтр("ru = 'любые документы'"));
	ДобавитьПараметр(Параметры, "Action", ВернутьСтр("ru = 'разрешенное действие: %1'"), ВернутьСтр("ru = 'любое изменение состояния проведения'"));
