...
Функция ПолучитьФайлИзИнтернет(Знач URL, Знач НастройкаСохранения, Знач НастройкаСоединения = Неопределено,
	...
	Если ИспользуетсяFTPПротокол Тогда
		...
		Исключение
			...
			СообщениеОбОшибке = ВернутьСтр("ru = 'Не удалось установить FTP-соединение с сервером %1:'") + Символы.ПС + "%2";
	...
	Иначе
		...
		Исключение
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			СообщениеОбОшибке = ВернутьСтр("ru = 'Не удалось установить HTTP-соединение с сервером %1:
			|%2'");
	...
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		СообщениеОбОшибке = ВернутьСтр("ru = 'Не удалось получить файл с сервера %1:'") + Символы.ПС + "%2";
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат ВернутьСтр("ru = 'Получение файлов из Интернета'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
