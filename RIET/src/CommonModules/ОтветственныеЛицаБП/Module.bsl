...
Функция ПустаяСтруктураОтветственныхЛиц() Экспорт
	...
	ПустаяДолжность	 = Справочники.ДолжностиОрганизаций.ПустаяСсылка();
...
Процедура УстановитьОтветственныхЛиц(ДокументОбъект) Экспорт
	...
	ДанныеЗаполнения	= Новый Структура("Руководитель, ГлавныйБухгалтер,
		|ЗаРуководителяНаОсновании, ЗаГлавногоБухгалтераНаОсновании");
...
Процедура УстановитьПодписиПоУмолчанию(ДокументСсылка, ПараметрыЗаписи) Экспорт
	...
	УчитыватьПодразделение = ПолучитьФункциональнуюОпцию("ВестиУчетПоПодразделениям");
	УполномоченныеЛица = РегистрыСведений.ОтветственныеЛицаОрганизаций.СоздатьНаборЗаписей().ВыгрузитьКолонки();
	...
	СтруктураПараметровБлокировки.Вставить("ИмяТаблицы",	"УполномоченныеЛицаОрганизаций");
	СтруктураПараметровБлокировки.Вставить("ИсточникДанных", УполномоченныеЛица);

	ОписаниеИсточника = Новый Соответствие;
	ОписаниеИсточника.Вставить("Организация",				"Организация");
	ОписаниеИсточника.Вставить("ПодразделениеОрганизации",	"ПодразделениеОрганизации");
	ОписаниеИсточника.Вставить("Пользователь",				"Пользователь");

	ОбщегоНазначенияБПВызовСервера.УстановитьУправляемуюБлокировку(СтруктураПараметровБлокировки, , ОписаниеИсточника);
...
Функция ПолучитьСоздатьДолжность(НазваниеДолжности) Экспорт
	...
	Иначе
		ДолжностьРуководителя = Справочники.ДолжностиОрганизаций.СоздатьЭлемент();
