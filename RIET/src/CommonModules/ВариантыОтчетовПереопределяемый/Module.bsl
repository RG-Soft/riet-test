...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	// {начало добавления RG-Soft
	// Reports 
	Разделы.Добавить(Метаданные.Подсистемы.ImportExportReports.Подсистемы.ImportLogisticsReports,   "Import logistics reports");
	Разделы.Добавить(Метаданные.Подсистемы.ImportExportReports.Подсистемы.ExportLogisticsReports,   "Export logistics reports");
	Разделы.Добавить(Метаданные.Подсистемы.ImportExportReports.Подсистемы.CustomsAccountingReports, "Customs accounting reports");
	Разделы.Добавить(Метаданные.Подсистемы.ImportExportReports.Подсистемы.LocalDistributionReports, "Local distribution reports");
	Разделы.Добавить(Метаданные.Подсистемы.ImportExportReports.Подсистемы.ServicesReports,   		"Services reports");
	
	// Dashboards 
	Разделы.Добавить(Метаданные.Подсистемы.Dashboards.Подсистемы.InternationalDashboards,  		"International dashboards");
	Разделы.Добавить(Метаданные.Подсистемы.Dashboards.Подсистемы.DomesticDashboards,  			"Domestic dashboards");
	Разделы.Добавить(Метаданные.Подсистемы.Dashboards.Подсистемы.Budgets,   					"Budgets dashboards");
	
	// Администрирование
	Разделы.Добавить(Метаданные.Подсистемы.Администрирование,   		"Администрирование");
...
//
// Например:
//	Настройки.Поиск.ПодсказкаВвода = ВернутьСтр("ru = 'Например, себестоимость'");
