...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	// { RGS AFokin 08.08.2016 15:13:23 - ERM
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.rgsОбменДокументамиLogelcoERM);
	// } RGS AFokin 08.08.2016 15:13:29 - ERM	
	// Богушевич обмен с биллингом
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.rgsСинхронизацияДанныхЧерезФорматБиллинга);
	// конец
КонецПроцедуры
