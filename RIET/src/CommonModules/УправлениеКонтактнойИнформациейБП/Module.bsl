	...
	Для Каждого ОбъектКонтактнойИнформации Из ТЗКонтактнаяИнформация Цикл
		...
		Иначе
			Если СокрЛП(ОбъектКонтактнойИнформации.ИмяРеквизита) = "" Тогда
				ОбъектКонтактнойИнформации.ИмяРеквизита = "КонтактнаяИнформацияПоле" + ТЗКонтактнаяИнформация.Индекс(ОбъектКонтактнойИнформации);
			...
			Исключение
				...
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
					ВернутьСтр("ru = 'Ошибка анализа контактной информации, возможно неверный формат значений полей.'"), ,
...
Функция Действие(Форма, Тип, ИмяРеквизита, ГруппаДействий, КоличествоАдресов, ЕстьКомментарий = Ложь)
	...
	Если (Тип = Перечисления.ТипыКонтактнойИнформации.ВебСтраница
		...
		Если Тип = Перечисления.ТипыКонтактнойИнформации.Адрес Тогда
			...
			Команда.Подсказка = ВернутьСтр("ru = 'Заполнить адрес'");
