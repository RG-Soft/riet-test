	...
	Если ПустаяСтрока(СтрокаЗаголовка) Тогда
		...
		Если ЗначениеЗаполнено(Свойство) Тогда
			Если НЕ Параметры.РежимВыбора Тогда
				СтрокаЗаголовка = ВернутьСтр("ru = 'Значения свойства %1'");
			ИначеЕсли ВыборГрупп Тогда
				СтрокаЗаголовка = ВернутьСтр("ru = 'Выберите группу значений свойства %1'");
			Иначе
				СтрокаЗаголовка = ВернутьСтр("ru = 'Выберите значение свойства %1'");
			КонецЕсли;
		...
		ИначеЕсли Параметры.РежимВыбора Тогда
			...
			Если ВыборГрупп Тогда
				СтрокаЗаголовка = ВернутьСтр("ru = 'Выберите группу значений свойства'");
			Иначе
				СтрокаЗаголовка = ВернутьСтр("ru = 'Выберите значение свойства'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
