...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Заголовок = ВернутьСтр("ru = 'Подбор профилей групп доступа'");
		Иначе
			Заголовок = ВернутьСтр("ru = 'Выбор профиля групп доступа'");
		КонецЕсли;
	КонецЕсли;
...
Процедура ВидПользователейНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПользователиСлужебныйКлиент.ВыбратьНазначение(ЭтотОбъект,
		ВернутьСтр("ru = 'Выбор назначения профилей'"), Истина, Истина, ОписаниеОповещения);
