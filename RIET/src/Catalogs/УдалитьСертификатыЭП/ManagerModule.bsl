...
// Создаёт новые элементы справочника СертификатыКлючейЭлектроннойПодписиИШифрования
...
Функция ПеренестиЭлементВСертификатыКлючейЭлектроннойПодписиИШифрования(СтарыйСертификат, Программа)
	...
	Если ЗначениеЗаполнено(СтарыйСертификатОбъект.ПрограммаБанка) Тогда
		...
		НоваяЗапись.ПрограммаБанка = СтарыйСертификатОбъект.ПрограммаБанка;
		НоваяЗапись.СертификатЭП = СертификатОбъект.Ссылка;
