...
Функция ПоставляемыеНастройкиПрограмм() Экспорт
	...
	Настройка.Представление       = ВернутьСтр("ru = 'ViPNet CSP'");
	...
	// КриптоПро CSP
	Настройка = Настройки.Добавить();
	Настройка.Представление       = ВернутьСтр("ru = 'КриптоПро CSP'");
	...
	// ЛИССИ CSP
	Настройка = Настройки.Добавить();
	Настройка.Представление       = ВернутьСтр("ru = 'ЛИССИ CSP'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = ВернутьСтр("ru = 'Сигнал-КОМ CSP (RFC 4357)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = ВернутьСтр("ru = 'Сигнал-КОМ CSP (ITU-T X.509 v.3)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = ВернутьСтр("ru = 'Microsoft Enhanced CSP'");
