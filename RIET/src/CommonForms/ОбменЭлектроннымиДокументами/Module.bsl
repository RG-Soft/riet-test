...
Процедура ОткрытьНастройкиОбменаЭлектроннымиДокументами(Команда)
	...
	ОткрытьФорму("ОбщаяФорма.НастройкиОбменаЭД", , ЭтаФорма);
...
Процедура УстановитьЗначенияЗависимыхКонстант(ИмяРодительскойКонстанты)
	...
	Если ИмяРодительскойКонстанты = "ИспользоватьОбменЭД" ИЛИ ИмяРодительскойКонстанты = "ИспользоватьЭлектронныеПодписи" Тогда
		
		Если НЕ НаборКонстант.ИспользоватьОбменЭД ИЛИ НЕ НаборКонстант.ИспользоватьЭлектронныеПодписи Тогда
...
Процедура УстановитьВидимостьДоступностьЗависимыхЭлементовФормы(ИмяКонстанты = Неопределено)
	...
	Если ИмяКонстанты = "ИспользоватьЭлектронныеПодписи" ИЛИ ИмяКонстанты = Неопределено Тогда
		Элементы.ГруппаКомментарийОткрытьНастройкиОбменаЭлектроннымиДокументами.Видимость = НЕ НаборКонстант.ИспользоватьЭлектронныеПодписи;
	КонецЕсли;
	
	// Настройки, выполняемые при создании формы и при изменении соответствующего элемента формы
	Если ИмяКонстанты = "ИспользоватьОбменЭД" ИЛИ ИмяКонстанты = "ИспользоватьЭлектронныеПодписи"
		...
		Элементы.ОткрытьНастройкиОбменаЭлектроннымиДокументами.Доступность 		= НаборКонстант.ИспользоватьОбменЭД И НаборКонстант.ИспользоватьЭлектронныеПодписи;
		Элементы.ИспользоватьОбменЭДМеждуОрганизациями.Доступность 				= НаборКонстант.ИспользоватьОбменЭД И НаборКонстант.ИспользоватьЭлектронныеПодписи;
		Элементы.ИспользоватьОбменЭДСБанками.Доступность 		  				= НаборКонстант.ИспользоватьОбменЭД И НаборКонстант.ИспользоватьЭлектронныеПодписи;
	КонецЕсли;
