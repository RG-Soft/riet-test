...
Процедура Выбрать(Команда)
	Закрыть(ВыбранныеНастройкиФормата());
КонецПроцедуры
...
Процедура ФорматВложенийНажатие(Элемент, СтандартнаяОбработка)
	...
	РезультатВыбораФорматов = ОткрытьФормуМодально("ОбщаяФорма.ВыборФорматаВложений", Новый Структура("НастройкиФормата", ВыбранныеНастройкиФормата()));
	Если РезультатВыбораФорматов <> КодВозвратаДиалога.Отмена И РезультатВыбораФорматов <> Неопределено Тогда
		...
		УпаковатьВАрхив = РезультатВыбораФорматов.УпаковатьВАрхив;
		СформироватьПредставлениеВыбранныхФорматов();
	КонецЕсли;
КонецПроцедуры
