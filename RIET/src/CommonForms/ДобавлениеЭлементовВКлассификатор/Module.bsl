...
// Если Код из классификатора присутствует в "ТаблицеНазначениеа" в колонке "Отбор" 
...
//Параметры:
// - ОбластьЕдиницаИзмерени - строка, название области содежащей данные о единицах измерения
