...
Процедура НастроитьСинхронизациюДанных(Элемент)
	...
	Если НастраиваемыеСинхронизации.Количество() > 1 Тогда
		ОписаниеОповещения = Новый ОписаниеОповещения("НастроитьСинхронизациюДанныхЗавершение", ЭтотОбъект);
		ПоказатьВыборИзМеню(ОписаниеОповещения, НастраиваемыеСинхронизации, Элемент);
	Иначе
		НастроитьСинхронизациюДанныхЗавершение(НастраиваемыеСинхронизации.Получить(0), Неопределено);
	КонецЕсли;
	
КонецПроцедуры

&НаКлиенте
Процедура НастроитьСинхронизациюДанныхЗавершение(ВыбраннаяСинхронизация, ДополнительныеПараметры) Экспорт
